...
public class DuplicateSampleAbscissaException extends org.apache.commons.math.MathException {
     ...
     * 		duplicate abscissa
     * @param i1
     * 		index of one entry having the duplicate abscissa
     * @param i2
     * 		index of another entry having the duplicate abscissa
     */     public DuplicateSampleAbscissaException(double abscissa, int i1, int i2) {         super(org.apache.commons.math.util.LocalizedFormats.DUPLICATED_ABSCISSA, abscissa, i1, i2);}
