...
public class RandomKeyTest {
    ...
    public void testInducedPermutation() {
        ...
        try {
            org.apache.commons.math.genetics.RandomKey.inducedPermutation(
            java.util.Arrays.asList(new java.lang.String[]{ "a", "b", "c", "d", "d" }), 
            java.util.Arrays.asList(new java.lang.String[]{ "a", "b", "c", "d" }));
        ...
        try {
            org.apache.commons.math.genetics.RandomKey.inducedPermutation(
            java.util.Arrays.asList(new java.lang.String[]{ "a", "b", "c", "d", "d" }), 
            java.util.Arrays.asList(new java.lang.String[]{ "a", "b", "c", "d", "f" }));
