 ...
 * @since 2.0
 */
public class BigFraction extends 
java.lang.Number implements 
java.io.Serializable , java.lang.Comparable<org.apache.commons.math.fraction.BigFraction> , org.apache.commons.math.FieldElement<org.apache.commons.math.fraction.BigFraction> {
     ...
     */     public BigFraction(final double value) throws java.lang.IllegalArgumentException {         if (java.lang.Double.isNaN(value)) {
     ...
     */
    public BigFraction(final double value, final double epsilon, final 
     ...
     * 		if the continued fraction failed to converge.
     */
    private BigFraction(final double value, final double epsilon, final 
    int maxDenominator, int maxIterations) throws 
    org.apache.commons.math.fraction.FractionConversionException {
        ...
        do {
            ...
            if (((n < maxIterations) && 
            ((java.lang.Math.abs((convergent - value))) > epsilon)) && 
            (q2 < maxDenominator)) {
                p0 = p1;
                p1 = p2;
                q0 = q1;
     ...
     * 		if the continued fraction failed to converge.
     */
    public BigFraction(final double value, final int maxDenominator) throws 
    org.apache.commons.math.fraction.FractionConversionException {
     ...
     * 		if the denominator is <code>zero</code>.
     */
    public static org.apache.commons.math.fraction.BigFraction getReducedFraction(final int numerator, final 
    int denominator) {
        if (numerator == 0) {
    ...
    public org.apache.commons.math.fraction.BigFraction multiply(final org.apache.commons.math.fraction.BigFraction fraction) {
        ...
        (fraction.numerator.equals(java.math.BigInteger.ZERO))) {
            return org.apache.commons.math.fraction.BigFraction.ZERO;
        }
        return new org.apache.commons.math.fraction.BigFraction(numerator.multiply(fraction.numerator), 
    ...
    public org.apache.commons.math.fraction.BigFraction pow(final long exponent) {
        if (exponent < 0) {
            return new org.apache.commons.math.fraction.BigFraction(org.apache.commons.math.util.MathUtils.pow(denominator, (-exponent)), 
            org.apache.commons.math.util.MathUtils.pow(numerator, (-exponent)));
        }
        return new org.apache.commons.math.fraction.BigFraction(org.apache.commons.math.util.MathUtils.pow(numerator, exponent), 
        org.apache.commons.math.util.MathUtils.pow(denominator, exponent));
    }
    ...
    public org.apache.commons.math.fraction.BigFraction pow(final java.math.BigInteger exponent) {
        if ((exponent.compareTo(java.math.BigInteger.ZERO)) < 0) {
            ...
            return new org.apache.commons.math.fraction.BigFraction(org.apache.commons.math.util.MathUtils.pow(denominator, eNeg), 
            org.apache.commons.math.util.MathUtils.pow(numerator, eNeg));
        }
        return new org.apache.commons.math.fraction.BigFraction(org.apache.commons.math.util.MathUtils.pow(numerator, exponent), 
        org.apache.commons.math.util.MathUtils.pow(denominator, exponent));
    }
    ...
    public double pow(final double exponent) {
        return (java.lang.Math.pow(numerator.doubleValue(), exponent)) / 
        (java.lang.Math.pow(denominator.doubleValue(), exponent));
    }
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.fraction.BigFractionField getField() {         return org.apache.commons.math.fraction.BigFractionField.getInstance();
    }
