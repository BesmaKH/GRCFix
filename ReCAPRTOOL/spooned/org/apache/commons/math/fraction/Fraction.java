...
java.lang.Number implements 
java.io.Serializable , java.lang.Comparable<org.apache.commons.math.fraction.Fraction> , org.apache.commons.math.FieldElement<org.apache.commons.math.fraction.Fraction> {
     ...
     * 		converge.
     */     public Fraction(double value) throws org.apache.commons.math.fraction.FractionConversionException {         this(value, 1.0E-5, 100);}
     ...
     * 		if the continued fraction failed to
     * 		converge.
     */     public Fraction(double value, double epsilon, int maxIterations) throws org.apache.commons.math.fraction.FractionConversionException {         this(value, epsilon, java.lang.Integer.MAX_VALUE, maxIterations);}
     ...
     * 		if the continued fraction failed to
     * 		converge
     */     public Fraction(double value, int maxDenominator) throws org.apache.commons.math.fraction.FractionConversionException {         this(value, 0, maxDenominator, 100);
    }
     ...
     * 		if the continued fraction failed to
     * 		converge.
     */     private Fraction(double value, double epsilon, int maxDenominator, int maxIterations) throws org.apache.commons.math.fraction.FractionConversionException {         long overflow = java.lang.Integer.MAX_VALUE;         double r0 = value;
     ...
     */     public Fraction(int num, int den) {         if (den == 0) {             throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, num, den);
        }
        if (den < 0) {
            if ((num == (java.lang.Integer.MIN_VALUE)) || (den == (java.lang.Integer.MIN_VALUE))) {
                ...
                org.apache.commons.math.util.LocalizedFormats.OVERFLOW_IN_FRACTION, num, den);
            }
            num = -num;
            den = -den;
        }
     ...
     */     public int compareTo(org.apache.commons.math.fraction.Fraction object) {         long nOd = ((long) (numerator)) * (object.denominator);
     ...
     */     public org.apache.commons.math.fraction.Fraction negate() {
        if ((numerator) == (java.lang.Integer.MIN_VALUE)) {
            throw org.apache.commons.math.MathRuntimeException.createArithmeticException(
            org.apache.commons.math.util.LocalizedFormats.OVERFLOW_IN_FRACTION, numerator, denominator);
        }
     ...
     */     public org.apache.commons.math.fraction.Fraction add(org.apache.commons.math.fraction.Fraction fraction) {         return /* add */         addSub(fraction, true);}
     ...
     * @return this + i
     */     public org.apache.commons.math.fraction.Fraction add(final int i) {         return new org.apache.commons.math.fraction.Fraction(((numerator) + (i * (denominator))), denominator);
    }
     ...
     */     public org.apache.commons.math.fraction.Fraction subtract(org.apache.commons.math.fraction.Fraction fraction) {         return /* subtract */         addSub(fraction, false);}
     ...
     * @return this - i
     */     public org.apache.commons.math.fraction.Fraction subtract(final int i) {         return new org.apache.commons.math.fraction.Fraction(((numerator) - (i * (denominator))), denominator);
    }
     ...
     * 		if the resulting numerator or denominator
     * 		cannot be represented in an <code>int</code>.
     */     private org.apache.commons.math.fraction.Fraction addSub(org.apache.commons.math.fraction.Fraction fraction, boolean isAdd) {         if (fraction == null) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.NULL_FRACTION);}
        ...
        if (d1 == 1) {
            ...
            return new org.apache.commons.math.fraction.Fraction(
            (isAdd ? org.apache.commons.math.util.MathUtils.addAndCheck(uvp, upv) : 
            org.apache.commons.math.util.MathUtils.subAndCheck(uvp, upv)), 
            org.apache.commons.math.util.MathUtils.mulAndCheck(denominator, fraction.denominator));
        }
        // the quantity 't' requires 65 bits of precision; see knuth 4.5.1
        // exercise 7.  we're going to use a BigInteger.
        // t = u(v'/d1) +/- v(u'/d1)
        java.math.BigInteger uvp = java.math.BigInteger.valueOf(numerator).multiply(
        java.math.BigInteger.valueOf(((fraction.denominator) / d1)));
        java.math.BigInteger upv = java.math.BigInteger.valueOf(fraction.numerator).multiply(
        java.math.BigInteger.valueOf(((denominator) / d1)));
        ...
        if ((w.bitLength()) > 31) {
            throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.NUMERATOR_OVERFLOW_AFTER_MULTIPLY, 
            w);
        }
        return new org.apache.commons.math.fraction.Fraction(w.intValue(), 
        org.apache.commons.math.util.MathUtils.mulAndCheck(((denominator) / d1), 
     ...
     * 		if the resulting numerator or denominator exceeds
     * 		<code>Integer.MAX_VALUE</code>
     */     public org.apache.commons.math.fraction.Fraction multiply(org.apache.commons.math.fraction.Fraction fraction) {         if (fraction == null) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.NULL_FRACTION);
        }
        ...
        return org.apache.commons.math.fraction.Fraction.getReducedFraction(
        org.apache.commons.math.util.MathUtils.mulAndCheck(((numerator) / d1), ((fraction.numerator) / d2)), 
        org.apache.commons.math.util.MathUtils.mulAndCheck(((denominator) / d2), ((fraction.denominator) / d1)));
    }
     ...
     * 		if the resulting numerator or denominator exceeds
     * 		<code>Integer.MAX_VALUE</code>
     */     public org.apache.commons.math.fraction.Fraction divide(org.apache.commons.math.fraction.Fraction fraction) {         if (fraction == null) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.NULL_FRACTION);}
        if ((fraction.numerator) == 0) {
            throw org.apache.commons.math.MathRuntimeException.createArithmeticException(
            org.apache.commons.math.util.LocalizedFormats.ZERO_FRACTION_TO_DIVIDE_BY, 
     ...
     * @return this * i
     */     public org.apache.commons.math.fraction.Fraction divide(final int i) {         return new org.apache.commons.math.fraction.Fraction(numerator, ((denominator) * i));
    }
     ...
     * @throws ArithmeticException
     * 		if the denominator is <code>zero</code>
     */     public static org.apache.commons.math.fraction.Fraction getReducedFraction(int numerator, int denominator) {         if (denominator == 0) {             throw org.apache.commons.math.MathRuntimeException.createArithmeticException(
            org.apache.commons.math.util.LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, numerator, denominator);
        }
        if (numerator == 0) {
            return org.apache.commons.math.fraction.Fraction.ZERO;// normalize zero.
        }
        ...
        if (denominator < 0) {
            if ((numerator == (java.lang.Integer.MIN_VALUE)) || 
            (denominator == (java.lang.Integer.MIN_VALUE))) {
                throw org.apache.commons.math.MathRuntimeException.createArithmeticException(
                org.apache.commons.math.util.LocalizedFormats.OVERFLOW_IN_FRACTION, numerator, denominator);
            }
            numerator = -numerator;
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.fraction.FractionField getField() {         return org.apache.commons.math.fraction.FractionField.getInstance();
    }
