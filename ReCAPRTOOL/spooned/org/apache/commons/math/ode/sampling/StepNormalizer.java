...
public class StepNormalizer implements org.apache.commons.math.ode.sampling.StepHandler {
     ...
     */     public StepNormalizer(final double h, final org.apache.commons.math.ode.sampling.FixedStepHandler handler) {         this.h = java.lang.Math.abs(h);         this.handler = handler;         reset();
    }
     ...
     */     public void handleStep(final org.apache.commons.math.ode.sampling.StepInterpolator interpolator, final boolean isLast) throws org.apache.commons.math.ode.DerivativeException {         if ((lastState) == null) {
        ...
        while (nextInStep) {
            ...
            lastTime = nextTime;
            interpolator.setInterpolatedTime(lastTime);
            java.lang.System.arraycopy(interpolator.getInterpolatedState(), 0, 
            lastState, 0, lastState.length);
            java.lang.System.arraycopy(interpolator.getInterpolatedDerivatives(), 0, 
