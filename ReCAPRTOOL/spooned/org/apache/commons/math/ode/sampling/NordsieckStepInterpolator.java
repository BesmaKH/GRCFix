...
public class NordsieckStepInterpolator extends org.apache.commons.math.ode.sampling.AbstractStepInterpolator {
     ...
     * 		instance
     */     public NordsieckStepInterpolator(final org.apache.commons.math.ode.sampling.NordsieckStepInterpolator interpolator) {         super(interpolator);         scalingH = interpolator.scalingH;
     ...
     */     @java.lang.Override     public void reinitialize(final double[] y, final boolean forward) {         super.reinitialize(y, forward);         stateVariation = new double[y.length];
    }
     ...
     * 		nordsieck vector
     */     public void reinitialize(final double time, final double stepSize, final double[] scaledDerivative, final org.apache.commons.math.linear.Array2DRowRealMatrix nordsieckVector) {         this.referenceTime = time;         this.scalingH = stepSize;         this.scaled = scaledDerivative;
    ...
    /**
     * {@inheritDoc}
     */     @java.lang.Override     protected void computeInterpolatedStateAndDerivatives(final double theta, final double oneMinusThetaH) {
