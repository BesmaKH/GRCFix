...
public class HighamHall54IntegratorTest extends 
junit.framework.TestCase {
    ...
    public void testWrongDerivative() {
        try {
            org.apache.commons.math.ode.nonstiff.HighamHall54Integrator integrator = 
            new org.apache.commons.math.ode.nonstiff.HighamHall54Integrator(0.0, 1.0, 1.0E-10, 1.0E-10);
            ...
            new org.apache.commons.math.ode.FirstOrderDifferentialEquations() {
                ...
                public void computeDerivatives(double t, double[] y, double[] dot) throws 
                org.apache.commons.math.ode.DerivativeException {
                    if (t < (-0.5)) {
                        throw new org.apache.commons.math.ode.DerivativeException(org.apache.commons.math.util.LocalizedFormats.SIMPLE_MESSAGE, "oops");
                    }else {
    ...
    public void testMinStep() {
        ...
        try {
            ...
            org.apache.commons.math.ode.FirstOrderIntegrator integ = new org.apache.commons.math.ode.nonstiff.HighamHall54Integrator(minStep, maxStep, 
    ...
    public void testIncreasingTolerance() throws 
    ...
    public void testEventsErrors() {
        ...
        new org.apache.commons.math.ode.nonstiff.HighamHall54Integrator(minStep, maxStep, 
        ...
        integ.addEventHandler(new org.apache.commons.math.ode.events.EventHandler() {
            ...
            public double g(double t, double[] y) throws org.apache.commons.math.ode.events.EventException {
                ...
                if (offset > 0) {
                    throw new org.apache.commons.math.ode.events.EventException(org.apache.commons.math.util.LocalizedFormats.EVALUATION_FAILED, t);
                }
                return offset;
            }
    ...
    public void testSanityChecks() {
        try {
            ...
            try {
                org.apache.commons.math.ode.FirstOrderIntegrator integ = 
                new org.apache.commons.math.ode.nonstiff.HighamHall54Integrator(minStep, maxStep, new double[4], new double[4]);
            ...
            try {
                org.apache.commons.math.ode.FirstOrderIntegrator integ = 
                new org.apache.commons.math.ode.nonstiff.HighamHall54Integrator(minStep, maxStep, new double[2], new double[4]);
                integ.integrate(pb, pb.getInitialTime(), pb.getInitialState(), 
                pb.getFinalTime(), new double[pb.getDimension()]);
                junit.framework.Assert.fail("an exception should have been thrown");
            } catch (org.apache.commons.math.ode.IntegratorException ie) {
            ...
            try {
                org.apache.commons.math.ode.FirstOrderIntegrator integ = 
                new org.apache.commons.math.ode.nonstiff.HighamHall54Integrator(minStep, maxStep, new double[4], new double[2]);
                integ.integrate(pb, pb.getInitialTime(), pb.getInitialState(), 
                pb.getFinalTime(), new double[pb.getDimension()]);
                junit.framework.Assert.fail("an exception should have been thrown");
            } catch (org.apache.commons.math.ode.IntegratorException ie) {
