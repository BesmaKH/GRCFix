...
public class DormandPrince54StepInterpolatorTest {
    ...
    org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        ...
        org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator integ = new org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator(minStep, maxStep, 
    ...
    java.io.IOException, java.lang.ClassNotFoundException, org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        ...
        org.junit.Assert.assertTrue(((bos.size()) > 119500));
        org.junit.Assert.assertTrue(((bos.size()) < 120500));
        ...
        org.junit.Assert.assertTrue((maxError < 7.0E-10));
