...
public class DormandPrince853StepInterpolatorTest {
    ...
    org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        ...
        org.apache.commons.math.ode.nonstiff.DormandPrince853Integrator integ = new org.apache.commons.math.ode.nonstiff.DormandPrince853Integrator(minStep, maxStep, 
    ...
    java.io.IOException, java.lang.ClassNotFoundException, org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        ...
        org.junit.Assert.assertTrue(((bos.size()) > 86000));
        org.junit.Assert.assertTrue(((bos.size()) < 87000));
        ...
        org.junit.Assert.assertTrue((maxError < 2.4E-10));
