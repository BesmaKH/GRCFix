...
class DormandPrince853StepInterpolator extends 
org.apache.commons.math.ode.nonstiff.RungeKuttaStepInterpolator {
    ...
    new double[]{ (-1.7751989329E10) / 2.10607656E9, 4.272954039E9 / 7.53986464E9, 
    (-1.18476319744E11) / 3.8604839385E10, 7.55123450731E11 / 3.166577316E11, 
    3.6923844612348283E18 / 1.7441304416342505E18, (-4.612609375E9) / 5.293382976E9, 
    2.091772278379E12 / 9.336445866E11, 2.136624137E9 / 3.38298912E9, 
    (-126493.0) / 1421424.0, 9.835E7 / 5419179.0, 
    (-1.8878125E7) / 2053168.0, (-1.944542619E9) / 4.38351368E8 }, 

    new double[]{ 3.2941697297E10 / 3.15911484E9, 4.56696183123E11 / 1.88496616E9, 
    1.9132610714624E13 / 1.15814518155E11, (-1.77904688592943E14) / 4.749865974E11, 
    (-4.8211399418367652E18) / 2.18016305204281312E17, 3.0702015625E10 / 3.970037232E9, 
    (-8.5916079474274E13) / 2.8009337598E12, (-5.919468007E9) / 6.3431046E8, 
    2479159.0 / 157936.0, (-1.875E7) / 602131.0, 
    (-1.9203125E7) / 2053168.0, 1.5700361463E10 / 4.38351368E8 }, 

    new double[]{ 1.2627015655E10 / 6.31822968E8, (-7.2955222965E10) / 1.88496616E8, 
    (-1.314574495232E13) / 6.9488710893E10, 3.0084216194513E13 / 5.6998391688E10, 
    (-2.9685876100664064E17) / 2.5648977082856624E16, 5.69140625E8 / 8.2709109E7, 
    (-1.8684190637E10) / 1.8672891732E10, 6.9644045E7 / 8.9549712E7, 
    (-1.1847025E7) / 4264272.0, (-9.7865E8) / 1.6257537E7, 
    5.19371875E8 / 6159504.0, 5.256837225E9 / 4.38351368E8 }, 

    new double[]{ (-4.50944925E8) / 1.7550638E7, (-1.4532122925E10) / 9.4248308E7, 
    (-5.958769664E11) / 2.573655959E9, 1.88748653015E11 / 5.27762886E8, 
    2.5454854581152343E18 / 2.7252038150535164E16, (-1.376953125E9) / 3.6759604E7, 
    5.3995596795E10 / 5.18691437E8, 2.10311225E8 / 7047894.0, 
    (-1718875.0) / 39484.0, 5.8E7 / 602131.0, 
    (-1546875.0) / 39484.0, (-1.262172375E9) / 8429834.0 } };
     ...
     * 		instance
     */     public DormandPrince853StepInterpolator(final org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator interpolator) {         super(interpolator);
        ...
        if ((interpolator.currentState) == null) {
            ...
            for (int k = 0; k < (yDotKLast.length); ++k) {
                ...
                java.lang.System.arraycopy(interpolator.yDotKLast[k], 0, yDotKLast[k], 0, 
                dimension);
            }
    ...
    /**
     * {@inheritDoc}
     */     @java.lang.Override     public void reinitialize(final org.apache.commons.math.ode.AbstractIntegrator integrator, final 
    double[] y, final double[][] yDotK, final boolean forward) {
    ...
    /**
     * {@inheritDoc}
     */     @java.lang.Override     public void storeTime(final double t) {
        super.storeTime(t);
        vectorsInitialized = false;
    }
    ...
    /**
     * {@inheritDoc}
     */     @java.lang.Override     protected void computeInterpolatedStateAndDerivatives(final double theta, final 
    double oneMinusThetaH) throws 
    org.apache.commons.math.ode.DerivativeException {
        ...
        if (!(vectorsInitialized)) {
            ...
            for (int i = 0; i < (interpolatedState.length); ++i) {
                ...
                v[0][i] = ((((((((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.B_01) * yDot1) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.B_06) * yDot6)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.B_07) * yDot7)) + 
                ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.B_08) * yDot8)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.B_09) * yDot9)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.B_10) * yDot10)) + 
                ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.B_11) * yDot11)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.B_12) * yDot12);
                v[1][i] = yDot1 - (v[0][i]);
                v[2][i] = ((v[0][i]) - (v[1][i])) - (yDotK[12][i]);
                for (int k = 0; k < (org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D.length); ++k) {
                    v[(k + 3)][i] = ((((((((((((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][0]) * yDot1) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][1]) * yDot6)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][2]) * yDot7)) + 
                    ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][3]) * yDot8)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][4]) * yDot9)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][5]) * yDot10)) + 
                    ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][6]) * yDot11)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][7]) * yDot12)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][8]) * yDot13)) + 
                    ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][9]) * yDot14)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][10]) * yDot15)) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.D[k][11]) * yDot16);
                }
            }
    ...
    /**
     * {@inheritDoc}
     */     @java.lang.Override     protected void doFinalize() throws 
    org.apache.commons.math.ode.DerivativeException {
        ...
        for (int j = 0; j < (currentState.length); ++j) {
            s = (((((((((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_01) * (yDotK[0][j])) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_06) * (yDotK[5][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_07) * (yDotK[6][j]))) + 
            ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_08) * (yDotK[7][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_09) * (yDotK[8][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_10) * (yDotK[9][j]))) + 
            ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_11) * (yDotK[10][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_12) * (yDotK[11][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K14_13) * (yDotK[12][j]));
            yTmp[j] = (currentState[j]) + ((h) * s);
        }
        integrator.computeDerivatives(((previousTime) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.C14) * (h))), yTmp, yDotKLast[0]);

        // k15
        for (int j = 0; j < (currentState.length); ++j) {
            s = ((((((((((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_01) * (yDotK[0][j])) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_06) * (yDotK[5][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_07) * (yDotK[6][j]))) + 
            ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_08) * (yDotK[7][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_09) * (yDotK[8][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_10) * (yDotK[9][j]))) + 
            ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_11) * (yDotK[10][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_12) * (yDotK[11][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_13) * (yDotK[12][j]))) + 
            ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K15_14) * (yDotKLast[0][j]));
            yTmp[j] = (currentState[j]) + ((h) * s);
        }
        integrator.computeDerivatives(((previousTime) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.C15) * (h))), yTmp, yDotKLast[1]);

        // k16
        for (int j = 0; j < (currentState.length); ++j) {
            s = (((((((((((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_01) * (yDotK[0][j])) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_06) * (yDotK[5][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_07) * (yDotK[6][j]))) + 
            ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_08) * (yDotK[7][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_09) * (yDotK[8][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_10) * (yDotK[9][j]))) + 
            ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_11) * (yDotK[10][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_12) * (yDotK[11][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_13) * (yDotK[12][j]))) + 
            ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_14) * (yDotKLast[0][j]))) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.K16_15) * (yDotKLast[1][j]));
            yTmp[j] = (currentState[j]) + ((h) * s);
        }
        integrator.computeDerivatives(((previousTime) + ((org.apache.commons.math.ode.nonstiff.DormandPrince853StepInterpolator.C16) * (h))), yTmp, yDotKLast[2]);
