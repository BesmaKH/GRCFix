...
public abstract class RungeKuttaIntegrator extends org.apache.commons.math.ode.AbstractIntegrator {
     ...
     * @param step
     * 		integration step
     */     protected RungeKuttaIntegrator(final java.lang.String name, final double[] c, final double[][] a, final double[] b, final org.apache.commons.math.ode.nonstiff.RungeKuttaStepInterpolator prototype, final double step) {         super(name);         this.c = c;         this.a = a;         this.b = b;
    ...
    /**
     * {@inheritDoc}
     */     public double integrate(final org.apache.commons.math.ode.FirstOrderDifferentialEquations equations, final double t0, final double[] y0, final 
