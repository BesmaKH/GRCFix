...
public class FirstOrderIntegratorWithJacobiansTest {
    ...
    @org.junit.Test
    public void testLowAccuracyExternalDifferentiation() throws 
    org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        ...
        new org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator(1.0E-8, 100.0, new double[]{ 1.0E-4, 1.0E-4 }, new double[]{ 1.0E-4, 1.0E-4 });
        double hP = 1.0E-12;
    ...
    @org.junit.Test
    public void testHighAccuracyExternalDifferentiation() throws 
    org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        org.apache.commons.math.ode.FirstOrderIntegrator integ = 
        new org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator(1.0E-8, 100.0, new double[]{ 1.0E-10, 1.0E-10 }, new double[]{ 1.0E-10, 1.0E-10 });
        double hP = 1.0E-12;
        org.apache.commons.math.stat.descriptive.SummaryStatistics residualsP0 = new org.apache.commons.math.stat.descriptive.SummaryStatistics();
        org.apache.commons.math.stat.descriptive.SummaryStatistics residualsP1 = new org.apache.commons.math.stat.descriptive.SummaryStatistics();
        for (double b = 2.88; b < 3.08; b += 0.001) {
    ...
    @org.junit.Test
    public void testInternalDifferentiation() throws 
    org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        org.apache.commons.math.ode.FirstOrderIntegrator integ = 
        new org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator(1.0E-8, 100.0, new double[]{ 1.0E-4, 1.0E-4 }, new double[]{ 1.0E-4, 1.0E-4 });
        double hP = 1.0E-12;
        ...
        for (double b = 2.88; b < 3.08; b += 0.001) {
            ...
            double hY = 1.0E-12;
            org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians extInt = 
            new org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians(integ, brusselator, new double[]{ b }, 
            ...
            org.junit.Assert.assertTrue(((extInt.getEvaluations()) > 1500));
            org.junit.Assert.assertTrue(((extInt.getEvaluations()) < 2100));
            org.junit.Assert.assertEquals((4 * (integ.getEvaluations())), extInt.getEvaluations());
        ...
        org.junit.Assert.assertTrue(((residualsP0.getStandardDeviation()) < 0.003));
        org.junit.Assert.assertTrue((((residualsP1.getMax()) - (residualsP1.getMin())) < 0.05));
        org.junit.Assert.assertTrue(((residualsP1.getStandardDeviation()) < 0.01));
    }

    @org.junit.Test
    public void testAnalyticalDifferentiation() throws 
    org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        org.apache.commons.math.ode.FirstOrderIntegrator integ = 
        new org.apache.commons.math.ode.nonstiff.DormandPrince54Integrator(1.0E-8, 100.0, new double[]{ 1.0E-4, 1.0E-4 }, new double[]{ 1.0E-4, 1.0E-4 });
        org.apache.commons.math.stat.descriptive.SummaryStatistics residualsP0 = new org.apache.commons.math.stat.descriptive.SummaryStatistics();
        ...
        for (double b = 2.88; b < 3.08; b += 0.001) {
            ...
            double[][] dZdP = new double[2][1];
            org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians extInt = 
            new org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians(integ, brusselator);
            extInt.setMaxEvaluations(5000);
            extInt.integrate(0, z, new double[][]{ new double[]{ 0.0 }, new double[]{ 1.0 } }, 20.0, z, dZdZ0, dZdP);
            org.junit.Assert.assertEquals(5000, extInt.getMaxEvaluations());
            org.junit.Assert.assertTrue(((extInt.getEvaluations()) > 350));
        ...
        org.junit.Assert.assertTrue((((residualsP0.getMax()) - (residualsP0.getMin())) < 0.014));
        org.junit.Assert.assertTrue(((residualsP0.getStandardDeviation()) < 0.003));
        org.junit.Assert.assertTrue((((residualsP1.getMax()) - (residualsP1.getMin())) < 0.05));
        org.junit.Assert.assertTrue(((residualsP1.getStandardDeviation()) < 0.01));
    }
    ...
    public void testFinalResult() throws org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        ...
        org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians extInt = 
        new org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians(integ, circle);
        extInt.integrate(0, y, circle.exactDyDp(0), t, y, dydy0, dydp);
        for (int i = 0; i < (y.length); ++i) {
            org.junit.Assert.assertEquals(circle.exactY(t)[i], y[i], 1.0E-9);
        }
        for (int i = 0; i < (dydy0.length); ++i) {
            for (int j = 0; j < (dydy0[i].length); ++j) {
                org.junit.Assert.assertEquals(circle.exactDyDy0(t)[i][j], dydy0[i][j], 1.0E-9);
            }
        }
        for (int i = 0; i < (dydp.length); ++i) {
            for (int j = 0; j < (dydp[i].length); ++j) {
                org.junit.Assert.assertEquals(circle.exactDyDp(t)[i][j], dydp[i][j], 1.0E-7);
            }
        }
    }
    ...
    public void testStepHandlerResult() throws org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
        ...
        double[][] dydp = new double[2][3];
        double t = 18 * (java.lang.Math.PI);
        final org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians extInt = 
        new org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians(integ, circle);
        extInt.addStepHandler(new org.apache.commons.math.ode.jacobians.StepHandlerWithJacobians() {
            ...
            public void handleStep(org.apache.commons.math.ode.jacobians.StepInterpolatorWithJacobians interpolator, boolean isLast) throws 
            org.apache.commons.math.ode.DerivativeException {
                ...
                for (int i = 0; i < (dydp.length); ++i) {
                    for (int j = 0; j < (dydp[i].length); ++j) {
                        org.junit.Assert.assertEquals(circle.exactDyDp(t)[i][j], dydp[i][j], 3.0E-8);
                    }
                }
                ...
                for (int i = 0; i < (yDot.length); ++i) {
                    org.junit.Assert.assertEquals(circle.exactYDot(t)[i], yDot[i], 1.0E-10);
                }
                for (int i = 0; i < (dydy0Dot.length); ++i) {
                    for (int j = 0; j < (dydy0Dot[i].length); ++j) {
                        org.junit.Assert.assertEquals(circle.exactDyDy0Dot(t)[i][j], dydy0Dot[i][j], 1.0E-10);
                    }
                }
                for (int i = 0; i < (dydpDot.length); ++i) {
                    for (int j = 0; j < (dydpDot[i].length); ++j) {
                        org.junit.Assert.assertEquals(circle.exactDyDpDot(t)[i][j], dydpDot[i][j], 3.0E-9);
                    }
                }
            }
        });
     ...
     */     private static class Circle implements org.apache.commons.math.ode.jacobians.ODEWithJacobians {
        ...
        public double[][] exactDyDp(double t) {
            ...
            double dy0 = (y0[1]) - (cy);
            return new double[][]{ 
            new double[]{ 1 - cos, sin, (-t) * ((sin * dx0) + (cos * dy0)) }, 
            new double[]{ -sin, 1 - cos, t * ((cos * dx0) - (sin * dy0)) } };
        ...
        public double[][] exactDyDy0Dot(double t) {
            ...
            double oSin = (omega) * (java.lang.Math.sin(((omega) * t)));
            return new double[][]{ 
            new double[]{ -oSin, -oCos }, 
            new double[]{ oCos, -oSin } };
        ...
        public double[][] exactDyDpDot(double t) {
            ...
            double dy0 = (y0[1]) - (cy);
            return new double[][]{ 
            new double[]{ oSin, oCos, (((-sin) * dx0) - (cos * dy0)) - (t * ((oCos * dx0) - (oSin * dy0))) }, 
            new double[]{ -oCos, oSin, ((cos * dx0) - (sin * dy0)) + (t * (((-oSin) * dx0) - (oCos * dy0))) } };
