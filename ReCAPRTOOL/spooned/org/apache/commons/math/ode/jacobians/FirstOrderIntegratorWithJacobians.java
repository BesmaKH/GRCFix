 ...
 */ public class FirstOrderIntegratorWithJacobians {
     ...
     *
     * @param integrator
     * 		underlying integrator to solve the compound problem
     * @param ode
     * 		original problem (f in the equation y' = f(t, y))
     * @param p
     * 		parameters array (may be null if {@link
     ...
     * ODEWithJacobians)
     */     public FirstOrderIntegratorWithJacobians(final org.apache.commons.math.ode.FirstOrderIntegrator integrator, final org.apache.commons.math.ode.jacobians.ParameterizedODE ode, final double[] p, final double[] hY, final double[] hP) {         checkDimension(ode.getDimension(), hY);         checkDimension(ode.getParametersDimension(), p);         checkDimension(ode.getParametersDimension(), hP);         this.integrator = integrator;
     ...
     * 		underlying integrator to solve the compound problem
     * @param ode
     * 		original problem, which can compute the jacobians by itself
     * @see #FirstOrderIntegratorWithJacobians(FirstOrderIntegrator,
     * ParameterizedODE, double[], double[], double[])
     */     public FirstOrderIntegratorWithJacobians(final org.apache.commons.math.ode.FirstOrderIntegrator integrator, final org.apache.commons.math.ode.jacobians.ODEWithJacobians ode) {         this.integrator = integrator;         this.ode = ode;
        setMaxEvaluations((-1));
    }
     ...
     */     public void addStepHandler(org.apache.commons.math.ode.jacobians.StepHandlerWithJacobians handler) {         final int n = ode.getDimension();         final int k = ode.getParametersDimension();
     ...
     * @see #clearStepHandlers()
     */     public java.util.Collection<org.apache.commons.math.ode.jacobians.StepHandlerWithJacobians> getStepHandlers() {         final java.util.Collection<org.apache.commons.math.ode.jacobians.StepHandlerWithJacobians> handlers = 
        new java.util.ArrayList<org.apache.commons.math.ode.jacobians.StepHandlerWithJacobians>();
     ...
     * @see #addStepHandler(StepHandlerWithJacobians)
     * @see #getStepHandlers()
     */     public void clearStepHandlers() {         integrator.clearStepHandlers();
    }
     ...
     */     public void addEventHandler(org.apache.commons.math.ode.jacobians.EventHandlerWithJacobians handler, double maxCheckInterval, double convergence, int maxIterationCount) {         final int n = ode.getDimension();         final int k = ode.getParametersDimension();
        integrator.addEventHandler(new org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians.EventHandlerWrapper(handler, n, k), 
     ...
     * @see #clearEventHandlers()
     */     public java.util.Collection<org.apache.commons.math.ode.jacobians.EventHandlerWithJacobians> getEventHandlers() {         final java.util.Collection<org.apache.commons.math.ode.jacobians.EventHandlerWithJacobians> handlers = 
        new java.util.ArrayList<org.apache.commons.math.ode.jacobians.EventHandlerWithJacobians>();
     ...
     * @see #addEventHandler(EventHandlerWithJacobians, double, double, int)
     * @see #getEventHandlers()
     */     public void clearEventHandlers() {         integrator.clearEventHandlers();
    }
     ...
     */     public double integrate(final double t0, final double[] y0, final double[][] dY0dP, final double t, final double[] y, final double[][] dYdY0, final double[][] dYdP) throws org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {         final int n = ode.getDimension();         final int k = ode.getParametersDimension();         checkDimension(n, y0);         checkDimension(n, y);         checkDimension(n, dYdY0);         checkDimension(n, dYdY0[0]);
        if (k != 0) {
     ...
     * 		compound state
     * @param y
     * 		raw state array to fill
     * @param dydy0
     * 		jacobian array to fill
     * @param dydp
     * 		jacobian array to fill
     */     private static void dispatchCompoundState(final double[] z, final double[] y, final double[][] dydy0, final double[][] dydp) {         final int n = y.length;         final int k = dydp[0].length;
        // state
     ...
     */     public double getCurrentStepStart() {         return integrator.getCurrentStepStart();
    }
     ...
     */     public double getCurrentSignedStepsize() {         return integrator.getCurrentSignedStepsize();
    }
     ...
     */     public void setMaxEvaluations(int maxEvaluations) {         this.maxEvaluations = (maxEvaluations < 0) ? java.lang.Integer.MAX_VALUE : maxEvaluations;}
     ...
     */     private void checkDimension(final int expected, final java.lang.Object array) throws java.lang.IllegalArgumentException {         int arrayDimension = (array == null) ? 0 : java.lang.reflect.Array.getLength(array);         if (arrayDimension != expected) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, arrayDimension, expected);
        }
    }
     ...
     */     private class MappingWrapper implements org.apache.commons.math.ode.ExtendedFirstOrderDifferentialEquations {
        ...
        /**
         * {@inheritDoc}
         */         public int getDimension() {             final int n = y.length;
        ...
        /**
         * {@inheritDoc}
         */         public int getMainSetDimension() {             return ode.getDimension();
        }
     ...
     */     private class FiniteDifferencesWrapper implements org.apache.commons.math.ode.jacobians.ODEWithJacobians {
         ...
         *
         * @param ode
         * 		original ODE problem, without jacobians computations
         * @param p
         * 		parameters array (may be null if parameters dimension from original problem is zero)
         * @param hY
         * 		step sizes to use for computing the jacobian df/dy
         * @param hP
         * 		step sizes to use for computing the jacobian df/dp
         */         public FiniteDifferencesWrapper(final org.apache.commons.math.ode.jacobians.ParameterizedODE ode, final double[] p, final double[] hY, final double[] hP) {             this.ode = ode;             this.p = p.clone();             this.hY = hY.clone();             this.hP = hP.clone();
            tmpDot = new double[ode.getDimension()];
        }

        /**
         * {@inheritDoc}
         */         public int getDimension() {             return ode.getDimension();
        }

        /**
         * {@inheritDoc}
         */         public void computeDerivatives(double t, double[] y, double[] yDot) throws org.apache.commons.math.ode.DerivativeException {             // this call to computeDerivatives has already been counted,
        ...
        /**
         * {@inheritDoc}
         */         public int getParametersDimension() {             return ode.getParametersDimension();
        }

        /**
         * {@inheritDoc}
         */         public void computeJacobians(double t, double[] y, double[] yDot, double[][] dFdY, double[][] dFdP) throws 
     ...
     */     private static class StepHandlerWrapper implements org.apache.commons.math.ode.sampling.StepHandler {
         ...
         * @param k
         * 		number of parameters
         */         public StepHandlerWrapper(final org.apache.commons.math.ode.jacobians.StepHandlerWithJacobians handler, final int n, final int k) {             this.handler = handler;             this.n = n;             this.k = k;
        }
         ...
         */         public org.apache.commons.math.ode.jacobians.StepHandlerWithJacobians getHandler() {             return handler;
        }
        ...
        /**
         * {@inheritDoc}
         */         public boolean requiresDenseOutput() {             return handler.requiresDenseOutput();
        }
     ...
     */     private static class StepInterpolatorWrapper implements org.apache.commons.math.ode.jacobians.StepInterpolatorWithJacobians {
         ...
         * @param k
         * 		number of parameters
         */         public StepInterpolatorWrapper(final org.apache.commons.math.ode.sampling.StepInterpolator interpolator, final int n, final int k) {             this.interpolator = interpolator;             y = new double[n];             dydy0 = new double[n][n];
            dydp = new double[n][k];
            yDot = new double[n];
        ...
        /**
         * {@inheritDoc}
         */         public void setInterpolatedTime(double time) {             interpolator.setInterpolatedTime(time);
        }

        /**
         * {@inheritDoc}
         */         public boolean isForward() {             return interpolator.isForward();
        }
        ...
        /**
         * {@inheritDoc}
         */         public double getInterpolatedTime() {             return interpolator.getInterpolatedTime();
        }

        /**
         * {@inheritDoc}
         */         public double[] getInterpolatedY() throws org.apache.commons.math.ode.DerivativeException {             double[] extendedState = interpolator.getInterpolatedState();
        ...
        /**
         * {@inheritDoc}
         */         public double[][] getInterpolatedDyDy0() throws org.apache.commons.math.ode.DerivativeException {             double[] extendedState = interpolator.getInterpolatedState();
            final int n = y.length;
            int start = n;
            for (int i = 0; i < n; ++i) {
        ...
        /**
         * {@inheritDoc}
         */         public double[][] getInterpolatedDyDp() throws org.apache.commons.math.ode.DerivativeException {             double[] extendedState = interpolator.getInterpolatedState();
            final int n = y.length;
        ...
        /**
         * {@inheritDoc}
         */         public double[] getInterpolatedYDot() throws org.apache.commons.math.ode.DerivativeException {             double[] extendedDerivatives = interpolator.getInterpolatedDerivatives();
        ...
        /**
         * {@inheritDoc}
         */         public double[][] getInterpolatedDyDy0Dot() throws org.apache.commons.math.ode.DerivativeException {             double[] extendedDerivatives = interpolator.getInterpolatedDerivatives();
            final int n = y.length;
            int start = n;
            for (int i = 0; i < n; ++i) {
        ...
        /**
         * {@inheritDoc}
         */         public double[][] getInterpolatedDyDpDot() throws org.apache.commons.math.ode.DerivativeException {             double[] extendedDerivatives = interpolator.getInterpolatedDerivatives();
            final int n = y.length;
        ...
        /**
         * {@inheritDoc}
         */         public org.apache.commons.math.ode.jacobians.StepInterpolatorWithJacobians copy() throws org.apache.commons.math.ode.DerivativeException {             final int n = y.length;
            final int k = dydp[0].length;
            org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians.StepInterpolatorWrapper copied = 
            new org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians.StepInterpolatorWrapper(interpolator.copy(), n, k);
        ...
        /**
         * {@inheritDoc}
         */         public void writeExternal(java.io.ObjectOutput out) throws java.io.IOException {             out.writeObject(interpolator);
        ...
        /**
         * {@inheritDoc}
         */         public void readExternal(java.io.ObjectInput in) throws java.io.IOException, java.lang.ClassNotFoundException {             interpolator = ((org.apache.commons.math.ode.sampling.StepInterpolator) (in.readObject()));
         ...
         * @param dest
         * 		destination array
         */         private static void copyArray(final double[] src, final double[] dest) {             java.lang.System.arraycopy(src, 0, dest, 0, src.length);}
        /**
         * Copy an array.
         *
         * @param src
         ...
         * @param dest
         * 		destination array
         */         private static void copyArray(final double[][] src, final double[][] dest) {             for (int i = 0; i < (src.length); ++i) {                 org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians.StepInterpolatorWrapper.copyArray(src[i], dest[i]);}
        }
         ...
         */         private static void writeArray(final java.io.ObjectOutput out, final double[] array) throws java.io.IOException {             for (int i = 0; i < (array.length); ++i) {                 out.writeDouble(array[i]);
            }
        }
         ...
         * 		array to write
         * @exception IOException if array cannot be read
         */         private static void writeArray(final java.io.ObjectOutput out, final double[][] array) throws java.io.IOException {             for (int i = 0; i < (array.length); ++i) {                 org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians.StepInterpolatorWrapper.writeArray(out, array[i]);
            }
        }
         ...
         * 		array to read
         * @exception IOException if array cannot be read
         */         private static void readArray(final java.io.ObjectInput in, final double[] array) throws java.io.IOException {             for (int i = 0; i < (array.length); ++i) {                 array[i] = in.readDouble();
            }
        }
         ...
         * 		array to read
         * @exception IOException if array cannot be read
         */         private static void readArray(final java.io.ObjectInput in, final double[][] array) throws java.io.IOException {             for (int i = 0; i < (array.length); ++i) {                 org.apache.commons.math.ode.jacobians.FirstOrderIntegratorWithJacobians.StepInterpolatorWrapper.readArray(in, array[i]);
            }
        }
     ...
     */     private static class EventHandlerWrapper implements org.apache.commons.math.ode.events.EventHandler {
         ...
         * @param k
         * 		number of parameters
         */         public EventHandlerWrapper(final org.apache.commons.math.ode.jacobians.EventHandlerWithJacobians handler, final int n, final int k) {             this.handler = handler;             y = new double[n];             dydy0 = new double[n][n];
            dydp = new double[n][k];
        }
         ...
         */         public org.apache.commons.math.ode.jacobians.EventHandlerWithJacobians getHandler() {             return handler;
        }
