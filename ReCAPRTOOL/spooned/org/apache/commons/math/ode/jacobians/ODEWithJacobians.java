...
public interface ODEWithJacobians extends org.apache.commons.math.ode.FirstOrderDifferentialEquations {
     ...
     * @param yDot
     * 		array containing the current value of the time derivative of the state vector
     * @param dFdY
     * 		placeholder array where to put the jacobian of the ODE with respect to the state vector
     * @param dFdP
