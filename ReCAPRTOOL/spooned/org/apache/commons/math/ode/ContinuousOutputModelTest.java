...
public class ContinuousOutputModelTest extends 
junit.framework.TestCase {
    ...
    public void testRandomAccess() throws 
    org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {
    ...
    public void testModelsMerging() throws 
    org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {

        // theoretical solution: y[0] = cos(t), y[1] = sin(t)
        org.apache.commons.math.ode.FirstOrderDifferentialEquations problem = 
        ...
        org.apache.commons.math.ode.FirstOrderIntegrator integ1 = 
        new org.apache.commons.math.ode.nonstiff.DormandPrince853Integrator(0, 1.0, 1.0E-8, 1.0E-8);
        integ1.addStepHandler(cm1);
        integ1.integrate(problem, java.lang.Math.PI, new double[]{ -1.0, 0.0 }, 
        0, new double[2]);
        ...
        org.apache.commons.math.ode.FirstOrderIntegrator integ2 = 
        new org.apache.commons.math.ode.nonstiff.DormandPrince853Integrator(0, 0.1, 1.0E-12, 1.0E-12);
        integ2.addStepHandler(cm2);
        integ2.integrate(problem, (2.0 * (java.lang.Math.PI)), new double[]{ 1.0, 0.0 }, 
        java.lang.Math.PI, new double[2]);
    ...
    public void testErrorConditions() throws 
    org.apache.commons.math.ode.DerivativeException {
    ...
    private boolean checkAppendError(org.apache.commons.math.ode.ContinuousOutputModel cm, 
    double t0, double[] y0, double t1) throws 
    org.apache.commons.math.ode.DerivativeException {
        try {
