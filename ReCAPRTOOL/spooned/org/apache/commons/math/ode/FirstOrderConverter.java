...
public class FirstOrderConverter implements org.apache.commons.math.ode.FirstOrderDifferentialEquations {
     ...
     */     public FirstOrderConverter(final org.apache.commons.math.ode.SecondOrderDifferentialEquations equations) {         this.equations = equations;         dimension = equations.getDimension();
     ...
     */     public int getDimension() {         return 2 * (dimension);
    }
     ...
     */     public void computeDerivatives(final double t, final double[] y, final double[] yDot) throws org.apache.commons.math.ode.DerivativeException {         // split the state vector in two         java.lang.System.arraycopy(y, 0, z, 0, dimension);         java.lang.System.arraycopy(y, dimension, zDot, 0, dimension);
