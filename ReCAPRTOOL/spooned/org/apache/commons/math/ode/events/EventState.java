 ...
 */ public class EventState {
     ...
     */     public EventState(final org.apache.commons.math.ode.events.EventHandler handler, final double maxCheckInterval, final double convergence, final int maxIterationCount) {         this.handler = handler;         this.maxCheckInterval = maxCheckInterval;         this.convergence = java.lang.Math.abs(convergence);         this.maxIterationCount = maxIterationCount;
     ...
     */     public void reinitializeBegin(final double tStart, final double[] yStart) throws org.apache.commons.math.ode.events.EventException {         t0 = tStart;         g0 = handler.g(tStart, yStart);
        g0Positive = (g0) >= 0;
    }
        ...
        try {
            ...
            for (int i = 0; i < n; ++i) {
                ...
                if ((g0Positive) ^ (gb >= 0)) {
                    ...
                    if (((java.lang.Math.abs((root - ta))) <= (convergence)) && ((java.lang.Math.abs((root - (previousEventTime)))) <= (convergence))) {                         // we have either found nothing or found (again ?) a past event, we simply ignore it                         ta = tb;                         ga = gb;}// we were already waiting for this event which was                     // found during a previous call for a step that was                     // rejected, this step must now be accepted since it                     // properly ends exactly at the event occurrence                     // either we were not waiting for the event or it has                     // moved in such a way the step cannot be accepted
                    else                         if ((java.lang.Double.isNaN(previousEventTime)) || ((java.lang.Math.abs(((previousEventTime) - root))) > (convergence))) {                             pendingEventTime = root;                             if ((pendingEvent) && ((java.lang.Math.abs((t1 - (pendingEventTime)))) <= (convergence))) {                                 return false;}                             pendingEvent = true;                             return true;
                        }
            ...
            }else                 if ((cause != null) && (cause instanceof org.apache.commons.math.ode.events.EventException)) {
     ...
     * step.
     */     public double getEventTime() {         return pendingEventTime;
    }
     ...
     */     public void stepAccepted(final double t, final double[] y) throws org.apache.commons.math.ode.events.EventException {         t0 = t;
        g0 = handler.g(t, y);
     ...
     */     public boolean stop() {         return (nextAction) == (org.apache.commons.math.ode.events.EventHandler.STOP);
    }
     ...
     * handler
     */     public boolean reset(final double t, final double[] y) throws org.apache.commons.math.ode.events.EventException {         if (!(pendingEvent)) {
            return false;
        }
        ...
        return ((nextAction) == (org.apache.commons.math.ode.events.EventHandler.RESET_STATE)) || 
        ((nextAction) == (org.apache.commons.math.ode.events.EventHandler.RESET_DERIVATIVES));
