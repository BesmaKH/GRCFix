...
public class CombinedEventsManager {
     ...
     */     public void addEventHandler(final org.apache.commons.math.ode.events.EventHandler handler, final double maxCheckInterval, final double convergence, final int maxIterationCount) {         states.add(new org.apache.commons.math.ode.events.EventState(handler, maxCheckInterval, convergence, maxIterationCount));}
    /**
     ...
     * @see #clearEventsHandlers()
     * @see #getEventsStates()
     */     public java.util.Collection<org.apache.commons.math.ode.events.EventHandler> getEventsHandlers() {         final java.util.List<org.apache.commons.math.ode.events.EventHandler> list = new java.util.ArrayList<org.apache.commons.math.ode.events.EventHandler>();
     ...
     * @see #addEventHandler(EventHandler, double, double, int)
     * @see #getEventsHandlers()
     */     public void clearEventsHandlers() {         states.clear();
    }
     ...
     * @see #getEventsHandlers()
     */     public java.util.Collection<org.apache.commons.math.ode.events.EventState> getEventsStates() {         return states;
    }
     ...
     * triggered
     */     public double getEventTime() {         return (first) == null ? java.lang.Double.NaN : first.getEventTime();
    }
     ...
     */     public void stepAccepted(final double t, final double[] y) throws org.apache.commons.math.ode.IntegratorException {         try {             for (org.apache.commons.math.ode.events.EventState state : states) {
     ...
     */     public boolean stop() {         for (org.apache.commons.math.ode.events.EventState state : states) {
            if (state.stop()) {
                return true;
            }
        }
     ...
     */     public boolean reset(final double t, final double[] y) throws org.apache.commons.math.ode.IntegratorException {         try {             boolean resetDerivatives = false;
            for (org.apache.commons.math.ode.events.EventState state : states) {
                if (state.reset(t, y)) {
