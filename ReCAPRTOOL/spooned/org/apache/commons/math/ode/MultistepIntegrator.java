...
public abstract class MultistepIntegrator extends org.apache.commons.math.ode.nonstiff.AdaptiveStepsizeIntegrator {
     ...
     */     protected MultistepIntegrator(final java.lang.String name, final int nSteps, final int order, final double minStep, final double maxStep, final double scalAbsoluteTolerance, final double scalRelativeTolerance) {         super(name, minStep, maxStep, scalAbsoluteTolerance, scalRelativeTolerance);
        if (nSteps <= 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.INTEGRATION_METHOD_NEEDS_AT_LEAST_ONE_PREVIOUS_POINT, 
            name);
        }

        starter = new org.apache.commons.math.ode.nonstiff.DormandPrince853Integrator(minStep, maxStep, 
     ...
     * 		allowed relative error
     */     protected MultistepIntegrator(final java.lang.String name, final int nSteps, final int order, final double minStep, final double maxStep, final double[] vecAbsoluteTolerance, final double[] vecRelativeTolerance) {         super(name, minStep, maxStep, vecAbsoluteTolerance, vecRelativeTolerance);         starter = new org.apache.commons.math.ode.nonstiff.DormandPrince853Integrator(minStep, maxStep, vecAbsoluteTolerance, 
     ...
     * 		starter integrator
     */     public void setStarterIntegrator(org.apache.commons.math.ode.FirstOrderIntegrator starterIntegrator) {         this.starter = starterIntegrator;
    }
     ...
     */     protected void start(final double t0, final double[] y0, final double t) throws org.apache.commons.math.ode.DerivativeException, org.apache.commons.math.ode.IntegratorException {         // make sure NO user event nor user step handler is triggered,         // this is the task of the top level integrator, not the task         // of the starter integrator         starter.clearEventHandlers();
        ...
        try {
            starter.integrate(new org.apache.commons.math.ode.MultistepIntegrator.CountingDifferentialEquations(y0.length), 
     ...
     */     protected double computeStepGrowShrinkFactor(final double error) {         return java.lang.Math.min(maxGrowth, java.lang.Math.max(minReduction, ((safety) * (java.lang.Math.pow(error, exp)))));}
     ...
     */     private class NordsieckInitializer implements org.apache.commons.math.ode.sampling.StepHandler {
         ...
         * @param n
         * 		problem dimension
         */         public NordsieckInitializer(final int n) {             this.n = n;}
     ...
     */     private static class InitializationCompletedMarkerException extends org.apache.commons.math.ode.DerivativeException {
        ...
        /**
         * Simple constructor.
         */         public InitializationCompletedMarkerException() {             super(((java.lang.Throwable) (null)));
        }
     ...
     */     private class CountingDifferentialEquations implements org.apache.commons.math.ode.ExtendedFirstOrderDifferentialEquations {
         ...
         * @param dimension
         * 		dimension of the problem
         */         public CountingDifferentialEquations(final int dimension) {             this.dimension = dimension;}
