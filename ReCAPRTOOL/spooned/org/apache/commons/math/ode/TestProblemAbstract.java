 ...
 */
public abstract class TestProblemAbstract implements 
org.apache.commons.math.ode.FirstOrderDifferentialEquations {
     ...
     * @param problem
     * 		problem to copy
     */     protected TestProblemAbstract(org.apache.commons.math.ode.TestProblemAbstract problem) {         n = problem.n;
        calls = problem.calls;
        t0 = problem.t0;
        if ((problem.y0) == null) {
            y0 = null;
     ...
     */     protected void setInitialConditions(double t0, double[] y0) {         calls = 0;         n = y0.length;
        this.t0 = t0;
        this.y0 = y0.clone();
    }
     ...
     * @param t1
     * 		final time
     */     protected void setFinalConditions(double t1) {         this.t1 = t1;
    }
     ...
     * @param errorScale
     * 		error scale
     */     protected void setErrorScale(double[] errorScale) {         this.errorScale = errorScale.clone();
    }
     ...
     */     public org.apache.commons.math.ode.events.EventHandler[] getEventsHandlers() {         return new org.apache.commons.math.ode.events.EventHandler[0];
    }
