...
public class ContinuousOutputModel implements 
java.io.Serializable , org.apache.commons.math.ode.sampling.StepHandler {
     ...
     */     public void append(final org.apache.commons.math.ode.ContinuousOutputModel model) throws org.apache.commons.math.ode.DerivativeException {
        ...
        if ((steps.size()) == 0) {
            ...
            if ((forward) ^ (model.forward)) {
                throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                org.apache.commons.math.util.LocalizedFormats.PROPAGATION_DIRECTION_MISMATCH);
            }
            ...
            if ((java.lang.Math.abs(gap)) > (0.001 * (java.lang.Math.abs(step)))) {
                throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                org.apache.commons.math.util.LocalizedFormats.HOLE_BETWEEN_MODELS_TIME_RANGES, java.lang.Math.abs(gap));
            }
     ...
     */     public void handleStep(final org.apache.commons.math.ode.sampling.StepInterpolator interpolator, final boolean isLast) throws org.apache.commons.math.ode.DerivativeException {         if ((steps.size()) == 0) {             initialTime = interpolator.getPreviousTime();
     ...
     */     public void setInterpolatedTime(final double time) {         // initialize the search with the complete steps table
        int iMin = 0;
        ...
        while ((iMax - iMin) > 5) {
            ...
            if (location < 0) {                 iMax = index;                 tMax = 0.5 * ((si.getPreviousTime()) + (si.getCurrentTime()));}// we have found the target step, no need to continue searching
            else                 if (location > 0) {                     iMin = index;                     tMin = 0.5 * ((si.getPreviousTime()) + (si.getCurrentTime()));}else {                     si.setInterpolatedTime(time);                     return;
                }
     ...
     */     public double[] getInterpolatedState() throws org.apache.commons.math.ode.DerivativeException {         return steps.get(index).getInterpolatedState();
    }
     ...
     */     private int locatePoint(final double time, final org.apache.commons.math.ode.sampling.StepInterpolator interval) {         if (forward) {             if (time < (interval.getPreviousTime())) {                 return -1;
