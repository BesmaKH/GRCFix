...
public final class FastFourierTransformerTest extends junit.framework.TestCase {
    ...
    public void testAdHocData() {
        ...
        org.apache.commons.math.complex.Complex[] result;         double tolerance = 1.0E-12;

        double[] x = new double[]{ 1.3, 2.4, 1.7, 4.1, 2.9, 1.7, 5.1, 2.7 };
        org.apache.commons.math.complex.Complex[] y = new org.apache.commons.math.complex.Complex[]{ 
        new org.apache.commons.math.complex.Complex(21.9, 0.0), 
        new org.apache.commons.math.complex.Complex((-2.09497474683058), 1.91507575950825), 
        new org.apache.commons.math.complex.Complex((-2.6), 2.7), 
        new org.apache.commons.math.complex.Complex((-1.10502525316942), (-4.88492424049175)), 
        new org.apache.commons.math.complex.Complex(0.1, 0.0), 
        new org.apache.commons.math.complex.Complex((-1.10502525316942), 4.88492424049175), 
        new org.apache.commons.math.complex.Complex((-2.6), (-2.7)), 
        new org.apache.commons.math.complex.Complex((-2.09497474683058), (-1.91507575950825)) };
    ...
    public void test2DData() {
        ...
        org.apache.commons.math.complex.Complex[][] input = new org.apache.commons.math.complex.Complex[][]{ new org.apache.commons.math.complex.Complex[]{ new org.apache.commons.math.complex.Complex(1, 0), 
        new org.apache.commons.math.complex.Complex(2, 0) }, 
        new org.apache.commons.math.complex.Complex[]{ new org.apache.commons.math.complex.Complex(3, 1), 
        new org.apache.commons.math.complex.Complex(4, 2) } };
        org.apache.commons.math.complex.Complex[][] goodOutput = new org.apache.commons.math.complex.Complex[][]{ new org.apache.commons.math.complex.Complex[]{ new org.apache.commons.math.complex.Complex(5, 
        1.5), new org.apache.commons.math.complex.Complex((-1), (-0.5)) }, new org.apache.commons.math.complex.Complex[]{ new org.apache.commons.math.complex.Complex((-2), 
        (-1.5)), new org.apache.commons.math.complex.Complex(0, 0.5) } };
        ...
        for (int i = 0; i < (input.length); i++) {
            for (int j = 0; j < (input[0].length); j++) {
                junit.framework.Assert.assertEquals(input[i][j].getImaginary(), output2[i][j].getImaginary(), 
                tolerance);
                junit.framework.Assert.assertEquals(input[i][j].getReal(), output2[i][j].getReal(), tolerance);
                junit.framework.Assert.assertEquals(goodOutput[i][j].getImaginary(), output[i][j].getImaginary(), 
                tolerance);
    ...
    public void testSinFunction() throws org.apache.commons.math.MathException {
        ...
        org.apache.commons.math.transform.FastFourierTransformer transformer = new org.apache.commons.math.transform.FastFourierTransformer();
        org.apache.commons.math.complex.Complex[] result;         int N = 1 << 8;
        double min;         double max;         double tolerance = 1.0E-12;
