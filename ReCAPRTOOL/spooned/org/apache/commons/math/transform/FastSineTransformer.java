...
public class FastSineTransformer implements org.apache.commons.math.transform.RealTransformer {
     ...
     * @throws IllegalArgumentException
     * 		if any parameters are invalid
     */     public double[] inversetransform(org.apache.commons.math.analysis.UnivariateRealFunction f, double min, double max, int n) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException {         double[] data = org.apache.commons.math.transform.FastFourierTransformer.sample(f, min, max, n);         data[0] = 0.0;         double scaling_coefficient = 2.0 / n;
        return org.apache.commons.math.transform.FastFourierTransformer.scaleArray(fst(data), scaling_coefficient);
    }
     ...
     */     protected double[] fst(double[] f) throws java.lang.IllegalArgumentException {
        ...
        if ((f[0]) != 0.0) {
            ...
            org.apache.commons.math.util.LocalizedFormats.FIRST_ELEMENT_NOT_ZERO, 
            f[0]);
        }
