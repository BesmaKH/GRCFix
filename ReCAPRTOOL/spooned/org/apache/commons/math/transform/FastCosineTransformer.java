...
public class FastCosineTransformer implements org.apache.commons.math.transform.RealTransformer {
     ...
     */     public double[] transform(double[] f) throws java.lang.IllegalArgumentException {         return fct(f);
    }
     ...
     * @throws IllegalArgumentException
     * 		if any parameters are invalid
     */     public double[] transform2(org.apache.commons.math.analysis.UnivariateRealFunction f, double min, double max, int n) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException {         double[] data = org.apache.commons.math.transform.FastFourierTransformer.sample(f, min, max, n);         double scaling_coefficient = java.lang.Math.sqrt((2.0 / (n - 1)));
     ...
     * @throws IllegalArgumentException
     * 		if any parameters are invalid
     */     public double[] inversetransform(org.apache.commons.math.analysis.UnivariateRealFunction f, double min, double max, int n) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException {         double[] data = org.apache.commons.math.transform.FastFourierTransformer.sample(f, min, max, n);         double scaling_coefficient = 2.0 / (n - 1);
        return org.apache.commons.math.transform.FastFourierTransformer.scaleArray(fct(data), scaling_coefficient);
    }
     ...
     * @throws IllegalArgumentException
     * 		if any parameters are invalid
     */     public double[] inversetransform2(double[] f) throws java.lang.IllegalArgumentException {         return transform2(f);
    }
     ...
     * @throws IllegalArgumentException
     * 		if any parameters are invalid
     */     public double[] inversetransform2(org.apache.commons.math.analysis.UnivariateRealFunction f, double min, double max, int n) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException {         return transform2(f, min, max, n);}
     ...
     */     protected double[] fct(double[] f) throws java.lang.IllegalArgumentException {
        ...
        if (!(org.apache.commons.math.transform.FastFourierTransformer.isPowerOf2(n))) {
            ...
            org.apache.commons.math.util.LocalizedFormats.NOT_POWER_OF_TWO_PLUS_ONE, 
            f.length);
        }
        if (n == 1) {             // trivial case
