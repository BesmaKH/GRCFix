 ...
 */ public class FastHadamardTransformer implements org.apache.commons.math.transform.RealTransformer {
    ...
    /**
     * {@inheritDoc}
     */     public double[] transform(org.apache.commons.math.analysis.UnivariateRealFunction f, double min, double max, int n) throws 
    ...
    /**
     * {@inheritDoc}
     */     public double[] inversetransform(org.apache.commons.math.analysis.UnivariateRealFunction f, double min, double max, int n) throws 
    java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException {
        final double[] unscaled = 
        fht(org.apache.commons.math.transform.FastFourierTransformer.sample(f, min, max, n));
     ...
     */     public int[] transform(int[] f) throws java.lang.IllegalArgumentException {         return fht(f);
    }
     ...
     */     protected double[] fht(double[] x) throws java.lang.IllegalArgumentException {
        ...
        if (!(org.apache.commons.math.transform.FastFourierTransformer.isPowerOf2(n))) {
            ...
            org.apache.commons.math.util.LocalizedFormats.NOT_POWER_OF_TWO, 
            n);
        }
