...
public abstract class IntegerDistributionAbstractTest extends junit.framework.TestCase {
     ...
     * @param name
     * 		
     */     public IntegerDistributionAbstractTest(java.lang.String name) {         super(name);
    }
    ...
    protected void verifyDensities() throws java.lang.Exception {
        for (int i = 0; i < (densityTestPoints.length); i++) {
            junit.framework.Assert.assertEquals(("Incorrect density value returned for " + (densityTestPoints[i])), 
            densityTestValues[i], 
    ...
    protected void verifyCumulativeProbabilities() throws java.lang.Exception {
        for (int i = 0; i < (cumulativeTestPoints.length); i++) {
            junit.framework.Assert.assertEquals(("Incorrect cumulative probability value returned for " + (cumulativeTestPoints[i])), 
    ...
    protected void verifyInverseCumulativeProbabilities() throws java.lang.Exception {
        for (int i = 0; i < (inverseCumulativeTestPoints.length); i++) {
            junit.framework.Assert.assertEquals(("Incorrect inverse cumulative probability value returned for " + 
    ...
    public void testFloatingPointArguments() throws java.lang.Exception {
        for (int i = 0; i < (cumulativeTestPoints.length); i++) {
            ...
            if (i < ((cumulativeTestPoints.length) - 1)) {
                ...
                junit.framework.Assert.assertEquals(((((("Inconsistent probability for discrete range " + 
                "[ ") + arg) + ",") + arg2) + " ]"), 
        ...
        double twod = two;
        double tend = ten;
        junit.framework.Assert.assertEquals(distribution.cumulativeProbability(one, two), 
        distribution.cumulativeProbability(oned, twod), tolerance);
        junit.framework.Assert.assertEquals(distribution.cumulativeProbability(one, two), 
        distribution.cumulativeProbability((oned - (tolerance)), 
        (twod + 0.9)), tolerance);
        junit.framework.Assert.assertEquals(distribution.cumulativeProbability(two, ten), 
    ...
    public void testSampling() throws java.lang.Exception {
        ...
        org.apache.commons.math.distribution.AbstractIntegerDistribution distribution = ((org.apache.commons.math.distribution.AbstractIntegerDistribution) (makeDistribution()));
     ...
     */     protected int[] getCumulativeTestPoints() {         return cumulativeTestPoints;
    }
     ...
     */     protected void setCumulativeTestPoints(int[] cumulativeTestPoints) {         this.cumulativeTestPoints = cumulativeTestPoints;}
     ...
     */     protected int[] getDensityTestPoints() {         return densityTestPoints;
    }
     ...
     */     protected void setDensityTestPoints(int[] densityTestPoints) {         this.densityTestPoints = densityTestPoints;}

    /**
     *
     *
     * @return Returns the densityTestValues.
     */     protected double[] getDensityTestValues() {         return densityTestValues;
    }
     ...
     */     protected void setDensityTestValues(double[] densityTestValues) {         this.densityTestValues = densityTestValues;}

    /**
     *
     *
     * @return Returns the distribution.
     */     protected org.apache.commons.math.distribution.IntegerDistribution getDistribution() {         return distribution;
    }
     ...
     */     protected void setDistribution(org.apache.commons.math.distribution.IntegerDistribution distribution) {         this.distribution = distribution;}
     ...
     */     protected int[] getInverseCumulativeTestValues() {         return inverseCumulativeTestValues;
    }
     ...
     */     protected void setInverseCumulativeTestValues(int[] inverseCumulativeTestValues) {         this.inverseCumulativeTestValues = inverseCumulativeTestValues;}
