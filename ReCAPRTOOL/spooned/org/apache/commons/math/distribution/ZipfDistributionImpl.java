 ...
 */
public class ZipfDistributionImpl extends org.apache.commons.math.distribution.AbstractIntegerDistribution implements 
java.io.Serializable , org.apache.commons.math.distribution.ZipfDistribution {
     ...
     * 		the number of elements
     * @exception IllegalArgumentException if n &le; 0
     */     private void setNumberOfElementsInternal(final int n) throws 
    java.lang.IllegalArgumentException {
        if (n <= 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.INSUFFICIENT_DIMENSION, n, 0);
        }
     ...
     * 		the exponent
     * @exception IllegalArgumentException if s &le; 0.0
     */     private void setExponentInternal(final double s) throws 
    java.lang.IllegalArgumentException {
        if (s <= 0.0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.NOT_POSITIVE_EXPONENT, 
            s);
        }
        this.exponent = s;
    }
     ...
     *
     * @param n
     * 		the term in the series to calculate (must be &ge; 1)
     * @param m
