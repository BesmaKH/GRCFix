 ...
 */
public abstract class AbstractIntegerDistribution extends org.apache.commons.math.distribution.AbstractDistribution implements 
java.io.Serializable , org.apache.commons.math.distribution.IntegerDistribution {
     ...
     */     public double cumulativeProbability(double x) throws org.apache.commons.math.MathException {         return cumulativeProbability(((int) (java.lang.Math.floor(x))));
    }
     ...
     * 		if <code>x0 > x1</code>
     */     @java.lang.Override     public double cumulativeProbability(double x0, double x1) throws org.apache.commons.math.MathException {         if (x0 > x1) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.LOWER_ENDPOINT_ABOVE_UPPER_ENDPOINT, x0, x1);
        }
        if ((java.lang.Math.floor(x0)) < x0) {
            return cumulativeProbability((((int) (java.lang.Math.floor(x0))) + 1), 
            ((int) (java.lang.Math.floor(x1))));// don't want to count mass below x0
        }else {             // x0 is mathematical integer, so use as is
            return cumulativeProbability(((int) (java.lang.Math.floor(x0))), 
            ((int) (java.lang.Math.floor(x1))));
        }
    }
     ...
     * @throws IllegalArgumentException
     * 		if x0 > x1
     */     public double cumulativeProbability(int x0, int x1) throws org.apache.commons.math.MathException {         if (x0 > x1) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.LOWER_ENDPOINT_ABOVE_UPPER_ENDPOINT, x0, x1);
        }
     ...
     * @throws IllegalArgumentException
     * 		if p < 0 or p > 1
     */     public int inverseCumulativeProbability(final double p) throws org.apache.commons.math.MathException {         if ((p < 0.0) || (p > 1.0)) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
     ...
     * @throws IllegalArgumentException
     * 		if sampleSize is not positive
     */     public int[] sample(int sampleSize) throws org.apache.commons.math.MathException {         if (sampleSize <= 0) {             org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.NOT_POSITIVE_SAMPLE_SIZE, sampleSize);
        }
     ...
     * 		if a MathException occurs computing the cumulative probability
     */     private double checkedCumulativeProbability(int argument) throws org.apache.commons.math.FunctionEvaluationException {         double result = java.lang.Double.NaN;
        try {
        ...
        if (java.lang.Double.isNaN(result)) {
            throw new org.apache.commons.math.FunctionEvaluationException(argument, 
            org.apache.commons.math.util.LocalizedFormats.DISCRETE_CUMULATIVE_PROBABILITY_RETURNED_NAN, argument);
        }
        return result;
    }
