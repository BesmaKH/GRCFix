...
public class NormalDistributionTest extends org.apache.commons.math.distribution.ContinuousDistributionAbstractTest {
     ...
     * @param arg0
     * 		
     */     public NormalDistributionTest(java.lang.String arg0) {         super(arg0);
    }
     ...
     */     @java.lang.Override     public org.apache.commons.math.distribution.NormalDistribution makeDistribution() {
     ...
     */     @java.lang.Override     public double[] makeDensityTestValues() {
        return new double[]{ 0.00240506434076, 0.019037244431, 0.0417464784322, 0.0736683145538, 0.12535595138, 
        0.00240506434076, 0.019037244431, 0.0417464784322, 0.0736683145538, 0.12535595138 };
    }
    ...
    public void testQuantiles() throws java.lang.Exception {
        ...
        0.00316560600853, 9.55930184035E-5, 1.06194251052E-6 });
        verifyQuantiles();
        verifyDensities();
        ...
        0.00443184841194, 1.33830225765E-4, 1.48671951473E-6 });
        verifyQuantiles();
        verifyDensities();
        ...
        0.539909665132, 0.0443184841194, 0.00133830225765, 1.48671951473E-5 });
        verifyQuantiles();
        verifyDensities();
    }
