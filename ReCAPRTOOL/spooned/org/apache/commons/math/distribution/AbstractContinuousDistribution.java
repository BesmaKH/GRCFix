...
java.io.Serializable , org.apache.commons.math.distribution.ContinuousDistribution {
     ...
     * @since 2.1
     */     public double density(double x) throws org.apache.commons.math.MathRuntimeException {         throw new org.apache.commons.math.MathRuntimeException(new java.lang.UnsupportedOperationException(), org.apache.commons.math.util.LocalizedFormats.NO_DENSITY_FOR_THIS_DISTRIBUTION);
    }
     ...
     * 		probability.
     */     public double inverseCumulativeProbability(final double p) throws org.apache.commons.math.MathException {         if ((p < 0.0) || (p > 1.0)) {
        ...
        new org.apache.commons.math.analysis.UnivariateRealFunction() {
            public double value(double x) throws org.apache.commons.math.FunctionEvaluationException {
                ...
                if (java.lang.Double.isNaN(ret)) {
                    throw new org.apache.commons.math.FunctionEvaluationException(x, 
                    org.apache.commons.math.util.LocalizedFormats.CUMULATIVE_PROBABILITY_RETURNED_NAN, x, p);
                }
                return ret;
            }
        };
        ...
        try {
             ...
             */
            if (
            (java.lang.Math.abs(rootFindingFunction.value(lowerBound))) < (getSolverAbsoluteAccuracy())) {
                return lowerBound;
            }
        ...
        // absolute accuracy different from BrentSolver default         org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils.solve(rootFindingFunction, 
     ...
     */     public double[] sample(int sampleSize) throws org.apache.commons.math.MathException {         if (sampleSize <= 0) {             org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.NOT_POSITIVE_SAMPLE_SIZE, sampleSize);
        }
