...
java.io.Serializable , org.apache.commons.math.distribution.PoissonDistribution {
     ...
     */     private void setNormalAndMeanInternal(org.apache.commons.math.distribution.NormalDistribution z, double p) {         if (p <= 0) {
            ...
            org.apache.commons.math.util.LocalizedFormats.NOT_POSITIVE_POISSON_MEAN, p);
        }
        mean = p;
        normal = z;
        normal.setMean(p);
