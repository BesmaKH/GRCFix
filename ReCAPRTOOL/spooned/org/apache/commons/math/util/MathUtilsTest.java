 ...
 */ public final class MathUtilsTest extends junit.framework.TestCase {
    ...
    private long binomialCoefficient(int n, int k) throws java.lang.ArithmeticException {
        if ((org.apache.commons.math.util.MathUtilsTest.binomialCache.size()) > n) {
            java.lang.Long cachedResult = org.apache.commons.math.util.MathUtilsTest.binomialCache.get(n).get(java.lang.Integer.valueOf(k));
        ...
        if ((n == k) || (k == 0)) {             result = 1;}// Reduce stack depth for larger values of n
        else             if ((k == 1) || (k == (n - 1))) {                 result = n;}else {                 if (k < (n - 100)) {                     binomialCoefficient((n - 100), k);
                }
                if (k > 100) {
                    binomialCoefficient((n - 100), (k - 100));
                }
                result = org.apache.commons.math.util.MathUtils.addAndCheck(binomialCoefficient((n - 1), (k - 1)), 
        ...
        for (int i = org.apache.commons.math.util.MathUtilsTest.binomialCache.size(); i < (n + 1); i++) {
            org.apache.commons.math.util.MathUtilsTest.binomialCache.add(new java.util.HashMap<java.lang.Integer, java.lang.Long>());
        }
        org.apache.commons.math.util.MathUtilsTest.binomialCache.get(n).put(java.lang.Integer.valueOf(k), java.lang.Long.valueOf(result));
        return result;
    }
    ...
    /**
     * Verify that b(0,0) = 1
     */     public void test0Choose0() {         junit.framework.Assert.assertEquals(org.apache.commons.math.util.MathUtils.binomialCoefficientDouble(0, 0), 1.0, 0);
    ...
    public void testBinomialCoefficient() {
        ...
        for (int i = 0; i < (n.length); i++) {
            ...
            junit.framework.Assert.assertEquals((((n[i]) + " choose ") + (k[i])), expected, 
            org.apache.commons.math.util.MathUtils.binomialCoefficient(n[i], k[i]));
            junit.framework.Assert.assertEquals((((n[i]) + " choose ") + (k[i])), expected, 
            org.apache.commons.math.util.MathUtils.binomialCoefficientDouble(n[i], k[i]), 0.0);
            junit.framework.Assert.assertEquals((((("log(" + (n[i])) + " choose ") + (k[i])) + ")"), java.lang.Math.log(expected), 
            org.apache.commons.math.util.MathUtils.binomialCoefficientLog(n[i], k[i]), 0.0);
        }
    }
        ...
        for (int n = 0; n <= 200; n++) {
            for (int k = 0; k <= n; k++) {
                ...
                if ((!shouldThrow) && (exactResult > 1)) {
                    junit.framework.Assert.assertEquals(((n + " choose ") + k), 1.0, 
                    ((org.apache.commons.math.util.MathUtils.binomialCoefficientDouble(n, k)) / exactResult), 1.0E-10);
                    junit.framework.Assert.assertEquals(((n + " choose ") + k), 1, 
                    ((org.apache.commons.math.util.MathUtils.binomialCoefficientLog(n, k)) / (java.lang.Math.log(exactResult))), 1.0E-10);
                }
            }
        }
    ...
    public void testBinomialCoefficientFail() {
        ...
        junit.framework.Assert.assertTrue("expecting infinite binomial coefficient", java.lang.Double.isInfinite(
        x));
    }
    ...
    public void testEqualsIncludingNaN() {
        ...
        for (int i = 0; i < (testArray.length); i++) {
            for (int j = 0; j < (testArray.length); j++) {
                if (i == j) {
                    junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(testArray[i], testArray[j]));
                    junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(testArray[j], testArray[i]));
                }else {
                    junit.framework.Assert.assertTrue((!(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(testArray[i], testArray[j]))));
                    junit.framework.Assert.assertTrue((!(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(testArray[j], testArray[i]))));
                }
    ...
    public void testEqualsWithAllowedDelta() {
        ...
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(java.lang.Double.NaN, java.lang.Double.NaN, 1.0));
    ...
    public void testEqualsIncludingNaNWithAllowedDelta() {
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(153.0, 153.0, 0.0625));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(153.0, 153.0625, 0.0625));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(152.9375, 153.0, 0.0625));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.NaN, java.lang.Double.NaN, 1.0));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.POSITIVE_INFINITY, java.lang.Double.POSITIVE_INFINITY, 1.0));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.NEGATIVE_INFINITY, java.lang.Double.NEGATIVE_INFINITY, 1.0));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.NEGATIVE_INFINITY, java.lang.Double.POSITIVE_INFINITY, 1.0));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(153.0, 153.0625, 0.0624));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(152.9374, 153.0, 0.0625));
    }

    public void testEqualsWithAllowedUlps() {
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(0.0, (-0.0), 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(1.0, (1 + (java.lang.Math.ulp(1.0))), 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(1.0, (1 + (2 * (java.lang.Math.ulp(1.0)))), 1));

        final double nUp1 = java.lang.Math.nextUp(1.0);
        final double nnUp1 = java.lang.Math.nextUp(nUp1);
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(1.0, nUp1, 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(nUp1, nnUp1, 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(1.0, nnUp1, 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(0.0, java.lang.Math.ulp(0.0), 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(0.0, (-(java.lang.Math.ulp(0.0))), 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(153.0, 153.0, 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(153.0, 153.00000000000003, 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(153.0, 153.00000000000006, 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(153.0, 152.99999999999997, 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(153, 152.99999999999994, 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals((-128.0), (-127.99999999999999), 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals((-128.0), (-127.99999999999997), 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals((-128.0), (-128.00000000000003), 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals((-128.0), (-128.00000000000006), 1));
        ...
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(java.lang.Double.NaN, java.lang.Double.NaN, 1));
    ...
    public void testEqualsIncludingNaNWithAllowedUlps() {
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(0.0, (-0.0), 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(1.0, (1 + (java.lang.Math.ulp(1.0))), 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(1.0, (1 + (2 * (java.lang.Math.ulp(1.0)))), 1));

        final double nUp1 = java.lang.Math.nextUp(1.0);
        final double nnUp1 = java.lang.Math.nextUp(nUp1);
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(1.0, nUp1, 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(nUp1, nnUp1, 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(1.0, nnUp1, 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(0.0, java.lang.Math.ulp(0.0), 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(0.0, (-(java.lang.Math.ulp(0.0))), 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(153.0, 153.0, 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(153.0, 153.00000000000003, 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(153.0, 153.00000000000006, 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(153.0, 152.99999999999997, 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(153, 152.99999999999994, 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN((-128.0), (-127.99999999999999), 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN((-128.0), (-127.99999999999997), 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN((-128.0), (-128.00000000000003), 1));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN((-128.0), (-128.00000000000006), 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.POSITIVE_INFINITY, java.lang.Double.POSITIVE_INFINITY, 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.MAX_VALUE, java.lang.Double.POSITIVE_INFINITY, 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.NEGATIVE_INFINITY, java.lang.Double.NEGATIVE_INFINITY, 1));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN((-(java.lang.Double.MAX_VALUE)), java.lang.Double.NEGATIVE_INFINITY, 1));

        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.NaN, java.lang.Double.NaN, 1));

        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(java.lang.Double.NEGATIVE_INFINITY, java.lang.Double.POSITIVE_INFINITY, 100000));
    }
     ...
     */     public void testArrayEquals() {         junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(new double[]{ 1.0 }, null));
        ...
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equals(new double[]{ 
        java.lang.Double.NaN, java.lang.Double.POSITIVE_INFINITY, 
        java.lang.Double.NEGATIVE_INFINITY, 1.0, 0.0 }, 
        new double[]{ 
        java.lang.Double.NaN, java.lang.Double.POSITIVE_INFINITY, 
        java.lang.Double.NEGATIVE_INFINITY, 1.0, 0.0 }));

        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(new double[]{ java.lang.Double.POSITIVE_INFINITY }, 
        new double[]{ java.lang.Double.NEGATIVE_INFINITY }));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equals(new double[]{ 1.0 }, 
        new double[]{ org.apache.commons.math.util.MathUtils.nextAfter(1.0, 2.0) }));

    }

    public void testArrayEqualsIncludingNaN() {
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(new double[]{ 1.0 }, null));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(null, new double[]{ 1.0 }));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(((double[]) (null)), ((double[]) (null))));

        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(new double[]{ 1.0 }, new double[0]));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(new double[]{ 1.0 }, new double[]{ 1.0 }));
        junit.framework.Assert.assertTrue(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(new double[]{ 
        java.lang.Double.NaN, java.lang.Double.POSITIVE_INFINITY, 
        java.lang.Double.NEGATIVE_INFINITY, 1.0, 0.0 }, 
        new double[]{ 
        java.lang.Double.NaN, java.lang.Double.POSITIVE_INFINITY, 
        ...
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(new double[]{ java.lang.Double.POSITIVE_INFINITY }, 
        new double[]{ java.lang.Double.NEGATIVE_INFINITY }));
        junit.framework.Assert.assertFalse(org.apache.commons.math.util.MathUtils.equalsIncludingNaN(new double[]{ 1.0 }, 
        new double[]{ org.apache.commons.math.util.MathUtils.nextAfter(org.apache.commons.math.util.MathUtils.nextAfter(1.0, 2.0), 2.0) }));
    }
    ...
    public void testArrayHash() {
        ...
        junit.framework.Assert.assertEquals(org.apache.commons.math.util.MathUtils.hash(new double[]{ 
        java.lang.Double.NaN, java.lang.Double.POSITIVE_INFINITY, 
        java.lang.Double.NEGATIVE_INFINITY, 1.0, 0.0 }), 

        org.apache.commons.math.util.MathUtils.hash(new double[]{ 
        java.lang.Double.NaN, java.lang.Double.POSITIVE_INFINITY, 
        java.lang.Double.NEGATIVE_INFINITY, 1.0, 0.0 }));

        junit.framework.Assert.assertFalse(((org.apache.commons.math.util.MathUtils.hash(new double[]{ 1.0 })) == 
        (org.apache.commons.math.util.MathUtils.hash(new double[]{ org.apache.commons.math.util.MathUtils.nextAfter(1.0, 2.0) }))));
        junit.framework.Assert.assertFalse(((org.apache.commons.math.util.MathUtils.hash(new double[]{ 1.0 })) == 
        (org.apache.commons.math.util.MathUtils.hash(new double[]{ 1.0, 1.0 }))));
    }
    ...
    public void testLcmLong() {
        ...
        junit.framework.Assert.assertEquals((((long) (java.lang.Integer.MAX_VALUE)) * ((java.lang.Integer.MAX_VALUE) - 1)), 
        org.apache.commons.math.util.MathUtils.lcm(((long) (java.lang.Integer.MAX_VALUE)), ((java.lang.Integer.MAX_VALUE) - 1)));
        try {
    ...
    public void testNormalizeArray() {
        ...
        org.apache.commons.math.util.MathUtils.normalizeArray(testValues1, 1), 
        java.lang.Double.MIN_VALUE);

        double[] testValues2 = new double[]{ -1, -1, 1 };
        org.apache.commons.math.TestUtils.assertEquals(
        new double[]{ 1, 1, -1 }, 
        org.apache.commons.math.util.MathUtils.normalizeArray(testValues2, 1), 
        java.lang.Double.MIN_VALUE);

        // Ignore NaNs
        double[] testValues3 = new double[]{ -1, -1, java.lang.Double.NaN, 1, java.lang.Double.NaN };
        org.apache.commons.math.TestUtils.assertEquals(
        new double[]{ 1, 1, java.lang.Double.NaN, -1, java.lang.Double.NaN }, 
        org.apache.commons.math.util.MathUtils.normalizeArray(testValues3, 1), 
        java.lang.Double.MIN_VALUE);
    ...
    public void testPow() {
        ...
        java.math.BigInteger bigOne = 
        new java.math.BigInteger(("1543786922199448028351389769265814882661837148" + 
    ...
    public void testCheckOrder() {
        org.apache.commons.math.util.MathUtils.checkOrder(new double[]{ -15, -5.5, -1, 2, 15 }, 
        org.apache.commons.math.util.MathUtils.Order.Direction.INCREASING, true);
        org.apache.commons.math.util.MathUtils.checkOrder(new double[]{ -15, -5.5, -1, 2, 2 }, 
        org.apache.commons.math.util.MathUtils.Order.Direction.INCREASING, false);
        org.apache.commons.math.util.MathUtils.checkOrder(new double[]{ 3, -5.5, -11, -27.5 }, 
        org.apache.commons.math.util.MathUtils.Order.Direction.DECREASING, true);
        org.apache.commons.math.util.MathUtils.checkOrder(new double[]{ 3, 0, 0, -5.5, -11, -27.5 }, 
        org.apache.commons.math.util.MathUtils.Order.Direction.DECREASING, false);

        try {
            org.apache.commons.math.util.MathUtils.checkOrder(new double[]{ -15, -5.5, -1, -1, 2, 15 }, 
            org.apache.commons.math.util.MathUtils.Order.Direction.INCREASING, true);
        ...
        try {
            org.apache.commons.math.util.MathUtils.checkOrder(new double[]{ 3, 3, -5.5, -11, -27.5 }, 
            org.apache.commons.math.util.MathUtils.Order.Direction.DECREASING, true);
            junit.framework.Assert.fail("an exception should have been thrown");
        } catch (org.apache.commons.math.exception.NonMonotonousSequenceException e) {
            // Expected
        ...
        try {
            org.apache.commons.math.util.MathUtils.checkOrder(new double[]{ 3, -1, 0, -5.5, -11, -27.5 }, 
            org.apache.commons.math.util.MathUtils.Order.Direction.DECREASING, false);
            junit.framework.Assert.fail("an exception should have been thrown");
        } catch (org.apache.commons.math.exception.NonMonotonousSequenceException e) {
            // Expected
