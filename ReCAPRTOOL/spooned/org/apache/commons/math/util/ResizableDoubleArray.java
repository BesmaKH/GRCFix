 ...
 */ public class ResizableDoubleArray implements java.io.Serializable , org.apache.commons.math.util.DoubleArray {
     ...
     */     public ResizableDoubleArray(int initialCapacity) {         setInitialCapacity(initialCapacity);         internalArray = new double[this.initialCapacity];
    }
     ...
     */     public ResizableDoubleArray(int initialCapacity, float expansionFactor) {         this.expansionFactor = expansionFactor;         setInitialCapacity(initialCapacity);
        internalArray = new double[initialCapacity];
     ...
     * @throws IllegalArgumentException
     * 		if parameters are not valid
     */     public ResizableDoubleArray(int initialCapacity, float expansionFactor, float contractionCriteria) {         this.expansionFactor = expansionFactor;         setContractionCriteria(contractionCriteria);         setInitialCapacity(initialCapacity);
        internalArray = new double[initialCapacity];
    }
     ...
     * @throws IllegalArgumentException
     * 		if parameters are not valid
     */     public ResizableDoubleArray(int initialCapacity, float expansionFactor, float contractionCriteria, int expansionMode) {         this.expansionFactor = expansionFactor;         setContractionCriteria(contractionCriteria);         setInitialCapacity(initialCapacity);
     ...
     */     public synchronized double substituteMostRecentElement(double value) {
        if ((numElements) < 1) {
            throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException(
            org.apache.commons.math.util.LocalizedFormats.CANNOT_SUBSTITUTE_ELEMENT_FROM_EMPTY_ARRAY);
        }
     ...
     */     protected void checkContractExpand(float contraction, float expansion) {         if (contraction < expansion) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.CONTRACTION_CRITERIA_SMALLER_THAN_EXPANSION_FACTOR, 
            contraction, expansion);
        }

        if (contraction <= 1.0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.CONTRACTION_CRITERIA_SMALLER_THAN_ONE, 
            contraction);
        }

        if (expansion <= 1.0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.EXPANSION_FACTOR_SMALLER_THAN_ONE, 
            expansion);
        }
    }
     ...
     */     private synchronized void discardExtremeElements(int i, boolean front) { 
        ...
        if (i > (numElements)) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.TOO_MANY_ELEMENTS_TO_DISCARD_FROM_ARRAY, i, numElements);}// "Subtract" this number of discarded from numElements
        else             if (i < 0) {                 throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.CANNOT_DISCARD_NEGATIVE_NUMBER_OF_ELEMENTS, i);}else {                 numElements -= i;                 if (front)                     startIndex += i;
            }
        if (shouldContract()) {
            contract();
        }
     ...
     */     public synchronized double getElement(int index) {         if (index >= (numElements)) {
            throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException(
            org.apache.commons.math.util.LocalizedFormats.INDEX_LARGER_THAN_MAX, 
            index, ((numElements) - 1));
        }else             if (index >= 0) {
                return internalArray[((startIndex) + index)];
            }else {
                throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException(
                org.apache.commons.math.util.LocalizedFormats.CANNOT_RETRIEVE_AT_NEGATIVE_INDEX, 
                index);
            }
    }
     ...
     */     public synchronized double[] getElements() {
        ...
        java.lang.System.arraycopy(internalArray, startIndex, elementArray, 0, 
        numElements);
        return elementArray;
    }
     ...
     * 		if <code>index</code> is less than
     * 		zero.
     */     public synchronized void setElement(int index, double value) {         if (index < 0) {             throw org.apache.commons.math.MathRuntimeException.createArrayIndexOutOfBoundsException(
            org.apache.commons.math.util.LocalizedFormats.CANNOT_SET_AT_NEGATIVE_INDEX, 
            index);
        }
     ...
     */     public void setExpansionFactor(float expansionFactor) {         checkContractExpand(getContractionCriteria(), expansionFactor);         // The check above verifies that the expansion factor is > 1.0;
        synchronized(this) {
     ...
     */     public void setExpansionMode(int expansionMode) {         if ((expansionMode != (org.apache.commons.math.util.ResizableDoubleArray.MULTIPLICATIVE_MODE)) && 
        (expansionMode != (org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE))) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.UNSUPPORTED_EXPANSION_MODE, 
     ...
     * 		positive.
     */     protected void setInitialCapacity(int initialCapacity) {         if (initialCapacity > 0) {
            synchronized(this) {
                this.initialCapacity = initialCapacity;
            }
        }else {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.INITIAL_CAPACITY_NOT_POSITIVE, 
            initialCapacity);
        }
    }
     ...
     */     public synchronized void setNumElements(int i) {
        ...
        if (i < 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.INDEX_NOT_POSITIVE, 
            i);
        }
