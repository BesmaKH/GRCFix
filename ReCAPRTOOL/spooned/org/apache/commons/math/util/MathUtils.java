 ...
 */ public final class MathUtils {
     ...
     */     private static final long[] FACTORIALS = new long[]{ 1L, 1L, 2L, 
    6L, 24L, 120L, 
    720L, 5040L, 40320L, 
     ...
     * 		int
     * @since 1.1
     */     public static int addAndCheck(int x, int y) {         long s = ((long) (x)) + ((long) (y));         if ((s < (java.lang.Integer.MIN_VALUE)) || (s > (java.lang.Integer.MAX_VALUE))) {
     ...
     * 		long
     * @since 1.2
     */     public static long addAndCheck(long a, long b) {         return org.apache.commons.math.util.MathUtils.addAndCheck(a, b, "overflow: add");}
     ...
     * 		long
     * @since 1.2
     */     private static long addAndCheck(long a, long b, java.lang.String msg) {         long ret;         if (a > b) {             // use symmetry to reduce boundary cases
     ...
     * 		by a long integer.
     */     public static long binomialCoefficient(final int n, final int k) {         org.apache.commons.math.util.MathUtils.checkBinomial(n, k);         if ((n == k) || (k == 0)) {             return 1;
        }
        if ((k == 1) || (k == (n - 1))) {
            return n;
        }
        ...
        // unnecessary.
        if (n <= 61) {             // For n <= 61, the naive implementation cannot overflow.             int i = (n - k) + 1;             for (int j = 1; j <= k; j++) {                 result = (result * i) / j;                 i++;}}// For n > 61 but n <= 66, the result cannot overflow,         // but we must take care not to overflow intermediate values.         // We know that (result * i) is divisible by j,         // but (result * i) may overflow, so we split j:         // Filter out the gcd, d, so j/d and i/d are integer.         // result is divisible by (j/d) because (j/d)         // is relative prime to (i/d) and is a divisor of         // result * (i/d).         // For n > 66, a result overflow might occur, so we check         // the multiplication, taking care to not overflow         // unnecessary.
        else             if (n <= 66) {                 int i = (n - k) + 1;                 for (int j = 1; j <= k; j++) {                     final long d = org.apache.commons.math.util.MathUtils.gcd(i, j);                     result = (result / (j / d)) * (i / d);                     i++;}}else {                 int i = (n - k) + 1;                 for (int j = 1; j <= k; j++) {
     ...
     * @throws IllegalArgumentException
     * 		if preconditions are not met.
     */     public static double binomialCoefficientDouble(final int n, final int k) {         org.apache.commons.math.util.MathUtils.checkBinomial(n, k);         if ((n == k) || (k == 0)) {
            return 1.0;
        }
        if ((k == 1) || (k == (n - 1))) {
            return n;
     ...
     * @throws IllegalArgumentException
     * 		if preconditions are not met.
     */     public static double binomialCoefficientLog(final int n, final int k) {         org.apache.commons.math.util.MathUtils.checkBinomial(n, k);         if ((n == k) || (k == 0)) {
            return 0;
        }
        if ((k == 1) || (k == (n - 1))) {
     ...
     */     private static void checkBinomial(final int n, final int k) throws java.lang.IllegalArgumentException {         if (n < k) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.BINOMIAL_INVALID_PARAMETERS_ORDER, 
            n, k);
        }
        if (n < 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.BINOMIAL_NEGATIVE_PARAMETER, 
            n);
        }
    }
     ...
     */     public static int compareTo(double x, double y, double eps) {         if (org.apache.commons.math.util.MathUtils.equals(x, y, eps)) {             return 0;
        }else             if (x < y) {
                return -1;
            }
        return 1;
     ...
     */     public static boolean equalsIncludingNaN(double x, double y) {         return ((java.lang.Double.isNaN(x)) && (java.lang.Double.isNaN(y))) || (org.apache.commons.math.util.MathUtils.equals(x, y, 1));
    }
     ...
     */     public static boolean equals(double x, double y, double eps) {         return (org.apache.commons.math.util.MathUtils.equals(x, y, 1)) || ((java.lang.Math.abs((y - x))) <= eps);}
     ...
     * @return {@code true} if the values are equal or within range of each other,
     * or both are NaN.
     */     public static boolean equalsIncludingNaN(double x, double y, double eps) {         return (org.apache.commons.math.util.MathUtils.equalsIncludingNaN(x, y)) || ((java.lang.Math.abs((y - x))) <= eps);}
     ...
     */     public static boolean equals(double x, double y, int maxUlps) {         // Check that "maxUlps" is non-negative and small enough so that         // NaN won't compare as equal to anything (except another NaN).
        ...
        final boolean isEqual = (java.lang.Math.abs((xInt - yInt))) <= maxUlps;
     ...
     */     public static boolean equalsIncludingNaN(double x, double y, int maxUlps) {         return ((java.lang.Double.isNaN(x)) && (java.lang.Double.isNaN(y))) || (org.apache.commons.math.util.MathUtils.equals(x, y, maxUlps));}
     ...
     * useful (see e.g. {@link #equalsIncludingNaN(double[],double[])
     * equalsIncludingNaN}.
     */     public static boolean equals(double[] x, double[] y) {         if ((x == null) || (y == null)) {
     ...
     * equal elements
     */     public static boolean equalsIncludingNaN(double[] x, double[] y) {         if ((x == null) || (y == null)) {
            return !((x == null) ^ (y == null));
        }
        if ((x.length) != (y.length)) {
            return false;
     ...
     * @throws IllegalArgumentException
     * 		if n < 0
     */     public static long factorial(final int n) {         if (n < 0) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.FACTORIAL_NEGATIVE_PARAMETER, 
            n);
        }
        if (n > 20) {
     ...
     * @throws IllegalArgumentException
     * 		if n < 0
     */     public static double factorialDouble(final int n) {         if (n < 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.FACTORIAL_NEGATIVE_PARAMETER, 
            n);
        }
     ...
     * @throws IllegalArgumentException
     * 		if preconditions are not met.
     */     public static double factorialLog(final int n) {         if (n < 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.FACTORIAL_NEGATIVE_PARAMETER, 
            n);
        }
     ...
     * @since 1.1
     */     public static int gcd(final int p, final int q) {         int u = p;         int v = q;
        if ((u == 0) || (v == 0)) {
            if ((u == (java.lang.Integer.MIN_VALUE)) || (v == (java.lang.Integer.MIN_VALUE))) {
                ...
                org.apache.commons.math.util.LocalizedFormats.GCD_OVERFLOW_32_BITS, 
                p, q);
            }
     ...
     * 		value
     * @since 2.1
     */     public static long gcd(final long p, final long q) {         long u = p;         long v = q;
        if ((u == 0) || (v == 0)) {
            if ((u == (java.lang.Long.MIN_VALUE)) || (v == (java.lang.Long.MIN_VALUE))) {
                throw org.apache.commons.math.MathRuntimeException.createArithmeticException(
                org.apache.commons.math.util.LocalizedFormats.GCD_OVERFLOW_64_BITS, 
                p, q);
            }
            return (java.lang.Math.abs(u)) + (java.lang.Math.abs(v));
        }
     ...
     * 		value
     * @since 1.1
     */     public static int lcm(int a, int b) {         if ((a == 0) || (b == 0)) {
            return 0;
        }
        ...
        if (lcm == (java.lang.Integer.MIN_VALUE)) {
            throw org.apache.commons.math.MathRuntimeException.createArithmeticException(
            org.apache.commons.math.util.LocalizedFormats.LCM_OVERFLOW_32_BITS, 
            a, b);
        }
        return lcm;
    }
     ...
     * 		value
     * @since 2.1
     */     public static long lcm(long a, long b) {         if ((a == 0) || (b == 0)) {             return 0;
        }
        ...
        if (lcm == (java.lang.Long.MIN_VALUE)) {
            throw org.apache.commons.math.MathRuntimeException.createArithmeticException(
            org.apache.commons.math.util.LocalizedFormats.LCM_OVERFLOW_64_BITS, 
            a, b);
        }
        return lcm;
    }
     ...
     * 		int
     * @since 1.1
     */     public static int mulAndCheck(int x, int y) {         long m = ((long) (x)) * ((long) (y));         if ((m < (java.lang.Integer.MIN_VALUE)) || (m > (java.lang.Integer.MAX_VALUE))) {
     ...
     * 		long
     * @since 1.2
     */     public static long mulAndCheck(long a, long b) {         long ret;         java.lang.String msg = "overflow: multiply";
        if (a > b) {
            ...
            // assert a == 0
            if (a < 0) {                 // check for negative overflow with negative a, positive b                 // assert b == 0
                if (b < 0) {                     // check for positive overflow with negative a, negative b
                    if (a >= ((java.lang.Long.MAX_VALUE) / b)) {                         ret = a * b;}else {                         throw new java.lang.ArithmeticException(msg);}}// check for negative overflow with negative a, positive b                 // assert b == 0
                else                     if (b > 0) {                         if (((java.lang.Long.MIN_VALUE) / b) <= a) {                             ret = a * b;}else {                             throw new java.lang.ArithmeticException(msg);}}else {                         ret = 0;}}// assert a > 0             // assert b > 0             // check for positive overflow with positive a, positive b             // assert a == 0
            else                 if (a > 0) {                     if (a <= ((java.lang.Long.MAX_VALUE) / b)) {                         ret = a * b;}else {                         throw new java.lang.ArithmeticException(msg);}}else {                     ret = 0;}}         return ret;}
     ...
     */     public static double nextAfter(double d, double direction) {
        ...
        if ((d * (direction - d)) >= 0) {
            ...
            if (mantissa == 4503599627370495L) {
                return java.lang.Double.longBitsToDouble((sign | 
                (exponent + 4503599627370496L)));
            }else {
                return java.lang.Double.longBitsToDouble(((sign | 
                exponent) | (mantissa + 1)));
            }
     ...
     * @since 2.1
     */     public static double[] normalizeArray(double[] values, double normalizedSum) throws java.lang.ArithmeticException, java.lang.IllegalArgumentException {         if (java.lang.Double.isInfinite(normalizedSum)) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.NORMALIZE_INFINITE);
        }
        if (java.lang.Double.isNaN(normalizedSum)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.NORMALIZE_NAN);
        }
        double sum = 0.0;
        ...
        for (int i = 0; i < len; i++) {
            if (java.lang.Double.isInfinite(values[i])) {
                throw org.apache.commons.math.MathRuntimeException.createArithmeticException(
                org.apache.commons.math.util.LocalizedFormats.INFINITE_ARRAY_ELEMENT, values[i], i);
            }
        ...
        if (sum == 0) {
            throw org.apache.commons.math.MathRuntimeException.createArithmeticException(org.apache.commons.math.util.LocalizedFormats.ARRAY_SUMS_TO_ZERO);
        }
        for (int i = 0; i < len; i++) {
            if (java.lang.Double.isNaN(values[i])) {
     ...
     * @return the rounded value.
     * @since 1.1
     */     public static double round(double x, int scale, int roundingMethod) {         try {             return new java.math.BigDecimal(
     ...
     * @return the rounded value.
     * @since 1.1
     */     public static float round(float x, int scale) {         return org.apache.commons.math.util.MathUtils.round(x, scale, java.math.BigDecimal.ROUND_HALF_UP);
    }
     ...
     * @return the rounded value.
     * @since 1.1
     */     public static float round(float x, int scale, int roundingMethod) {         float sign = org.apache.commons.math.util.MathUtils.indicator(x);         float factor = ((float) (java.lang.Math.pow(10.0F, scale))) * sign;
     ...
     */     private static double roundUnscaled(double unscaled, double sign, int roundingMethod) {         switch (roundingMethod) {
            ...
            case java.math.BigDecimal.ROUND_HALF_EVEN :                 {
                    ...
                    // odd
                    if (fraction > 0.5) {                         unscaled = java.lang.Math.ceil(unscaled);}// The following equality test is intentional and needed for rounding purposes                     // even                     // odd
                    else                         if (fraction < 0.5) {                             unscaled = java.lang.Math.floor(unscaled);}else {                             if (((java.lang.Math.floor(unscaled)) / 2.0) == (java.lang.Math.floor(((java.lang.Math.floor(unscaled)) / 2.0)))) {                                 unscaled = java.lang.Math.floor(unscaled);}else {                                 unscaled = java.lang.Math.ceil(unscaled);}
                        }
                    break;
                }
            ...
            default :
                throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                org.apache.commons.math.util.LocalizedFormats.INVALID_ROUNDING_METHOD, 
                roundingMethod, 
     ...
     * 		int
     * @since 1.1
     */     public static int subAndCheck(int x, int y) {         long s = ((long) (x)) - ((long) (y));         if ((s < (java.lang.Integer.MIN_VALUE)) || (s > (java.lang.Integer.MAX_VALUE))) {
     ...
     * 		long
     * @since 1.2
     */     public static long subAndCheck(long a, long b) {         long ret;         java.lang.String msg = "overflow: subtract";
     ...
     */     public static int pow(final int k, int e) throws java.lang.IllegalArgumentException {
        if (e < 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.POWER_NEGATIVE_PARAMETERS, 
            k, e);
        }
     ...
     */     public static double distance1(double[] p1, double[] p2) {         double sum = 0;
     ...
     * 		the second point
     * @return the L<sub>1</sub> distance between the two points
     */     public static int distance1(int[] p1, int[] p2) {         int sum = 0;
        for (int i = 0; i < (p1.length); i++) {
            sum += java.lang.Math.abs(((p1[i]) - (p2[i])));
        }
        return sum;
     ...
     */     public static double distance(double[] p1, double[] p2) {         double sum = 0;
        for (int i = 0; i < (p1.length); i++) {
     ...
     * 		the second point
     * @return the L<sub>2</sub> distance between the two points
     */     public static double distance(int[] p1, int[] p2) {         double sum = 0;
        for (int i = 0; i < (p1.length); i++) {
            final double dp = (p1[i]) - (p2[i]);
            sum += dp * dp;
        }
     ...
     */     public static double distanceInf(double[] p1, double[] p2) {         double max = 0;
        for (int i = 0; i < (p1.length); i++) {
     ...
     * 		the second point
     * @return the L<sub>&infin;</sub> distance between the two points
     */     public static int distanceInf(int[] p1, int[] p2) {         int max = 0;
        for (int i = 0; i < (p1.length); i++) {
            max = java.lang.Math.max(max, java.lang.Math.abs(((p1[i]) - (p2[i]))));
        }
        return max;
     ...
     */     public static void checkOrder(double[] val, org.apache.commons.math.util.MathUtils.Order.Direction dir, boolean strict) {         double previous = val[0];         boolean ok = true;
        int max = val.length;
        for (int i = 1; i < max; i++) {
            switch (dir) {
                case INCREASING :
     ...
     * @throws NonMonotonousSequenceException
     * 		if the array is not sorted.
     */     public static void checkOrder(double[] val) {         org.apache.commons.math.util.MathUtils.checkOrder(val, org.apache.commons.math.util.MathUtils.Order.Direction.INCREASING, true);
    }
     ...
     */     public static void checkOrder(double[] val, int dir, boolean strict) {         if (dir > 0) {             org.apache.commons.math.util.MathUtils.checkOrder(val, org.apache.commons.math.util.MathUtils.Order.Direction.INCREASING, strict);}else {
            org.apache.commons.math.util.MathUtils.checkOrder(val, org.apache.commons.math.util.MathUtils.Order.Direction.DECREASING, strict);
        }
    }
}