...
public class ResizableDoubleArrayTest extends org.apache.commons.math.util.DoubleArrayAbstractTest {
    ...
    public void testConstructors() {
        ...
        testDa = new org.apache.commons.math.util.ResizableDoubleArray(2, 2.0F, 3.0F, 
        org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE);
        junit.framework.Assert.assertEquals(0, testDa.getNumElements());
        junit.framework.Assert.assertEquals(2, testDa.getInternalLength());
        junit.framework.Assert.assertEquals(defaultExpansionFactor, testDa.getExpansionFactor(), 0);
        junit.framework.Assert.assertEquals(3.0F, testDa.getContractionCriteria(), 0);
        junit.framework.Assert.assertEquals(org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE, 
    ...
    public void testSetElementArbitraryExpansion() {
        ...
        junit.framework.Assert.assertEquals("The number of elements should now be 1001, it isn't", 
        da.getNumElements(), 1001);

        junit.framework.Assert.assertEquals("Uninitialized Elements are default value of 0.0, index 766 wasn't", 0.0, 
        da.getElement(760), java.lang.Double.MIN_VALUE);

        junit.framework.Assert.assertEquals("The 1000th index should be 3.4, it isn't", 3.4, da.getElement(1000), 
        java.lang.Double.MIN_VALUE);
        junit.framework.Assert.assertEquals("The 0th index should be 2.0, it isn't", 2.0, da.getElement(0), 
        java.lang.Double.MIN_VALUE);
        ...
        org.apache.commons.math.util.ResizableDoubleArray testDa = new org.apache.commons.math.util.ResizableDoubleArray(2, 2.0F, 3.0F, 
        org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE);
        junit.framework.Assert.assertEquals(2, testDa.getInternalLength());
    ...
    public void testAdd1000() {
        super.testAdd1000();
        junit.framework.Assert.assertEquals(("Internal Storage length should be 1024 if we started out with initial capacity of " + 
        "16 and an expansion factor of 2.0"), 
        1024, ((org.apache.commons.math.util.ResizableDoubleArray) (da)).getInternalLength());
    }
    ...
    public void testAddElementRolling() {
        ...
        org.apache.commons.math.util.ResizableDoubleArray testDa = new org.apache.commons.math.util.ResizableDoubleArray(2, 2.0F, 2.5F, 
        org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE);
        junit.framework.Assert.assertEquals(2, testDa.getInternalLength());
        testDa.addElement(1.0);// x,0
        testDa.addElement(2.0);// x,x
        testDa.addElement(3.0);// x,x,x,0 -- expanded
        ...
        junit.framework.Assert.assertEquals(4, testDa.getInternalLength());// x,x,x,0
        ...
        junit.framework.Assert.assertEquals(4, testDa.getInternalLength());// 0,x,x,x
        junit.framework.Assert.assertEquals(3, testDa.getNumElements());
        testDa.addElementRolling(5.0);// 0,0,x,x,x,0 -- time to contract
        ...
        junit.framework.Assert.assertEquals(4, testDa.getInternalLength());// contracted -- x,x,x,0
        junit.framework.Assert.assertEquals(3, testDa.getNumElements());
        try {
            testDa.getElement(4);
    ...
    public void testWithInitialCapacity() {
        ...
        junit.framework.Assert.assertEquals(("Number of elements should be equals to " + (iterations + 1)), 
    ...
    public void testMutators() {
        ...
        try {
            ((org.apache.commons.math.util.ResizableDoubleArray) (da)).setExpansionFactor(11.0F);// greater than contractionCriteria
            junit.framework.Assert.fail("Expecting IllegalArgumentException");
        } catch (java.lang.IllegalArgumentException ex) {
            // expected
        }
        ((org.apache.commons.math.util.ResizableDoubleArray) (da)).setExpansionMode(
        org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE);
        junit.framework.Assert.assertEquals(org.apache.commons.math.util.ResizableDoubleArray.ADDITIVE_MODE, 
        ((org.apache.commons.math.util.ResizableDoubleArray) (da)).getExpansionMode());
        try {
