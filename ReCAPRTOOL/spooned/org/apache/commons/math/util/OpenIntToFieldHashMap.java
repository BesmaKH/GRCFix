 ...
 */ public class OpenIntToFieldHashMap<T extends org.apache.commons.math.FieldElement<T>> implements java.io.Serializable {
     ...
     * @param field
     * 		field to which the elements belong
     */     public OpenIntToFieldHashMap(final org.apache.commons.math.Field<T> field) {         this(field, org.apache.commons.math.util.OpenIntToFieldHashMap.DEFAULT_EXPECTED_SIZE, field.getZero());
    }
     ...
     */     public OpenIntToFieldHashMap(final org.apache.commons.math.Field<T> field, final T missingEntries) {         this(field, org.apache.commons.math.util.OpenIntToFieldHashMap.DEFAULT_EXPECTED_SIZE, missingEntries);}
     ...
     */     public OpenIntToFieldHashMap(final org.apache.commons.math.Field<T> field, final int expectedSize) {         this(field, expectedSize, field.getZero());}
     ...
     * @param missingEntries
     * 		value to return when a missing entry is fetched
     */     public OpenIntToFieldHashMap(final org.apache.commons.math.Field<T> field, final int expectedSize, final T missingEntries) {         this.field = field;         final int capacity = org.apache.commons.math.util.OpenIntToFieldHashMap.computeCapacity(expectedSize);
     ...
     * @param source
     * 		map to copy
     */     public OpenIntToFieldHashMap(final org.apache.commons.math.util.OpenIntToFieldHashMap<T> source) {         field = source.field;
     ...
     */     private int findInsertionIndex(final int key) {         return org.apache.commons.math.util.OpenIntToFieldHashMap.findInsertionIndex(keys, states, key, mask);
    }
     ...
     * 		bit mask for hash values
     * @return index at which key should be inserted
     */     private static int findInsertionIndex(final int[] keys, final byte[] states, final int key, final int mask) {         final int hash = org.apache.commons.math.util.OpenIntToFieldHashMap.hashOf(key);         int index = hash & mask;         if ((states[index]) == (org.apache.commons.math.util.OpenIntToFieldHashMap.FREE)) {
            return index;
        ...
        if ((states[index]) == (org.apache.commons.math.util.OpenIntToFieldHashMap.FREE)) {             return index;}// due to the loop exit condition,         // if (states[index] == FULL) then keys[index] == key
        else             if ((states[index]) == (org.apache.commons.math.util.OpenIntToFieldHashMap.FULL)) {                 return org.apache.commons.math.util.OpenIntToFieldHashMap.changeIndexSign(index);}
     ...
     */     private boolean containsKey(final int key, final int index) {         return ((key != 0) || ((states[index]) == (org.apache.commons.math.util.OpenIntToFieldHashMap.FULL))) && ((keys[index]) == key);}
     ...
     * @return removed value
     */     private T doRemove(int index) {         keys[index] = 0;
     ...
     */     public T put(final int key, final T value) {         int index = findInsertionIndex(key);         T previous = missingEntries;
