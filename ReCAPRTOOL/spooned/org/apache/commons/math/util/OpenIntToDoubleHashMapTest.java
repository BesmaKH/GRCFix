...
public class OpenIntToDoubleHashMapTest extends junit.framework.TestCase {
    ...
    private void assertPutAndGet(org.apache.commons.math.util.OpenIntToDoubleHashMap map, int mapSize, 
    ...
    public void testCopy() {
        org.apache.commons.math.util.OpenIntToDoubleHashMap copy = 
        new org.apache.commons.math.util.OpenIntToDoubleHashMap(createFromJavaMap());
