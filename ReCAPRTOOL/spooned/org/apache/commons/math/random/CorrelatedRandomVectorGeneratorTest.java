 ...
 * under the License.
 */
package org.apache.commons.math.random; public class CorrelatedRandomVectorGeneratorTest extends junit.framework.TestCase {
    ...
    public void testMath226() throws 
    org.apache.commons.math.DimensionMismatchException, org.apache.commons.math.linear.NotPositiveDefiniteMatrixException {
        double[] mean = new double[]{ 1, 1, 10, 1 };
        double[][] cov = new double[][]{ 
        new double[]{ 1, 3, 2, 6 }, 
        new double[]{ 3, 13, 16, 2 }, 
        new double[]{ 2, 16, 38, -1 }, 
        new double[]{ 6, 2, -1, 197 } };
        ...
        org.apache.commons.math.random.CorrelatedRandomVectorGenerator sg = 
        new org.apache.commons.math.random.CorrelatedRandomVectorGenerator(mean, covRM, 1.0E-5, rg);
    ...
    public void testMeanAndCovariance() throws org.apache.commons.math.DimensionMismatchException {
        ...
        for (int i = 0; i < (estimatedMean.length); ++i) {
            ...
            for (int j = 0; j <= i; ++j) {
                junit.framework.Assert.assertEquals(covariance.getEntry(i, j), 
                estimatedCovariance.getEntry(i, j), 
                ((0.1 * (1.0 + (java.lang.Math.abs(mean[i])))) * (1.0 + (java.lang.Math.abs(mean[j])))));
            }
        }
    ...
    public void setUp() {
        try {
            ...
            generator = new org.apache.commons.math.random.CorrelatedRandomVectorGenerator(mean, 
            covariance, 
