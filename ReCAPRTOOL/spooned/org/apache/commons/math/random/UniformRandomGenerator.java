...
public class UniformRandomGenerator implements org.apache.commons.math.random.NormalizedRandomGenerator {
     ...
     */     public UniformRandomGenerator(org.apache.commons.math.random.RandomGenerator generator) {         this.generator = generator;}
     ...
     */     public double nextNormalizedDouble() {         return (org.apache.commons.math.random.UniformRandomGenerator.SQRT3) * ((2 * (generator.nextDouble())) - 1.0);
    }
