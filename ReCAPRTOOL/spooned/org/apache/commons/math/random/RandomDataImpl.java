...
public class RandomDataImpl implements java.io.Serializable , org.apache.commons.math.random.RandomData {
     ...
     */     public java.lang.String nextHexString(int len) {
        if (len <= 0) {
            throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.util.LocalizedFormats.LENGTH, len);
        }
     ...
     */     public int nextInt(int lower, int upper) {
        if (lower >= upper) {
            throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.util.LocalizedFormats.LOWER_BOUND_NOT_BELOW_UPPER_BOUND, 
            lower, upper, false);
        }
     ...
     * @throws NotStrictlyPositiveException
     * 		if {@code mean <= 0}.
     */     public long nextPoisson(double mean) {         if (mean <= 0) {
            throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.util.LocalizedFormats.MEAN, mean);
        }
     ...
     */     public double nextGaussian(double mu, double sigma) {
        if (sigma <= 0) {
            throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.util.LocalizedFormats.STANDARD_DEVIATION, sigma);
        }
     ...
     * @throws NotStrictlyPositiveException
     * 		if {@code mean <= 0}.
     */     public double nextExponential(double mean) {         if (mean <= 0.0) {
            throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.util.LocalizedFormats.MEAN, mean);
        }
        final org.apache.commons.math.random.RandomGenerator generator = getRan();
     ...
     * @since 2.2
     */     public double nextBeta(double alpha, double beta) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.BetaDistributionImpl(alpha, beta));}
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public int nextBinomial(int numberOfTrials, double probabilityOfSuccess) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.BinomialDistributionImpl(numberOfTrials, probabilityOfSuccess));}
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public double nextCauchy(double median, double scale) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.CauchyDistributionImpl(median, scale));}
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public double nextChiSquare(double df) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.ChiSquaredDistributionImpl(df));
    }
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public double nextF(double numeratorDf, double denominatorDf) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.FDistributionImpl(numeratorDf, denominatorDf));}
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public double nextGamma(double shape, double scale) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.GammaDistributionImpl(shape, scale));}
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public int nextHypergeometric(int populationSize, int numberOfSuccesses, int sampleSize) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.HypergeometricDistributionImpl(populationSize, numberOfSuccesses, sampleSize));}
    /**
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public int nextPascal(int r, double p) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.PascalDistributionImpl(r, p));}
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public double nextT(double df) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.TDistributionImpl(df));
    }
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public double nextWeibull(double shape, double scale) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.WeibullDistributionImpl(shape, scale));}
     ...
     * 		if an error occurs generating the random value
     * @since 2.2
     */     public int nextZipf(int numberOfElements, double exponent) throws org.apache.commons.math.MathException {         return nextInversionDeviate(new org.apache.commons.math.distribution.ZipfDistributionImpl(numberOfElements, exponent));}
     ...
     */
    public void setSecureAlgorithm(java.lang.String algorithm, java.lang.String provider) throws 
     ...
     * @throws NumberIsTooLargException
     * 		if {@code k > n}.
     * @throws NotStrictlyPositiveException
     * 		if {@code k <= 0}.
     */     public int[] nextPermutation(int n, int k) {         if (k > n) {
            throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.util.LocalizedFormats.PERMUTATION_EXCEEDS_N, 
            k, n, true);
        }
        if (k == 0) {
            throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.util.LocalizedFormats.PERMUTATION_SIZE, 
            k);
        }
     ...
     * @throws NotStrictlyPositiveException
     * 		if {@code k <= 0}.
     */     public java.lang.Object[] nextSample(java.util.Collection<?> c, int k) {         int len = c.size();
        if (k > len) {
            throw new org.apache.commons.math.exception.NumberIsTooLargeException(org.apache.commons.math.util.LocalizedFormats.SAMPLE_SIZE_EXCEEDS_COLLECTION_SIZE, 
            k, len, true);
        }
        if (k <= 0) {
            throw new org.apache.commons.math.exception.NotStrictlyPositiveException(org.apache.commons.math.util.LocalizedFormats.NUMBER_OF_SAMPLES, k);
        }
     ...
     * @throws MathException
     * 		if an error occurs computing the inverse cumulative distribution function
     * @since 2.2
     */     public double nextInversionDeviate(org.apache.commons.math.distribution.ContinuousDistribution distribution) throws org.apache.commons.math.MathException {         return distribution.inverseCumulativeProbability(nextUniform(0, 1));
     ...
     * 		if an error occurs computing the inverse cumulative distribution function
     * @since 2.2
     */     public int nextInversionDeviate(org.apache.commons.math.distribution.IntegerDistribution distribution) throws org.apache.commons.math.MathException {         final double target = nextUniform(0, 1);
        final int glb = distribution.inverseCumulativeProbability(target);
        if ((distribution.cumulativeProbability(glb)) == 1.0) {             // No mass above
            return glb;
        }else {
            return glb + 1;
        }
