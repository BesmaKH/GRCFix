 ...
 * under the License.
 */
package org.apache.commons.math.random; public class UncorrelatedRandomVectorGeneratorTest extends junit.framework.TestCase {     public UncorrelatedRandomVectorGeneratorTest(java.lang.String name) {
        super(name);
        mean = null;
    ...
    public void setUp() {
        ...
        generator = 
        new org.apache.commons.math.random.UncorrelatedRandomVectorGenerator(mean, standardDeviation, 
        new org.apache.commons.math.random.GaussianRandomGenerator(rg));
    }
