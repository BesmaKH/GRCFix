...
public class UncorrelatedRandomVectorGenerator implements 
org.apache.commons.math.random.RandomVectorGenerator {
     ...
     * 		components
     */     public UncorrelatedRandomVectorGenerator(double[] mean, double[] standardDeviation, org.apache.commons.math.random.NormalizedRandomGenerator generator) {         if ((mean.length) != (standardDeviation.length)) {             throw new org.apache.commons.math.exception.DimensionMismatchException(mean.length, standardDeviation.length);
        }
     ...
     * 		underlying generator for uncorrelated normalized
     * 		components
     */     public UncorrelatedRandomVectorGenerator(int dimension, org.apache.commons.math.random.NormalizedRandomGenerator generator) {         mean = new double[dimension];         standardDeviation = new double[dimension];
