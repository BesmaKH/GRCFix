 ...
 */ public class VectorialPointValuePair implements java.io.Serializable {
     ...
     */     public VectorialPointValuePair(final double[] point, final double[] value) {         this.point = (point == null) ? null : point.clone();         this.value = (value == null) ? null : value.clone();}
     ...
     */     public VectorialPointValuePair(final double[] point, final double[] value, final boolean copyArray) {         this.point = (copyArray) ? point == null ? null : point.clone() : point;
     ...
     */     public double[] getPoint() {         return (point) == null ? null : point.clone();
    }
     ...
     */     public double[] getPointRef() {         return point;
    }
     ...
     */     public double[] getValue() {         return (value) == null ? null : value.clone();
    }
     ...
     */     public double[] getValueRef() {         return value;
    }
