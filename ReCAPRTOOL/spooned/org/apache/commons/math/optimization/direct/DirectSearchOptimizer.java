...
public abstract class DirectSearchOptimizer implements org.apache.commons.math.optimization.MultivariateRealOptimizer {
     ...
     */     public void setStartConfiguration(final double[] steps) throws java.lang.IllegalArgumentException {         // only the relative position of the n final vertices with respect
        ...
        for (int i = 0; i < n; ++i) {
            ...
            for (int j = 0; j < (i + 1); ++j) {
                if ((steps[j]) == 0.0) {
                    ...
                    org.apache.commons.math.util.LocalizedFormats.EQUAL_VERTICES_IN_SIMPLEX, j, (j + 1));
                }
     ...
     */     public void setStartConfiguration(final double[][] referenceSimplex) throws java.lang.IllegalArgumentException {
        ...
        if (n < 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.SIMPLEX_NEED_ONE_POINT);
        }
        startConfiguration = new double[n][n];
        ...
        for (int i = 0; i < (n + 1); ++i) {
            ...
            if ((refI.length) != n) {
                throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                org.apache.commons.math.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, refI.length, n);
            }
            for (int j = 0; j < i; ++j) {
                ...
                if (allEquals) {
                    throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                    org.apache.commons.math.util.LocalizedFormats.EQUAL_VERTICES_IN_SIMPLEX, i, j);
                }
            }
    ...
    /**
     * {@inheritDoc}
     */     public void setConvergenceChecker(org.apache.commons.math.optimization.RealConvergenceChecker convergenceChecker) {         this.checker = convergenceChecker;
    }
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.optimization.RealPointValuePair optimize(final org.apache.commons.math.analysis.MultivariateRealFunction function, final org.apache.commons.math.optimization.GoalType goalType, final 
    ...
    java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.optimization.OptimizationException {
        ...
        this.f = function;
        final java.util.Comparator<org.apache.commons.math.optimization.RealPointValuePair> comparator = 
        new java.util.Comparator<org.apache.commons.math.optimization.RealPointValuePair>() {
            public int compare(final org.apache.commons.math.optimization.RealPointValuePair o1, final 
     ...
     * @exception IllegalArgumentException if the start point dimension is wrong
     */     protected double evaluate(final double[] x) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException {         if ((++(evaluations)) > (maxEvaluations)) {
     ...
     */     private void buildSimplex(final double[] startPoint) throws java.lang.IllegalArgumentException {
        ...
        if (n != (startConfiguration.length)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, n, startConfiguration.length);
        }
