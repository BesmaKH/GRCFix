...
public class MultiDirectionalTest {
    ...
    public void testFunctionEvaluationExceptions() {
        org.apache.commons.math.analysis.MultivariateRealFunction wrong = 
    ...
    @org.junit.Test
    public void testMinimizeMaximize() throws 
    org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
        ...
        final double yP = -yM;
        final double valueXmYm = 0.2373295333134217;// local  maximum
        final double valueXmYp = -valueXmYm;         // local  minimum
        final double valueXpYm = -0.7290400707055187;// global minimum
    ...
    org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
        ...
        org.apache.commons.math.analysis.MultivariateRealFunction rosenbrock = 
        new org.apache.commons.math.analysis.MultivariateRealFunction() {
    ...
    @org.junit.Test
    public void testPowell() throws 
    org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {

        org.apache.commons.math.analysis.MultivariateRealFunction powell = 
        new org.apache.commons.math.analysis.MultivariateRealFunction() {
    ...
    @org.junit.Test
    public void testMath283() throws 
    org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.optimization.OptimizationException {
        ...
        org.apache.commons.math.optimization.RealPointValuePair estimate = multiDirectional.optimize(function, 
        org.apache.commons.math.optimization.GoalType.MAXIMIZE, function.getMaximumPosition());
    ...
    private static class Gaussian2D implements org.apache.commons.math.analysis.MultivariateRealFunction {
        ...
        public double value(double[] point) {
            final double x = point[0];             final double y = point[1];
