...
public class LeastSquaresConverter implements org.apache.commons.math.analysis.MultivariateRealFunction {
     ...
     * @param observations
     * 		observations to be compared to objective function to compute residuals
     */     public LeastSquaresConverter(final org.apache.commons.math.analysis.MultivariateVectorialFunction function, final double[] observations) {         this.function = function;         this.observations = observations.clone();
        this.weights = null;
        this.scale = null;
    }
     ...
     */     public LeastSquaresConverter(final org.apache.commons.math.analysis.MultivariateVectorialFunction function, final double[] observations, final double[] weights) throws java.lang.IllegalArgumentException {         if ((observations.length) != (weights.length)) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
     ...
     * the {@link #value(double[])} method is called)
     */     public LeastSquaresConverter(final org.apache.commons.math.analysis.MultivariateVectorialFunction function, final double[] observations, final org.apache.commons.math.linear.RealMatrix scale) throws java.lang.IllegalArgumentException {         if ((observations.length) != (scale.getColumnDimension())) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, 
     ...
     */     public double value(final double[] point) throws org.apache.commons.math.FunctionEvaluationException {
        ...
        if ((residuals.length) != (observations.length)) {
            throw new org.apache.commons.math.FunctionEvaluationException(point, org.apache.commons.math.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, 
