...
public class SimplexTableauTest {
    ...
    public void testInitialization() {
        ...
        new org.apache.commons.math.optimization.linear.SimplexTableau(f, constraints, org.apache.commons.math.optimization.GoalType.MAXIMIZE, false, 1.0E-6);
        double[][] expectedInitialTableau = new double[][]{ 
        new double[]{ -1, 0, -1, -1, 2, 0, 0, 0, -4 }, 
        new double[]{ 0, 1, -15, -10, 25, 0, 0, 0, 0 }, 
        new double[]{ 0, 0, 1, 0, -1, 1, 0, 0, 2 }, 
        new double[]{ 0, 0, 0, 1, -1, 0, 1, 0, 3 }, 
        new double[]{ 0, 0, 1, 1, -2, 0, 0, 1, 4 } };
    ...
    public void testDropPhase1Objective() {
        ...
        org.apache.commons.math.optimization.linear.SimplexTableau tableau = 
        new org.apache.commons.math.optimization.linear.SimplexTableau(f, constraints, org.apache.commons.math.optimization.GoalType.MAXIMIZE, false, 1.0E-6);
        double[][] expectedTableau = new double[][]{ 
        new double[]{ 1, -15, -10, 0, 0, 0, 0 }, 
        new double[]{ 0, 1, 0, 1, 0, 0, 2 }, 
        new double[]{ 0, 0, 1, 0, 1, 0, 3 }, 
        new double[]{ 0, 1, 1, 0, 0, 1, 4 } };
    ...
    public void testTableauWithNoArtificialVars() {
        ...
        org.apache.commons.math.optimization.linear.SimplexTableau tableau = 
        new org.apache.commons.math.optimization.linear.SimplexTableau(f, constraints, org.apache.commons.math.optimization.GoalType.MAXIMIZE, false, 1.0E-6);
        double[][] initialTableau = new double[][]{ 
        new double[]{ 1, -15, -10, 25, 0, 0, 0, 0 }, 
        new double[]{ 0, 1, 0, -1, 1, 0, 0, 2 }, 
        new double[]{ 0, 0, 1, -1, 0, 1, 0, 3 }, 
        new double[]{ 0, 1, 1, -2, 0, 0, 1, 4 } };
