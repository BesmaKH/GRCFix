 ...
 */ public class LinearConstraint implements java.io.Serializable {
     ...
     */     public LinearConstraint(final double[] coefficients, final org.apache.commons.math.optimization.linear.Relationship relationship, final double value) {         this(new org.apache.commons.math.linear.ArrayRealVector(coefficients), relationship, value);}
     ...
     * @param value
     * 		The value of the constraint (right hand side)
     */     public LinearConstraint(final org.apache.commons.math.linear.RealVector coefficients, final org.apache.commons.math.optimization.linear.Relationship relationship, final double value) {         this.coefficients = coefficients;         this.relationship = relationship;
        this.value = value;
    }
     ...
     */     public LinearConstraint(final double[] lhsCoefficients, final double lhsConstant, final org.apache.commons.math.optimization.linear.Relationship relationship, final double[] rhsCoefficients, final double rhsConstant) {         double[] sub = new double[lhsCoefficients.length];         for (int i = 0; i < (sub.length); ++i) {             sub[i] = (lhsCoefficients[i]) - (rhsCoefficients[i]);
        }
     ...
     * @param rhsConstant
     * 		The constant term of the linear expression on the right hand side of the constraint
     */     public LinearConstraint(final org.apache.commons.math.linear.RealVector lhsCoefficients, final double lhsConstant, final org.apache.commons.math.optimization.linear.Relationship relationship, final org.apache.commons.math.linear.RealVector rhsCoefficients, final double rhsConstant) {         this.coefficients = lhsCoefficients.subtract(rhsCoefficients);         this.relationship = relationship;         this.value = rhsConstant - lhsConstant;
    }
     ...
     */     private void readObject(java.io.ObjectInputStream ois) throws java.io.IOException, java.lang.ClassNotFoundException {         ois.defaultReadObject();         org.apache.commons.math.linear.MatrixUtils.deserializeRealVector(this, "coefficients", ois);}
