...
public class BrentOptimizer extends org.apache.commons.math.optimization.univariate.AbstractUnivariateRealOptimizer {
    ...
    /**
     * {@inheritDoc}
     */     public double optimize(final org.apache.commons.math.analysis.UnivariateRealFunction f, final org.apache.commons.math.optimization.GoalType goalType, final double min, final double max, final double startValue) throws 
    ...
    /**
     * {@inheritDoc}
     */     public double optimize(final org.apache.commons.math.analysis.UnivariateRealFunction f, final org.apache.commons.math.optimization.GoalType goalType, final double min, final double max) throws 
    org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.MaxIterationsExceededException {
        clearResult();
     ...
     */     private double localMin(final org.apache.commons.math.analysis.UnivariateRealFunction f, final org.apache.commons.math.optimization.GoalType goalType, double a, double b, final double eps, final double t) throws org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.MaxIterationsExceededException {         double x = a + ((org.apache.commons.math.optimization.univariate.BrentOptimizer.GOLDEN_SECTION) * (b - a));         double v = x;         double w = x;         double e = 0;         double fx = computeObjectiveValue(f, x);         if (goalType == (org.apache.commons.math.optimization.GoalType.MAXIMIZE)) {
        ...
        while (count < (maximalIterationCount)) {
            ...
            if ((java.lang.Math.abs((x - m))) > (t2 - (0.5 * (b - a)))) {
                ...
                if ((java.lang.Math.abs(e)) > tol) {                     // Fit parabola.
                    r = (x - w) * (fx - fv);
                    q = (x - v) * (fx - fw);
                    p = ((x - v) * q) - ((x - w) * r);
                    q = 2 * (q - r);
                ...
                if ((((java.lang.Math.abs(p)) < (java.lang.Math.abs(((0.5 * q) * r)))) && 
