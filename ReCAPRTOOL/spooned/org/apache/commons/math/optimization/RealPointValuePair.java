 ...
 */ public class RealPointValuePair implements java.io.Serializable {
     ...
     */     public RealPointValuePair(final double[] point, final double value) {         this.point = (point == null) ? null : point.clone();         this.value = value;}
     ...
     */     public RealPointValuePair(final double[] point, final double value, final boolean copyArray) {         this.point = (copyArray) ? point == null ? null : point.clone() : point;
        this.value = value;
    }
