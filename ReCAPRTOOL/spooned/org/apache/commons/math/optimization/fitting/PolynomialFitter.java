 ...
 */ public class PolynomialFitter {
     ...
     */     public PolynomialFitter(int degree, final org.apache.commons.math.optimization.DifferentiableMultivariateVectorialOptimizer optimizer) {         this.fitter = new org.apache.commons.math.optimization.fitting.CurveFitter(optimizer);         this.degree = degree;}
     ...
     */     private static class ParametricPolynomial implements org.apache.commons.math.optimization.fitting.ParametricRealFunction {
        ...
        /**
         * {@inheritDoc}
         */         public double value(final double x, final double[] parameters) {             double y = 0;
