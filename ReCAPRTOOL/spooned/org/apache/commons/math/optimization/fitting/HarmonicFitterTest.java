 ...
 * under the License.
 */
package org.apache.commons.math.optimization.fitting; public class HarmonicFitterTest {     @org.junit.Test     public void testNoError() throws org.apache.commons.math.optimization.OptimizationException {         org.apache.commons.math.optimization.fitting.HarmonicFunction f = new org.apache.commons.math.optimization.fitting.HarmonicFunction(0.2, 3.4, 4.1);

        org.apache.commons.math.optimization.fitting.HarmonicFitter fitter = 
        new org.apache.commons.math.optimization.fitting.HarmonicFitter(new org.apache.commons.math.optimization.general.LevenbergMarquardtOptimizer());
    ...
    public void testInitialGuess() throws org.apache.commons.math.optimization.OptimizationException {
        ...
        org.apache.commons.math.optimization.fitting.HarmonicFitter fitter = 
        new org.apache.commons.math.optimization.fitting.HarmonicFitter(new org.apache.commons.math.optimization.general.LevenbergMarquardtOptimizer(), new double[]{ 0.15, 3.6, 4.5 });
        for (double x = 0.0; x < 10.0; x += 0.1) {
            fitter.addObservedPoint(1.0, x, 
            ((f.value(x)) + (0.01 * (randomizer.nextGaussian()))));
        }
