...
public class HarmonicCoefficientsGuesser {
     ...
     * @param observations
     * 		sampled observations
     */     public HarmonicCoefficientsGuesser(org.apache.commons.math.optimization.fitting.WeightedObservedPoint[] observations) {         this.observations = observations.clone();         a = java.lang.Double.NaN;
     ...
     */     public void guess() throws org.apache.commons.math.optimization.OptimizationException {         sortObservations();
        guessAOmega();
        guessPhi();
    }
     ...
     */     public double getGuessedAmplitude() {         return a;
    }
     ...
     */     public double getGuessedPulsation() {         return omega;
    }
     ...
     */     public double getGuessedPhase() {         return phi;
    }
