...
public class MultiStartDifferentiableMultivariateRealOptimizerTest {
    ...
    public void testCircleFitting() throws org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.optimization.OptimizationException {
        ...
        org.apache.commons.math.optimization.general.NonLinearConjugateGradientOptimizer underlying = 
        ...
        new org.apache.commons.math.random.UncorrelatedRandomVectorGenerator(new double[]{ 50.0, 50.0 }, new double[]{ 10.0, 10.0 }, 
        new org.apache.commons.math.random.GaussianRandomGenerator(g));
        org.apache.commons.math.optimization.MultiStartDifferentiableMultivariateRealOptimizer optimizer = 
        new org.apache.commons.math.optimization.MultiStartDifferentiableMultivariateRealOptimizer(underlying, 10, generator);
