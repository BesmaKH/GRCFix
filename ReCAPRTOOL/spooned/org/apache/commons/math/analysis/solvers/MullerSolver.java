...
public class MullerSolver extends org.apache.commons.math.analysis.solvers.UnivariateRealSolverImpl {
     ...
     */     public double solve(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max, final double initial) throws org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.MaxIterationsExceededException {         // check for zeros before verifying bracketing
        if ((f.value(min)) == 0.0) {             return min;}         if ((f.value(max)) == 0.0) {             return max;}         if ((f.value(initial)) == 0.0) {             return initial;}
     ...
     * since 2.0
     */     @java.lang.Deprecated     public double solve2(final double min, final double max) throws org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.MaxIterationsExceededException {         return solve2(f, min, max);}
     ...
     * @throws IllegalArgumentException
     * 		if any parameters are invalid
     */     public double solve2(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max) throws org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.MaxIterationsExceededException {         // x2 is the last root approximation         // x is the new approximation and new x2 for next round
