...
public class NewtonSolver extends org.apache.commons.math.analysis.solvers.UnivariateRealSolverImpl {
     ...
     * method.
     */     @java.lang.Deprecated     public NewtonSolver(org.apache.commons.math.analysis.DifferentiableUnivariateRealFunction f) {
        super(f, 100, 1.0E-6);
    }
    ...
    /**
     * {@inheritDoc}
     */     @java.lang.Deprecated     public double solve(final double min, final double max, final double startValue) throws 
    org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.MaxIterationsExceededException {
     ...
     */     public double solve(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max, final double startValue) throws org.apache.commons.math.FunctionEvaluationException, org.apache.commons.math.MaxIterationsExceededException {         try {             final org.apache.commons.math.analysis.UnivariateRealFunction derivative = 
            ((org.apache.commons.math.analysis.DifferentiableUnivariateRealFunction) (f)).derivative();
            clearResult();
