...
public class LegendreGaussIntegrator extends org.apache.commons.math.analysis.integration.UnivariateRealIntegratorImpl {
     ...
     */     private static final double[] ABSCISSAS_2 = new double[]{ (-1.0) / (java.lang.Math.sqrt(3.0)), 
    1.0 / (java.lang.Math.sqrt(3.0)) };


    /**
     * Weights for the 2 points method.
     */     private static final double[] WEIGHTS_2 = new double[]{ 1.0, 
    1.0 };


    /**
     * Abscissas for the 3 points method.
     */     private static final double[] ABSCISSAS_3 = new double[]{ -(java.lang.Math.sqrt(0.6)), 
    0.0, 
    java.lang.Math.sqrt(0.6) };


    /**
     * Weights for the 3 points method.
     */     private static final double[] WEIGHTS_3 = new double[]{ 5.0 / 9.0, 
    8.0 / 9.0, 
    5.0 / 9.0 };
     ...
     */     private static final double[] ABSCISSAS_4 = new double[]{ -(java.lang.Math.sqrt(((15.0 + (2.0 * (java.lang.Math.sqrt(30.0)))) / 35.0))), 
    -(java.lang.Math.sqrt(((15.0 - (2.0 * (java.lang.Math.sqrt(30.0)))) / 35.0))), 
    java.lang.Math.sqrt(((15.0 - (2.0 * (java.lang.Math.sqrt(30.0)))) / 35.0)), 
    java.lang.Math.sqrt(((15.0 + (2.0 * (java.lang.Math.sqrt(30.0)))) / 35.0)) };
     ...
     */     private static final double[] WEIGHTS_4 = new double[]{ (90.0 - (5.0 * (java.lang.Math.sqrt(30.0)))) / 180.0, 
    (90.0 + (5.0 * (java.lang.Math.sqrt(30.0)))) / 180.0, 
    (90.0 + (5.0 * (java.lang.Math.sqrt(30.0)))) / 180.0, 
    (90.0 - (5.0 * (java.lang.Math.sqrt(30.0)))) / 180.0 };
     ...
     */     private static final double[] ABSCISSAS_5 = new double[]{ -(java.lang.Math.sqrt(((35.0 + (2.0 * (java.lang.Math.sqrt(70.0)))) / 63.0))), 
    -(java.lang.Math.sqrt(((35.0 - (2.0 * (java.lang.Math.sqrt(70.0)))) / 63.0))), 
    0.0, 
    java.lang.Math.sqrt(((35.0 - (2.0 * (java.lang.Math.sqrt(70.0)))) / 63.0)), 
    java.lang.Math.sqrt(((35.0 + (2.0 * (java.lang.Math.sqrt(70.0)))) / 63.0)) };
     ...
     */     private static final double[] WEIGHTS_5 = new double[]{ (322.0 - (13.0 * (java.lang.Math.sqrt(70.0)))) / 900.0, 
    (322.0 + (13.0 * (java.lang.Math.sqrt(70.0)))) / 900.0, 
    128.0 / 225.0, 
    (322.0 + (13.0 * (java.lang.Math.sqrt(70.0)))) / 900.0, 
    (322.0 - (13.0 * (java.lang.Math.sqrt(70.0)))) / 900.0 };
     ...
     */     public LegendreGaussIntegrator(final int n, final int defaultMaximalIterationCount) throws java.lang.IllegalArgumentException {         super(defaultMaximalIterationCount);         switch (n) {
            case 2 :
            ...
            default :
                ...
                org.apache.commons.math.util.LocalizedFormats.N_POINTS_GAUSS_LEGENDRE_INTEGRATOR_NOT_SUPPORTED, 
                n, 2, 5);}
    ...
    java.lang.IllegalArgumentException, org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
    ...
    java.lang.IllegalArgumentException, org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
        ...
        for (int i = 0; i < (maximalIterationCount); ++i) {
            ...
            final double limit = 
            java.lang.Math.max(absoluteAccuracy, 
     ...
     * 		function
     */     private double stage(final org.apache.commons.math.analysis.UnivariateRealFunction f, final double min, final double max, final int n) throws org.apache.commons.math.FunctionEvaluationException {         // set up the step for the current stage         final double step = (max - min) / n;
