...
public class LegendreGaussIntegratorTest extends 
junit.framework.TestCase {
    ...
    public void testSinFunction() throws org.apache.commons.math.MathException {
        ...
        tolerance = java.lang.Math.max(integrator.getAbsoluteAccuracy(), 
        java.lang.Math.abs((expected * (integrator.getRelativeAccuracy()))));
    ...
    public void testQuinticFunction() throws org.apache.commons.math.MathException {
        ...
        double min;         double max;         double expected;         double result;
    ...
    public void testExactIntegration() throws 
    org.apache.commons.math.ConvergenceException, org.apache.commons.math.FunctionEvaluationException {
        ...
        for (int n = 2; n < 6; ++n) {
            org.apache.commons.math.analysis.integration.LegendreGaussIntegrator integrator = 
            new org.apache.commons.math.analysis.integration.LegendreGaussIntegrator(n, 64);
