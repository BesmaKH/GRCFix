...
public class PolynomialFunctionNewtonForm implements org.apache.commons.math.analysis.UnivariateRealFunction {
     ...
     */     public double value(double z) throws org.apache.commons.math.FunctionEvaluationException {         return org.apache.commons.math.analysis.polynomials.PolynomialFunctionNewtonForm.evaluate(a, c, z);
    }
     ...
     */     public static double evaluate(double[] a, double[] c, double z) throws java.lang.IllegalArgumentException, org.apache.commons.math.FunctionEvaluationException {         org.apache.commons.math.analysis.polynomials.PolynomialFunctionNewtonForm.verifyInputArray(a, c);
        int n = c.length;
        double value = a[n];
        for (int i = n - 1; i >= 0; i--) {
     ...
     */     protected static void verifyInputArray(double[] a, double[] c) throws java.lang.IllegalArgumentException {
        if (((a.length) < 1) || ((c.length) < 1)) {
            ...
            org.apache.commons.math.util.LocalizedFormats.EMPTY_POLYNOMIALS_COEFFICIENTS_ARRAY);
        }
        if ((a.length) != ((c.length) + 1)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.ARRAY_SIZES_SHOULD_HAVE_DIFFERENCE_1, 
            a.length, c.length);
        }
    }
}