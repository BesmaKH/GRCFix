...
public class PolynomialsUtilsTest extends junit.framework.TestCase {
    ...
    public void testFirstLaguerrePolynomials() {
        ...
        checkPolynomial(org.apache.commons.math.analysis.polynomials.PolynomialsUtils.createLaguerrePolynomial(7), 5040L, 
        ("5040.0 - 35280.0 x + 52920.0 x^2 - 29400.0 x^3" + 
        " + 7350.0 x^4 - 882.0 x^5 + 49.0 x^6 - x^7"));
        checkPolynomial(org.apache.commons.math.analysis.polynomials.PolynomialsUtils.createLaguerrePolynomial(6), 720L, 
        ("720.0 - 4320.0 x + 5400.0 x^2 - 2400.0 x^3 + 450.0 x^4" + 
        " - 36.0 x^5 + x^6"));
        checkPolynomial(org.apache.commons.math.analysis.polynomials.PolynomialsUtils.createLaguerrePolynomial(5), 120L, 
        "120.0 - 600.0 x + 600.0 x^2 - 200.0 x^3 + 25.0 x^4 - x^5");
        checkPolynomial(org.apache.commons.math.analysis.polynomials.PolynomialsUtils.createLaguerrePolynomial(4), 24L, 
    ...
    public void testHighDegreeLegendre() {
        ...
        +3.4461632205E10, -2.82585384081E13, +3.84787097990295E15, -2.07785032914759296E17, 
        +5.9292943321033103E18, -1.0330148347486655E20, +1.197358103913226E21, -9.763073770369382E21, 
        +5.817164788178423E22, -2.6006148464797657E23, +8.883152817712462E23, -2.3457676271881395E24, 
        +4.8190226254191124E24, -7.71043620067058E24, +9.566652323054239E24, -9.104813935044723E24, 
        +6.516550296251767E24, -3.391858621221954E24, +1.2113780790078407E24, -2.6536589497469058E23, 
        +2.6876802183334046E22 };
