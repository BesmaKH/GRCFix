...
public class PolynomialFunctionLagrangeForm implements org.apache.commons.math.analysis.UnivariateRealFunction {
     ...
     */     public double value(double z) throws org.apache.commons.math.FunctionEvaluationException {         try {
     ...
     */     public static double evaluate(double[] x, double[] y, double z) throws java.lang.IllegalArgumentException, org.apache.commons.math.DuplicateSampleAbscissaException {         org.apache.commons.math.analysis.polynomials.PolynomialFunctionLagrangeForm.verifyInterpolationArray(x, y);
        int nearest = 0;
            ...
            if (d == 0.0) {
                ...
                for (int k = 0; k < n; ++k) {
                    if ((i != k) && ((x[i]) == (x[k]))) {
                        ...
                        org.apache.commons.math.util.LocalizedFormats.IDENTICAL_ABSCISSAS_DIVISION_BY_ZERO, 
                        i, k, x[i]);
                    }
                }
            }
     ...
     */     public static void verifyInterpolationArray(double[] x, double[] y) throws java.lang.IllegalArgumentException {
        if ((x.length) != (y.length)) {
            ...
            org.apache.commons.math.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, x.length, y.length);
        }

        if ((x.length) < 2) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.WRONG_NUMBER_OF_POINTS, 2, x.length);
        }
