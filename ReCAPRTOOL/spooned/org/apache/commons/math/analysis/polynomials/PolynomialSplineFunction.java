...
org.apache.commons.math.analysis.DifferentiableUnivariateRealFunction {
     ...
     */     public PolynomialSplineFunction(double[] knots, org.apache.commons.math.analysis.polynomials.PolynomialFunction[] polynomials) {         if ((knots.length) < 2) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.NOT_ENOUGH_POINTS_IN_SPLINE_PARTITION, 
            2, knots.length);
        }
        if (((knots.length) - 1) != (polynomials.length)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.POLYNOMIAL_INTERPOLANTS_MISMATCH_SEGMENTS, 
        ...
        if (!(org.apache.commons.math.analysis.polynomials.PolynomialSplineFunction.isStrictlyIncreasing(knots))) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.NOT_STRICTLY_INCREASING_KNOT_VALUES);
        }
     ...
     */     public double value(double v) throws org.apache.commons.math.ArgumentOutsideDomainException {         if ((v < (knots[0])) || (v > (knots[n]))) {
