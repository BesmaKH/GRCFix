...
public class ComposableFunctionTest {
    ...
    public void testComposition() throws org.apache.commons.math.FunctionEvaluationException {
        ...
        for (double x = 0.1; x < 0.9; x += 0.01) {
            org.junit.Assert.assertEquals(java.lang.Math.sqrt(java.lang.Math.abs(java.lang.Math.expm1(java.lang.Math.cbrt(java.lang.Math.tanh(x))))), 
            f1.value(x), 1.0E-15);
        }
        ...
        for (double x = 0.1; x < 12.9; x += 1.0) {
            org.junit.Assert.assertEquals(java.lang.Math.cosh(java.lang.Math.sinh(java.lang.Math.tanh(java.lang.Math.cosh(java.lang.Math.log(java.lang.Math.ceil(x)))))), 
            f2.value(x), 1.0E-15);
        }
        ...
        for (double x = 1.0E16; x < 1.0E17; x += 1.0E16) {
            org.junit.Assert.assertEquals(java.lang.Math.cos(java.lang.Math.sin(java.lang.Math.tan(java.lang.Math.acos(java.lang.Math.asin(java.lang.Math.log10(java.lang.Math.log(java.lang.Math.ulp(x)))))))), 
            f3.value(x), 1.0E-15);
        }

        org.apache.commons.math.analysis.ComposableFunction f4 = atan.of(exp.of(negate.of(floor)));
        for (double x = 1.1; x < 10.2; x += 1.0) {
            org.junit.Assert.assertEquals(java.lang.Math.atan(java.lang.Math.exp((-(java.lang.Math.floor(x))))), 
            f4.value(x), 1.0E-15);
        }
    ...
    public void testCombine() throws org.apache.commons.math.FunctionEvaluationException {
        ...
        org.apache.commons.math.analysis.ComposableFunction f = 
        org.apache.commons.math.analysis.ComposableFunction.COS.combine(org.apache.commons.math.analysis.ComposableFunction.ASIN, org.apache.commons.math.analysis.BinaryFunction.POW);
        for (double x = 0.1; x < 0.9; x += 0.01) {
