 ...
 * @since 2.0
 */
public class LoessInterpolator implements 
java.io.Serializable , org.apache.commons.math.analysis.interpolation.UnivariateRealInterpolator {
     ...
     */     public LoessInterpolator(double bandwidth, int robustnessIters) throws org.apache.commons.math.MathException {         this(bandwidth, robustnessIters, org.apache.commons.math.analysis.interpolation.LoessInterpolator.DEFAULT_ACCURACY);}
     ...
     * @since 2.1
     */     public LoessInterpolator(double bandwidth, int robustnessIters, double accuracy) throws org.apache.commons.math.MathException {         if ((bandwidth < 0) || (bandwidth > 1)) {             throw new org.apache.commons.math.MathException(org.apache.commons.math.util.LocalizedFormats.BANDWIDTH_OUT_OF_INTERVAL, bandwidth);
        }
        this.bandwidth = bandwidth;
        if (robustnessIters < 0) {
            throw new org.apache.commons.math.MathException(org.apache.commons.math.util.LocalizedFormats.NEGATIVE_ROBUSTNESS_ITERATIONS, robustnessIters);
        }
     ...
     * 		</ul>
     */     public final org.apache.commons.math.analysis.polynomials.PolynomialSplineFunction interpolate(final double[] xval, final double[] yval) throws org.apache.commons.math.MathException {         return new org.apache.commons.math.analysis.interpolation.SplineInterpolator().interpolate(xval, smooth(xval, yval));
    }
     ...
     * 		the values for the interpolation points
     * @param weights
     * 		point weights: coefficients by which the robustness weight of a point is multiplied
     ...
     * 		</ul>
     * @since 2.1
     */     public final double[] smooth(final double[] xval, final double[] yval, final double[] weights) throws org.apache.commons.math.MathException {         if ((xval.length) != (yval.length)) {             throw new org.apache.commons.math.MathException(org.apache.commons.math.util.LocalizedFormats.MISMATCHED_LOESS_ABSCISSA_ORDINATE_ARRAYS, 
        ...
        if (n == 0) {
            throw new org.apache.commons.math.MathException(org.apache.commons.math.util.LocalizedFormats.LOESS_EXPECTS_AT_LEAST_ONE_POINT);
        }

        org.apache.commons.math.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(xval, org.apache.commons.math.util.LocalizedFormats.NON_REAL_FINITE_ABSCISSA);
        org.apache.commons.math.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(yval, org.apache.commons.math.util.LocalizedFormats.NON_REAL_FINITE_ORDINATE);
        org.apache.commons.math.analysis.interpolation.LoessInterpolator.checkAllFiniteReal(weights, org.apache.commons.math.util.LocalizedFormats.NON_REAL_FINITE_WEIGHT);
        ...
        if (bandwidthInPoints < 2) {
            throw new org.apache.commons.math.MathException(org.apache.commons.math.util.LocalizedFormats.TOO_SMALL_BANDWIDTH, 
            n, (2.0 / n), bandwidth);
        }
     ...
     * 		<li> All arguments and values are finite real numbers</li>
     * 		</ul>
     */     public final double[] smooth(final double[] xval, final double[] yval) throws org.apache.commons.math.MathException {         if ((xval.length) != (yval.length)) {
            throw new org.apache.commons.math.MathException(org.apache.commons.math.util.LocalizedFormats.MISMATCHED_LOESS_ABSCISSA_ORDINATE_ARRAYS, 
            xval.length, yval.length);
        }
     ...
     * 		weights array
     * @param i
     * 		the index around which the new interval should be computed
     * @param bandwidthInterval
     * 		a two-element array {left, right} such that: <p/>
     * 		<tt>(left==0 or xval[i] - xval[left-1] > xval[right] - xval[i])</tt>
     * 		<p/> and also <p/>
     * 		<tt>(right==xval.length-1 or xval[right+1] - xval[i] > xval[i] - xval[left])</tt>.
     * 		The array will be updated.
     */     private static void updateBandwidthInterval(final double[] xval, final double[] weights, final int i, final int[] bandwidthInterval) {         final int left = bandwidthInterval[0];
     ...
     * 		weights array
     * @param i
     * 		the index from which to start search; must be < weights.length
     * @return the smallest index j such that j > i && (j==weights.length || weights[j] != 0)
     */     private static int nextNonzero(final double[] weights, final int i) {         int j = i + 1;         while ((j < (weights.length)) && ((weights[j]) == 0)) {
            j++;
        } 
        return j;
    }
     ...
     * 		the values array
     * @param pattern
     * 		pattern of the error message
     * @throws MathException
     * 		if one of the values is not a finite real number
     */     private static void checkAllFiniteReal(final double[] values, final org.apache.commons.math.util.Localizable pattern) throws org.apache.commons.math.MathException {         for (int i = 0; i < (values.length); i++) {
     ...
     */     private static void checkStrictlyIncreasing(final double[] xval) throws org.apache.commons.math.MathException {
        for (int i = 0; i < (xval.length); ++i) {
            if ((i >= 1) && ((xval[(i - 1)]) >= (xval[i]))) {
                throw new org.apache.commons.math.MathException(org.apache.commons.math.util.LocalizedFormats.OUT_OF_ORDER_ABSCISSA_ARRAY, 
