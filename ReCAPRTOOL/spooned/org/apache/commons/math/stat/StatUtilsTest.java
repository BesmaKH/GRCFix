...
public final class StatUtilsTest extends junit.framework.TestCase {
    ...
    /**
     * test stats
     */     public void testStats() {         double[] values = new double[]{ one, two, two, three };
    ...
    public void testN0andN1Conditions() throws java.lang.Exception {
        ...
        java.lang.Double.isNaN(org.apache.commons.math.stat.StatUtils.mean(values)));
        junit.framework.Assert.assertTrue(
        "Variance of n = 0 set should be NaN", 
        java.lang.Double.isNaN(org.apache.commons.math.stat.StatUtils.variance(values)));

        values = new double[]{ one };

        junit.framework.Assert.assertTrue(
        "Mean of n = 1 set should be value of single item n1", 
        ((org.apache.commons.math.stat.StatUtils.mean(values)) == (one)));
        junit.framework.Assert.assertTrue(
        "Variance of n = 1 set should be zero", 
        ((org.apache.commons.math.stat.StatUtils.variance(values)) == 0));
    }
    ...
    public void testArrayIndexConditions() throws java.lang.Exception {
        ...
        "Sum not expected", 
        3.0, 
        org.apache.commons.math.stat.StatUtils.sum(values, 0, 2), 
        java.lang.Double.MIN_VALUE);
        junit.framework.Assert.assertEquals(
        "Sum not expected", 
        7.0, 
        org.apache.commons.math.stat.StatUtils.sum(values, 2, 2), 
        java.lang.Double.MIN_VALUE);
    ...
    public void testDifferenceStats() throws java.lang.Exception {
        ...
        junit.framework.Assert.assertEquals(org.apache.commons.math.stat.StatUtils.varianceDifference(sample1, sample2, meanDifference), 
        org.apache.commons.math.stat.StatUtils.variance(diff), tolerance);
        try {
    ...
    public void testGeometricMean() throws java.lang.Exception {
        ...
        junit.framework.Assert.assertEquals(java.lang.Math.exp((0.25 * (org.apache.commons.math.stat.StatUtils.sumLog(test)))), 
        org.apache.commons.math.stat.StatUtils.geometricMean(test), java.lang.Double.MIN_VALUE);
        junit.framework.Assert.assertEquals(java.lang.Math.exp((0.5 * (org.apache.commons.math.stat.StatUtils.sumLog(test, 0, 2)))), 
        org.apache.commons.math.stat.StatUtils.geometricMean(test, 0, 2), java.lang.Double.MIN_VALUE);
    }
}