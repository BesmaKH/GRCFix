...
public final class FrequencyTest extends junit.framework.TestCase {
    ...
    /**
     * test freq counts
     */     @java.lang.SuppressWarnings("deprecation")     public void testCounts() {
    ...
    /**
     * test pcts
     */     @java.lang.SuppressWarnings("deprecation")     public void testPcts() {
        f.addValue(oneL);
        f.addValue(twoL);
        f.addValue(oneI);
        f.addValue(twoI);
     ...
     */     @java.lang.SuppressWarnings("deprecation")     public void testAdd() {
        char aChar = 'a';
        char bChar = 'b';
    ...
    public void testAddNonComparable() {
        try {
            f.addValue(new java.lang.Object());// This was previously OK
    ...
    /**
     * test empty table
     */     public void testEmptyTable() {         junit.framework.Assert.assertEquals("freq sum, empty table", 0, f.getSumFreq());
    ...
    public void testToString() {
        ...
        try {
            java.lang.String line = reader.readLine();// header line
