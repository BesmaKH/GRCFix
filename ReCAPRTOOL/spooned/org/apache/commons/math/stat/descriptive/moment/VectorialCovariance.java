 ...
 */ public class VectorialCovariance implements java.io.Serializable {
     ...
     */     public VectorialCovariance(int dimension, boolean isBiasCorrected) {         sums = new double[dimension];         productsSums = new double[(dimension * (dimension + 1)) / 2];         n = 0;
     ...
     */     public void increment(double[] v) throws org.apache.commons.math.DimensionMismatchException {         if ((v.length) != (sums.length)) {
