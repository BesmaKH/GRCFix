...
public class Percentile extends org.apache.commons.math.stat.descriptive.AbstractUnivariateStatistic implements java.io.Serializable {
     ...
     */     public Percentile(final double p) {         setQuantile(p);}
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int start, final int length) {         return evaluate(values, start, length, quantile);
    }
     ...
     * 		input array is null
     */     public double evaluate(final double[] values, final int begin, final int length, final double p) {         test(values, begin, length);
        if ((p > 100) || (p <= 0)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.OUT_OF_BOUNDS_QUANTILE_VALUE, p);
        }
        if (length == 0) {
     ...
     * 		if p is not greater than 0 and less
     * 		than or equal to 100
     */     public void setQuantile(final double p) {         if ((p <= 0) || (p > 100)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.OUT_OF_BOUNDS_QUANTILE_VALUE, p);
        }
        quantile = p;
     ...
     */     public static void copy(org.apache.commons.math.stat.descriptive.rank.Percentile source, org.apache.commons.math.stat.descriptive.rank.Percentile dest) {         dest.quantile = source.quantile;}
