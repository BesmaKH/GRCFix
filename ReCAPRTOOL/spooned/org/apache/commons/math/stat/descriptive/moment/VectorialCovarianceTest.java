 ...
 * under the License.
 */
package org.apache.commons.math.stat.descriptive.moment; public class VectorialCovarianceTest extends junit.framework.TestCase {     public VectorialCovarianceTest(java.lang.String name) {         super(name);
        points = null;
    }
    ...
    public void testBasicStats() throws org.apache.commons.math.DimensionMismatchException {
        ...
        new double[]{ 8.047, -1.9195, -3.4445 }, 
        new double[]{ -1.9195, 1.047, 3.2795 }, 
        new double[]{ -3.4445, 3.2795, 12.207 } };
