...
org.apache.commons.math.stat.descriptive.AbstractUnivariateStatistic implements 
org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic {
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int begin, final int length) {         if (test(values, begin, length)) {             clear();
     ...
     */     public void incrementAll(double[] values) {         if (values == null) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.NULL_INPUT_ARRAY);
        }
     ...
     */     public void incrementAll(double[] values, int begin, int length) {         if (test(values, begin, length)) {             int k = begin + length;             for (int i = begin; i < k; i++) {
                increment(values[i]);
            }
        }
    }
     ...
     */     @java.lang.Override     public boolean equals(java.lang.Object object) {
        ...
        return (org.apache.commons.math.util.MathUtils.equalsIncludingNaN(stat.getResult(), this.getResult())) && 
        (org.apache.commons.math.util.MathUtils.equalsIncludingNaN(stat.getN(), this.getN()));
    }
