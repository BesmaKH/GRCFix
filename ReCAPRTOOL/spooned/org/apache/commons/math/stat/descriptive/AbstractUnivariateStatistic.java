 ...
 */
public abstract class AbstractUnivariateStatistic implements 
org.apache.commons.math.stat.descriptive.UnivariateStatistic {
     ...
     */     protected boolean test(final double[] values, final int begin, final int length) {
        ...
        if (begin < 0) {
            ...
            org.apache.commons.math.util.LocalizedFormats.NEGATIVE_START_POSITION, begin);
        }

        if (length < 0) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.NEGATIVE_LENGTH, length);
        }

        if ((begin + length) > (values.length)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.SUBARRAY_ENDS_AFTER_ARRAY_END);
        }
     ...
     */     protected boolean test(final double[] values, final double[] weights, final int begin, final int length) {
        ...
        if ((weights.length) != (values.length)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, weights.length, values.length);
        }
        ...
        for (int i = begin; i < (begin + length); i++) {
            if (java.lang.Double.isNaN(weights[i])) {
                throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                org.apache.commons.math.util.LocalizedFormats.NAN_ELEMENT_AT_INDEX, i);
            }
            if (java.lang.Double.isInfinite(weights[i])) {
                throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                org.apache.commons.math.util.LocalizedFormats.INFINITE_ARRAY_ELEMENT, weights[i], i);
            }
            if ((weights[i]) < 0) {
                throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                org.apache.commons.math.util.LocalizedFormats.NEGATIVE_ELEMENT_AT_INDEX, i, weights[i]);
            }
        ...
        if (!containsPositiveWeight) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.WEIGHT_AT_LEAST_ONE_NON_ZERO);
        }
