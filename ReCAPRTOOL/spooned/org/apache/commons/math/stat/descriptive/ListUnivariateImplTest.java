...
public final class ListUnivariateImplTest extends junit.framework.TestCase {
    ...
    public void testSkewAndKurtosis() {
        ...
        double[] testArray = new double[]{ 12.5, 12, 11.8, 14.2, 14.9, 14.5, 21, 8.2, 10.3, 11.3, 14.1, 
    ...
    public void testProductAndGeometricMean() throws java.lang.Exception {
        ...
        assertEquals("Geometric mean not expected", 5.755931, u.getGeometricMean(), 1.0E-5);
