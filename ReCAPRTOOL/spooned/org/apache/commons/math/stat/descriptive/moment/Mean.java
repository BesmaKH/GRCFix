 ...
 */
public class Mean extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements 
java.io.Serializable , org.apache.commons.math.stat.descriptive.WeightedEvaluation {
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int begin, final int length) {         if (test(values, begin, length)) {             org.apache.commons.math.stat.descriptive.summary.Sum sum = new org.apache.commons.math.stat.descriptive.summary.Sum();
     ...
     * @since 2.1
     */     public double evaluate(final double[] values, final double[] weights, final int begin, final int length) {         if (test(values, weights, begin, length)) {             org.apache.commons.math.stat.descriptive.summary.Sum sum = new org.apache.commons.math.stat.descriptive.summary.Sum();
            // Compute initial estimate using definitional formula
     ...
     */     public static void copy(org.apache.commons.math.stat.descriptive.moment.Mean source, org.apache.commons.math.stat.descriptive.moment.Mean dest) {         dest.incMoment = source.incMoment;         dest.moment = source.moment.copy();
    }
}