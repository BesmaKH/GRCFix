...
public class SumOfLogs extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements java.io.Serializable {
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int begin, final int length) {         double sumLog = java.lang.Double.NaN;         if (test(values, begin, length)) {
            sumLog = 0.0;
     ...
     */     public static void copy(org.apache.commons.math.stat.descriptive.summary.SumOfLogs source, org.apache.commons.math.stat.descriptive.summary.SumOfLogs dest) {         dest.n = source.n;         dest.value = source.value;
    }
}