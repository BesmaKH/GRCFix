...
public class Min extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements java.io.Serializable {
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int begin, final int length) {         double min = java.lang.Double.NaN;         if (test(values, begin, length)) {
            min = values[begin];
     ...
     */     public static void copy(org.apache.commons.math.stat.descriptive.rank.Min source, org.apache.commons.math.stat.descriptive.rank.Min dest) {         dest.n = source.n;         dest.value = source.value;
    }
}