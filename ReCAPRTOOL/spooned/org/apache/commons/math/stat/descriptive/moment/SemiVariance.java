...
public class SemiVariance extends org.apache.commons.math.stat.descriptive.AbstractUnivariateStatistic implements java.io.Serializable {
     ...
     */     public static void copy(final org.apache.commons.math.stat.descriptive.moment.SemiVariance source, org.apache.commons.math.stat.descriptive.moment.SemiVariance dest) {         dest.biasCorrected = source.biasCorrected;         dest.varianceDirection = source.varianceDirection;
    }
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int start, final int length) {         double m = new org.apache.commons.math.stat.descriptive.moment.Mean().evaluate(values, start, length);
     ...
     * @throws IllegalArgumentException
     * 		if values is null
     */     public double evaluate(final double[] values, org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction direction) {         double m = new org.apache.commons.math.stat.descriptive.moment.Mean().evaluate(values);
     ...
     * @throws IllegalArgumentException
     * 		if values is null
     */     public double evaluate(final double[] values, final double cutoff) {         return evaluate(values, cutoff, varianceDirection, biasCorrected, 0, values.length);}
     ...
     * @throws IllegalArgumentException
     * 		if values is null
     */     public double evaluate(final double[] values, final double cutoff, final org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction direction) {         return evaluate(values, cutoff, direction, biasCorrected, 0, values.length);}
     ...
     * @throws IllegalArgumentException
     * 		if the parameters are not valid
     */     public double evaluate(final double[] values, final double cutoff, final org.apache.commons.math.stat.descriptive.moment.SemiVariance.Direction direction, final boolean corrected, final int start, final int length) {         test(values, start, length);         if ((values.length) == 0) {             return java.lang.Double.NaN;
        }else {
            if ((values.length) == 1) {
                return 0.0;
            }else {
