...
public class Skewness extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements java.io.Serializable {
     ...
     * @param m3
     * 		external moment
     */     public Skewness(final org.apache.commons.math.stat.descriptive.moment.ThirdMoment m3) {         incMoment = false;
        this.moment = m3;
    }
    ...
    public double getResult() {
        ...
        if (variance < 1.0E-19) {
            ...
            return (n0 * (moment.m3)) / 
            ((((n0 - 1) * (n0 - 2)) * (java.lang.Math.sqrt(variance))) * variance);
        }
    }
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int begin, final int length) {
     ...
     */     public static void copy(org.apache.commons.math.stat.descriptive.moment.Skewness source, org.apache.commons.math.stat.descriptive.moment.Skewness dest) {         dest.moment = new org.apache.commons.math.stat.descriptive.moment.ThirdMoment(source.moment.copy());         dest.incMoment = source.incMoment;
    }
}