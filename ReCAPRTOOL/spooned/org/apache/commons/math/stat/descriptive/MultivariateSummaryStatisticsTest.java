...
public class MultivariateSummaryStatisticsTest extends junit.framework.TestCase {
    ...
    public void testSetterInjection() throws java.lang.Exception {
        ...
        u.setMeanImpl(new org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]{ 
        new org.apache.commons.math.stat.descriptive.MultivariateSummaryStatisticsTest.sumMean(), new org.apache.commons.math.stat.descriptive.MultivariateSummaryStatisticsTest.sumMean() });
        ...
        u.clear();
        u.setMeanImpl(new org.apache.commons.math.stat.descriptive.StorelessUnivariateStatistic[]{ 
        new org.apache.commons.math.stat.descriptive.moment.Mean(), new org.apache.commons.math.stat.descriptive.moment.Mean() });
        // OK after clear
        u.addValue(new double[]{ 1, 2 });
        u.addValue(new double[]{ 3, 4 });
    ...
    /**
     * test stats
     */     public void testStats() throws org.apache.commons.math.DimensionMismatchException {         org.apache.commons.math.stat.descriptive.MultivariateSummaryStatistics u = createMultivariateSummaryStatistics(2, true);
