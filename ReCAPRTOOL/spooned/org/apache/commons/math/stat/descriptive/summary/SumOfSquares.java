...
public class SumOfSquares extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements java.io.Serializable {
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int begin, final int length) {         double sumSq = java.lang.Double.NaN;         if (test(values, begin, length)) {
            sumSq = 0.0;
     ...
     */     public static void copy(org.apache.commons.math.stat.descriptive.summary.SumOfSquares source, org.apache.commons.math.stat.descriptive.summary.SumOfSquares dest) {         dest.n = source.n;         dest.value = source.value;
    }
