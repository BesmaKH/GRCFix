...
public class Sum extends org.apache.commons.math.stat.descriptive.AbstractStorelessUnivariateStatistic implements java.io.Serializable {
     ...
     */     @java.lang.Override     public double evaluate(final double[] values, final int begin, final int length) {         double sum = java.lang.Double.NaN;         if (test(values, begin, length)) {
            sum = 0.0;
     ...
     * @since 2.1
     */     public double evaluate(final double[] values, final double[] weights, final int begin, final int length) {         double sum = java.lang.Double.NaN;         if (test(values, weights, begin, length)) {             sum = 0.0;
            for (int i = begin; i < (begin + length); i++) {
     ...
     */     public static void copy(org.apache.commons.math.stat.descriptive.summary.Sum source, org.apache.commons.math.stat.descriptive.summary.Sum dest) {         dest.n = source.n;         dest.value = source.value;
    }
