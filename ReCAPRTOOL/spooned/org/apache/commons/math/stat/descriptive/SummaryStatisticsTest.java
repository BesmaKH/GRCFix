...
public class SummaryStatisticsTest extends junit.framework.TestCase {
    ...
    /**
     * test stats
     */     public void testStats() {         org.apache.commons.math.stat.descriptive.SummaryStatistics u = createSummaryStatistics();
    ...
    public void testN0andN1Conditions() throws java.lang.Exception {
        ...
        junit.framework.Assert.assertTrue("Mean of n = 0 set should be NaN", 
        java.lang.Double.isNaN(u.getMean()));
        junit.framework.Assert.assertTrue("Standard Deviation of n = 0 set should be NaN", 
        java.lang.Double.isNaN(u.getStandardDeviation()));
        junit.framework.Assert.assertTrue("Variance of n = 0 set should be NaN", 
        java.lang.Double.isNaN(u.getVariance()));

        /* n=1 */
        u.addValue(one);
        junit.framework.Assert.assertTrue("mean should be one (n = 1)", 
        ((u.getMean()) == (one)));
        junit.framework.Assert.assertTrue(("geometric should be one (n = 1) instead it is " + (u.getGeometricMean())), 
        ((u.getGeometricMean()) == (one)));
        junit.framework.Assert.assertTrue("Std should be zero (n = 1)", 
        ((u.getStandardDeviation()) == 0.0));
        junit.framework.Assert.assertTrue("variance should be zero (n = 1)", 
        ((u.getVariance()) == 0.0));

        /* n=2 */
        u.addValue(twoF);
        junit.framework.Assert.assertTrue("Std should not be zero (n = 2)", 
        ((u.getStandardDeviation()) != 0.0));
        junit.framework.Assert.assertTrue("variance should not be zero (n = 2)", 
        ((u.getVariance()) != 0.0));
    ...
    public void testProductAndGeometricMean() throws java.lang.Exception {
        ...
        junit.framework.Assert.assertEquals("Geometric mean not expected", 2.213364, 
        u.getGeometricMean(), 1.0E-5);
    }
    ...
    public void testNaNContracts() {
        ...
        junit.framework.Assert.assertEquals("mean not expected", 1.0, 
        u.getMean(), java.lang.Double.MIN_VALUE);
        junit.framework.Assert.assertEquals("variance not expected", 0.0, 
        u.getVariance(), java.lang.Double.MIN_VALUE);
        junit.framework.Assert.assertEquals("geometric mean not expected", 1.0, 
        u.getGeometricMean(), java.lang.Double.MIN_VALUE);
    ...
    public void testEqualsAndHashCode() {
        ...
        junit.framework.Assert.assertTrue("different n's should make hashcodes different", 
        ...
        junit.framework.Assert.assertEquals("summaries based on same data should have same hashcodes", 
        u.hashCode(), t.hashCode());
    ...
    public void testSetterInjection() throws java.lang.Exception {
        ...
        u.clear();
        u.setMeanImpl(new org.apache.commons.math.stat.descriptive.moment.Mean());// OK after clear
    }
