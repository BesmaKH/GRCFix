...
public class TTestTest extends junit.framework.TestCase {
    ...
    public void testOneSampleT() throws java.lang.Exception {
        ...
        testStatistic.t(mu, observed), 1.0E-9);
        junit.framework.Assert.assertEquals("t statistic", (-2.81976445346), 
        testStatistic.t(mu, sampleStats), 1.0E-9);
        junit.framework.Assert.assertEquals("p value", 0.0136390585873, 
        testStatistic.tTest(mu, observed), 1.0E-9);
        junit.framework.Assert.assertEquals("p value", 0.0136390585873, 
        testStatistic.tTest(mu, sampleStats), 1.0E-9);
    ...
    public void testOneSampleTTest() throws java.lang.Exception {
        ...
        testStatistic.t(0.0, oneSidedP), 1.0E-9);
        junit.framework.Assert.assertEquals("one sample t stat", 3.86485535541, 
        testStatistic.t(0.0, oneSidedPStats), 1.0E-10);
        junit.framework.Assert.assertEquals("one sample p value", 5.21637019637E-4, 
        ((testStatistic.tTest(0.0, oneSidedP)) / 2.0), 1.0E-9);
        junit.framework.Assert.assertEquals("one sample p value", 5.21637019637E-4, 
        ((testStatistic.tTest(0.0, oneSidedPStats)) / 2.0), 1.0E-4);
    ...
    public void testTwoSampleTHeterscedastic() throws java.lang.Exception {
        ...
        testStatistic.t(sample1, sample2), 1.0E-10);
        junit.framework.Assert.assertEquals("two sample heteroscedastic t stat", 1.60371728768, 
        testStatistic.t(sampleStats1, sampleStats2), 1.0E-10);
        junit.framework.Assert.assertEquals("two sample heteroscedastic p value", 0.128839369622, 
        testStatistic.tTest(sample1, sample2), 1.0E-10);
        junit.framework.Assert.assertEquals("two sample heteroscedastic p value", 0.128839369622, 
        testStatistic.tTest(sampleStats1, sampleStats2), 1.0E-10);
    ...
    public void testTwoSampleTHomoscedastic() throws java.lang.Exception {
        ...
        testStatistic.homoscedasticT(sample1, sample2), 1.0E-10);
        junit.framework.Assert.assertEquals("two sample homoscedastic p value", 0.4833963785, 
        testStatistic.homoscedasticTTest(sampleStats1, sampleStats2), 1.0E-10);
    ...
    public void testSmallSamples() throws java.lang.Exception {
        ...
        junit.framework.Assert.assertEquals((-2.2360679775), testStatistic.t(sample1, sample2), 
        1.0E-10);
        junit.framework.Assert.assertEquals(0.198727388935, testStatistic.tTest(sample1, sample2), 
        1.0E-10);
    }
