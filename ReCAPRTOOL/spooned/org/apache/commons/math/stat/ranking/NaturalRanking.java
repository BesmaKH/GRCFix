...
public class NaturalRanking implements org.apache.commons.math.stat.ranking.RankingAlgorithm {
     ...
     * @param tiesStrategy
     * 		TiesStrategy to use
     */     public NaturalRanking(org.apache.commons.math.stat.ranking.NaNStrategy nanStrategy, org.apache.commons.math.stat.ranking.TiesStrategy tiesStrategy) {         super();
        this.nanStrategy = nanStrategy;
        this.tiesStrategy = tiesStrategy;
        randomData = new org.apache.commons.math.random.RandomDataImpl();
    }
        ...
        for (int i = 0; i < (ranks.length); i++) {
            if (java.lang.Double.isNaN(ranks[i].getValue())) {
                ...
                for (int k = i + 1; k < (ranks.length); k++) {
                    ranks[k] = new org.apache.commons.math.stat.ranking.NaturalRanking.IntDoublePair(
                    ranks[k].getValue(), ((ranks[k].getPosition()) - 1));
                }
            }else {
                outRanks[j] = new org.apache.commons.math.stat.ranking.NaturalRanking.IntDoublePair(
     ...
     */     private void recodeNaNs(org.apache.commons.math.stat.ranking.NaturalRanking.IntDoublePair[] ranks, double value) {         for (int i = 0; i < (ranks.length); i++) {
            if (java.lang.Double.isNaN(ranks[i].getValue())) {
                ranks[i] = new org.apache.commons.math.stat.ranking.NaturalRanking.IntDoublePair(
     ...
     * @param value
     * 		value to set
     */     private void fill(double[] data, java.util.List<java.lang.Integer> tiesTrace, double value) {         java.util.Iterator<java.lang.Integer> iterator = tiesTrace.iterator();         while (iterator.hasNext()) {
     ...
     */     private void restoreNaNs(double[] ranks, java.util.List<java.lang.Integer> nanPositions) {         if ((nanPositions.size()) == 0) {
            return;
        }
    ...
    private static class IntDoublePair implements java.lang.Comparable<org.apache.commons.math.stat.ranking.NaturalRanking.IntDoublePair> {
         ...
         */         public IntDoublePair(double value, int position) {             this.value = value;             this.position = position;
        }
