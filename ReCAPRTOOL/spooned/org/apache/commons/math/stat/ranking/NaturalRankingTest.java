...
public class NaturalRankingTest extends junit.framework.TestCase {
    ...
    private final double[] exampleData = new double[]{ 20, 17, 30, 42.3, 17, 50, 
    java.lang.Double.NaN, java.lang.Double.NEGATIVE_INFINITY, 17 };
    ...
    public void testNaNsRemovedTiesSequential() {
        org.apache.commons.math.stat.ranking.NaturalRanking ranking = new org.apache.commons.math.stat.ranking.NaturalRanking(org.apache.commons.math.stat.ranking.NaNStrategy.REMOVED, 
        org.apache.commons.math.stat.ranking.TiesStrategy.SEQUENTIAL);
        double[] ranks = ranking.rank(exampleData);
    ...
    public void testNaNsMinimalTiesMaximum() {
        ...
        org.apache.commons.math.stat.ranking.TiesStrategy.MAXIMUM);
        double[] ranks = ranking.rank(exampleData);
    ...
    public void testNaNsFixedTiesRandom() {
        ...
        org.apache.commons.math.stat.ranking.NaturalRanking ranking = new org.apache.commons.math.stat.ranking.NaturalRanking(org.apache.commons.math.stat.ranking.NaNStrategy.FIXED, 
        randomGenerator);
        double[] ranks = ranking.rank(exampleData);
    ...
    public void testNaNsAndInfs() {
        double[] data = new double[]{ 0, java.lang.Double.POSITIVE_INFINITY, java.lang.Double.NaN, 
