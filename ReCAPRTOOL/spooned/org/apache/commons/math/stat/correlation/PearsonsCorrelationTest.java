...
public class PearsonsCorrelationTest extends junit.framework.TestCase {
    ...
    public void testLongly() throws java.lang.Exception {
        ...
        1.0, 0.970898525061056, 0.9835516111796693, 0.5024980838759942, 
        0.4573073999764817, 0.960390571594376, 0.9713294591921188, 
        0.970898525061056, 1.0, 0.9915891780247822, 0.6206333925590966, 
        0.4647441876006747, 0.979163432977498, 0.9911491900672053, 
        0.983551611179669, 0.9915891780247822, 1.0, 0.604260939889558, 
        0.4464367918926265, 0.991090069458478, 0.9952734837647849, 
        0.502498083875994, 0.6206333925590966, 0.604260939889558, 1.0, 
        ...
        1.0, 0.364416267189032, 0.4172451498349454, 
        0.960390571594376, 0.9791634329774981, 0.9910900694584777, 0.686551516365312, 
        0.364416267189032, 1.0, 0.9939528462329257, 
        0.971329459192119, 0.9911491900672053, 0.9952734837647849, 0.6682566045621746, 
        0.4172451498349454, 0.993952846232926, 1.0 };
        ...
        3.693245043123738E-9, 4.327782576751815E-11, 1.167954621905665E-13, 0.00331028281967516, 0.1652293725106684, 
    ...
    public void testSwissFertility() throws java.lang.Exception {
        ...
        org.apache.commons.math.linear.RealMatrix correlationMatrix = corrInstance.getCorrelationMatrix();
        double[] rData = new double[]{ 
        1.0, 0.3530791836199747, -0.6458827064572875, -0.6637888570350691, 0.4636847006517939, 
        0.3530791836199747, 1.0, -0.6865422086171366, -0.6395225189483201, 0.4010950530487398, 
        -0.6458827064572875, -0.6865422086171366, 1.0, 0.698415296288483, -0.5727418060641666, 
        -0.6637888570350691, -0.6395225189483201, 0.698415296288483, 1.0, -0.1538589170909148, 
        0.4636847006517939, 0.4010950530487398, -0.5727418060641666, -0.1538589170909148, 1.0 };

        org.apache.commons.math.TestUtils.assertEquals("correlation matrix", createRealMatrix(rData, 5, 5), correlationMatrix, 1.0E-14);

        double[] rPvalues = new double[]{ 
        0.01491720061472623, 
        9.45043734069043E-7, 9.95151527133974E-8, 
        3.658616965962355E-7, 1.304590105694471E-6, 4.811397236181847E-8, 
        0.001028523190118147, 0.005204433539191644, 2.588307925380906E-5, 0.301807756132683 };
     ...
     */
    public void testPValueNearZero() throws java.lang.Exception {
        ...
        org.apache.commons.math.stat.correlation.PearsonsCorrelation corrInstance = new org.apache.commons.math.stat.correlation.PearsonsCorrelation(data);
        junit.framework.Assert.assertTrue(((corrInstance.getCorrelationPValues().getEntry(0, 1)) > 0));
    }
    ...
    public void testCovarianceConsistency() throws java.lang.Exception {
        ...
        org.apache.commons.math.TestUtils.assertEquals("correlation values", corrInstance.getCorrelationMatrix(), 
        corrFromCovInstance.getCorrelationMatrix(), 1.0E-14);
        org.apache.commons.math.TestUtils.assertEquals("p values", corrInstance.getCorrelationPValues(), 
        corrFromCovInstance.getCorrelationPValues(), 1.0E-14);
        org.apache.commons.math.TestUtils.assertEquals("standard errors", corrInstance.getCorrelationStandardErrors(), 
        corrFromCovInstance.getCorrelationStandardErrors(), 1.0E-14);

        org.apache.commons.math.stat.correlation.PearsonsCorrelation corrFromCovInstance2 = 
        new org.apache.commons.math.stat.correlation.PearsonsCorrelation(covInstance.getCovarianceMatrix(), 16);
        org.apache.commons.math.TestUtils.assertEquals("correlation values", corrInstance.getCorrelationMatrix(), 
        corrFromCovInstance2.getCorrelationMatrix(), 1.0E-14);
        org.apache.commons.math.TestUtils.assertEquals("p values", corrInstance.getCorrelationPValues(), 
        corrFromCovInstance2.getCorrelationPValues(), 1.0E-14);
        org.apache.commons.math.TestUtils.assertEquals("standard errors", corrInstance.getCorrelationStandardErrors(), 
        corrFromCovInstance2.getCorrelationStandardErrors(), 1.0E-14);
    }
    ...
    public void testConsistency() {
        ...
        junit.framework.Assert.assertEquals(new org.apache.commons.math.stat.correlation.PearsonsCorrelation().correlation(x, y), 
        corrInstance.getCorrelationMatrix().getEntry(0, 1), java.lang.Double.MIN_VALUE);
        org.apache.commons.math.TestUtils.assertEquals("Correlation matrix", corrInstance.getCorrelationMatrix(), 
        new org.apache.commons.math.stat.correlation.PearsonsCorrelation().computeCorrelationMatrix(data), java.lang.Double.MIN_VALUE);
    }
