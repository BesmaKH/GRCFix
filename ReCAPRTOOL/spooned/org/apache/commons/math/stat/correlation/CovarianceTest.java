...
public class CovarianceTest extends junit.framework.TestCase {
    ...
    public void testLongly() {
        ...
        1.2333921733333332E7, 36796.66, 3.433302063333333E8, 
        1649102.6666666667, 1117681.0666666667, 2.3461965733333334E7, 16240.933333333332, 
        36796.66, 116.457625, 1063604.115416667, 
        6258.66625, 3490.25375, 73503.0, 50.92333333333334, 
        3.433302063333333E8, 1063604.115416667, 9.879353659329166E9, 
        5.6124369854166664E7, 3.0880428345833335E7, 6.852409446E8, 470977.9, 
        1649102.6666666667, 6258.66625, 5.6124369854166664E7, 
        873223.4291666667, -115378.7625, 4462741.533333333, 2973.0333333333333, 
        1117681.0666666667, 3490.25375, 3.0880428345833335E7, 
        -115378.7625, 484304.0958333333, 1764098.133333333, 1382.4333333333334, 
        2.3461965733333334E7, 73503.0, 6.852409446E8, 
        4462741.533333333, 1764098.1333333333, 4.838734893333333E7, 32917.4, 
        16240.93333333333, 50.92333333333334, 470977.9, 
        2973.033333333333, 1382.433333333333, 32917.4, 22.66666666666667 };
    ...
    public void testSwissFertility() {
        ...
        100.16914893617025, 515.7994172062905, -124.39283071230344, -139.6574005550416, 379.9043755781684, 
        -64.3669287696577, -124.3928307123034, 63.64662349676226, 53.5758556891767, -190.5606105457909, 
        -79.7295097132285, -139.6574005550416, 53.57585568917669, 92.4560592044403, -61.698829787234, 
        241.5632030527289, 379.9043755781684, -190.56061054579092, -61.698829787234, 1739.294537187789 };
    ...
    public void testConsistency() {
        ...
        junit.framework.Assert.assertEquals(covarianceMatrix.getEntry(2, 3), 
        new org.apache.commons.math.stat.correlation.Covariance().covariance(matrix.getColumn(2), matrix.getColumn(3), true), 1.0E-13);
        ...
        org.apache.commons.math.TestUtils.assertEquals("Covariances", 
        covarianceMatrix, new org.apache.commons.math.stat.correlation.Covariance().computeCovarianceMatrix(data), java.lang.Double.MIN_VALUE);
        org.apache.commons.math.TestUtils.assertEquals("Covariances", 
        covarianceMatrix, new org.apache.commons.math.stat.correlation.Covariance().computeCovarianceMatrix(data, true), java.lang.Double.MIN_VALUE);

        double[] x = data[0];
        double[] y = data[1];
        junit.framework.Assert.assertEquals(new org.apache.commons.math.stat.correlation.Covariance().covariance(x, y), 
        new org.apache.commons.math.stat.correlation.Covariance().covariance(x, y, true), java.lang.Double.MIN_VALUE);
    }
