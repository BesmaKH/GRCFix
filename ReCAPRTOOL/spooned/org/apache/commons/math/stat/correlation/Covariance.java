...
public class Covariance {
     ...
     */     public Covariance(double[][] data, boolean biasCorrected) {         this(new org.apache.commons.math.linear.BlockRealMatrix(data), biasCorrected);}
     ...
     */     public Covariance(org.apache.commons.math.linear.RealMatrix matrix, boolean biasCorrected) {         checkSufficientData(matrix);         n = matrix.getRowDimension();
     ...
     * 		if the input matrix does not have
     * 		at least two rows and two columns
     */     public Covariance(org.apache.commons.math.linear.RealMatrix matrix) {         this(matrix, true);
    }
     ...
     * @return covariance matrix
     */     protected org.apache.commons.math.linear.RealMatrix computeCovarianceMatrix(org.apache.commons.math.linear.RealMatrix matrix, boolean biasCorrected) {         int dimension = matrix.getColumnDimension();         org.apache.commons.math.stat.descriptive.moment.Variance variance = new org.apache.commons.math.stat.descriptive.moment.Variance(biasCorrected);
     ...
     * @return covariance matrix
     * @see #Covariance
     */     protected org.apache.commons.math.linear.RealMatrix computeCovarianceMatrix(org.apache.commons.math.linear.RealMatrix matrix) {         return computeCovarianceMatrix(matrix, true);
    }
     ...
     * 		determines whether or not covariance estimates are bias-corrected
     * @return covariance matrix
     */     protected org.apache.commons.math.linear.RealMatrix computeCovarianceMatrix(double[][] data, boolean biasCorrected) {         return computeCovarianceMatrix(new org.apache.commons.math.linear.BlockRealMatrix(data), biasCorrected);}
     ...
     * @return covariance matrix
     * @see #Covariance
     */     protected org.apache.commons.math.linear.RealMatrix computeCovarianceMatrix(double[][] data) {         return computeCovarianceMatrix(data, true);
    }
     ...
     */     public double covariance(final double[] xArray, final double[] yArray, boolean biasCorrected) throws java.lang.IllegalArgumentException {         org.apache.commons.math.stat.descriptive.moment.Mean mean = new org.apache.commons.math.stat.descriptive.moment.Mean();         double result = 0.0;
        int length = xArray.length;
        if (length != (yArray.length)) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, length, yArray.length);
        }else             if (length < 2) {
                throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                org.apache.commons.math.util.LocalizedFormats.INSUFFICIENT_DIMENSION, length, 2);
            }else {
     ...
     * 		IllegalArgumentException if the arrays lengths do not match or
     * 		there is insufficient data
     */     public double covariance(final double[] xArray, final double[] yArray) throws java.lang.IllegalArgumentException {         return covariance(xArray, yArray, true);
    }
     ...
     * @param matrix
     * 		matrix to check
     */     private void checkSufficientData(final org.apache.commons.math.linear.RealMatrix matrix) {         int nRows = matrix.getRowDimension();
