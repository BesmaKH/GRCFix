...
public class Frequency implements java.io.Serializable {
     ...
     */     // TODO is the cast OK?     @java.lang.SuppressWarnings("unchecked")
     ...
     */     @java.lang.Deprecated     public void addValue(java.lang.Object v) {
        if (v instanceof java.lang.Comparable<?>) {
            ...
            org.apache.commons.math.util.LocalizedFormats.CLASS_DOESNT_IMPLEMENT_COMPARABLE, 
            v.getClass().getName());
        }
    }
     ...
     */     public void addValue(java.lang.Comparable<?> v) {         java.lang.Comparable<?> obj = v;
        ...
        try {
            ...
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.INSTANCES_NOT_COMPARABLE_TO_EXISTING_VALUES, 
            v.getClass().getName());
        }
    }
     ...
     */     public void clear() {         freqTable.clear();
    }
     ...
     */     public long getCumFreq(java.lang.Comparable<?> v) {
        ...
        // OK, freqTable is Comparable<?>         @java.lang.SuppressWarnings("unchecked")
    ...
    private static class NaturalComparator<T extends java.lang.Comparable<T>> implements java.io.Serializable , java.util.Comparator<java.lang.Comparable<T>> {
         ...
         * 		or when <code>((Comparable)o1).compareTo(o2)</code> does
         */         // cast to (T) may throw ClassCastException, see Javadoc         @java.lang.SuppressWarnings("unchecked")         public int compare(java.lang.Comparable<T> o1, java.lang.Comparable<T> o2) {             return o1.compareTo(((T) (o2)));}
    }
