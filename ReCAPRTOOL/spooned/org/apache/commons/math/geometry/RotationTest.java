...
public class RotationTest extends 
junit.framework.TestCase {
    ...
    public void testVectorTwoPairs() {
        ...
        r = new org.apache.commons.math.geometry.Rotation(org.apache.commons.math.geometry.Vector3D.PLUS_I, org.apache.commons.math.geometry.Vector3D.PLUS_J, 
        new org.apache.commons.math.geometry.Vector3D(0.5, 0.5, sqrt), 
        new org.apache.commons.math.geometry.Vector3D(0.5, 0.5, (-sqrt)));
    ...
    public void testMatrix() throws 
    org.apache.commons.math.geometry.NotARotationMatrixException {

        try {
            new org.apache.commons.math.geometry.Rotation(new double[][]{ 
        ...
        try {
            new org.apache.commons.math.geometry.Rotation(new double[][]{ 
            new double[]{ 0.445888, 0.797184, -0.40704 }, 
            new double[]{ 0.82176, -0.18432, 0.5392 }, 
            new double[]{ -0.354816, 0.574912, 0.73728 } }, 
            1.0E-7);
        } catch (org.apache.commons.math.geometry.NotARotationMatrixException nrme) {
            // expected behavior
        } catch (java.lang.Exception e) {
        ...
        checkRotation(new org.apache.commons.math.geometry.Rotation(new double[][]{ 
        new double[]{ 0.445888, 0.797184, -0.40704 }, 
        new double[]{ -0.354816, 0.574912, 0.73728 }, 
        new double[]{ 0.82176, -0.18432, 0.5392 } }, 
        1.0E-10), 
        ...
        checkRotation(new org.apache.commons.math.geometry.Rotation(new double[][]{ 
        new double[]{ 0.5392, 0.73728, 0.40704 }, 
        new double[]{ 0.18432, -0.574912, 0.797184 }, 
        new double[]{ 0.82176, -0.354816, -0.445888 } }, 
        1.0E-10), 
        ...
        double[][] m1 = new double[][]{ new double[]{ 0.0, 1.0, 0.0 }, 
        ...
        double[][] m2 = new double[][]{ new double[]{ 0.83203, -0.55012, -0.07139 }, 
        new double[]{ 0.48293, 0.78164, -0.39474 }, 
        new double[]{ 0.27296, 0.29396, 0.91602 } };
        ...
        checkVector(r.applyTo(org.apache.commons.math.geometry.Vector3D.PLUS_I), 
        new org.apache.commons.math.geometry.Vector3D(m3[0][0], m3[1][0], m3[2][0]));
        checkVector(r.applyTo(org.apache.commons.math.geometry.Vector3D.PLUS_J), 
        new org.apache.commons.math.geometry.Vector3D(m3[0][1], m3[1][1], m3[2][1]));
        checkVector(r.applyTo(org.apache.commons.math.geometry.Vector3D.PLUS_K), 
        new org.apache.commons.math.geometry.Vector3D(m3[0][2], m3[1][2], m3[2][2]));

        double[][] m4 = new double[][]{ new double[]{ 1.0, 0.0, 0.0 }, 
        new double[]{ 0.0, -1.0, 0.0 }, 
        new double[]{ 0.0, 0.0, -1.0 } };
        ...
        try {
            double[][] m5 = new double[][]{ new double[]{ 0.0, 0.0, 1.0 }, 
            new double[]{ 0.0, 1.0, 0.0 }, 
            new double[]{ 1.0, 0.0, 0.0 } };
    ...
    public void testAngles() throws 
    org.apache.commons.math.geometry.CardanEulerSingularityException {

        org.apache.commons.math.geometry.RotationOrder[] CardanOrders = new org.apache.commons.math.geometry.RotationOrder[]{ 
        ...
        org.apache.commons.math.geometry.RotationOrder[] EulerOrders = new org.apache.commons.math.geometry.RotationOrder[]{ 
        ...
        for (int i = 0; i < (EulerOrders.length); ++i) {
            for (double alpha1 = 0.1; alpha1 < 6.2; alpha1 += 0.3) {
                for (double alpha2 = 0.05; alpha2 < 3.1; alpha2 += 0.3) {
                    for (double alpha3 = 0.1; alpha3 < 6.2; alpha3 += 0.3) {
                        org.apache.commons.math.geometry.Rotation r = new org.apache.commons.math.geometry.Rotation(EulerOrders[i], 
    ...
    public void testQuaternion() {
        ...
        double n = 23.5;
        org.apache.commons.math.geometry.Rotation r2 = new org.apache.commons.math.geometry.Rotation((n * (r1.getQ0())), (n * (r1.getQ1())), 
    ...
    public void testApplyInverseTo() {
        ...
        for (double lambda = 0; lambda < 6.2; lambda += 0.2) {
            for (double phi = -1.55; phi < 1.55; phi += 0.2) {
                org.apache.commons.math.geometry.Vector3D u = new org.apache.commons.math.geometry.Vector3D(((java.lang.Math.cos(lambda)) * (java.lang.Math.cos(phi))), 
                ((java.lang.Math.sin(lambda)) * (java.lang.Math.cos(phi))), 
                java.lang.Math.sin(phi));
