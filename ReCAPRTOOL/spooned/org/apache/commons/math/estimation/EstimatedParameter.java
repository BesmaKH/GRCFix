...
public class EstimatedParameter implements 
java.io.Serializable {
     ...
     */     public EstimatedParameter(java.lang.String name, double firstEstimate) {         this.name = name;         estimate = firstEstimate;         bound = false;
    }
     ...
     */     public EstimatedParameter(java.lang.String name, double firstEstimate, boolean bound) {         this.name = name;         estimate = firstEstimate;
        this.bound = bound;
    }
     ...
     * @param parameter
     * 		instance to copy
     */     public EstimatedParameter(org.apache.commons.math.estimation.EstimatedParameter parameter) {         name = parameter.name;         estimate = parameter.estimate;
