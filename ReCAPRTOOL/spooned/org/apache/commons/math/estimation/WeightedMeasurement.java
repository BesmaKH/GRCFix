...
public abstract class WeightedMeasurement implements java.io.Serializable {
     ...
     * @param measuredValue
     * 		measured value
     */     public WeightedMeasurement(double weight, double measuredValue) {         this.weight = weight;
     ...
     */     public WeightedMeasurement(double weight, double measuredValue, boolean ignored) {         this.weight = weight;         this.measuredValue = measuredValue;
