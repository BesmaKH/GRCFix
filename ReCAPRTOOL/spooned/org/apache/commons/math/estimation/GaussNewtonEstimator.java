...
public class GaussNewtonEstimator extends org.apache.commons.math.estimation.AbstractEstimator implements java.io.Serializable {
     ...
     */     public GaussNewtonEstimator() {         this.steadyStateThreshold = org.apache.commons.math.estimation.GaussNewtonEstimator.DEFAULT_STEADY_STATE_THRESHOLD;
        this.convergence = org.apache.commons.math.estimation.GaussNewtonEstimator.DEFAULT_CONVERGENCE;
    }
     ...
     */     public GaussNewtonEstimator(final int maxCostEval, final double convergence, final double steadyStateThreshold) {         setMaxCostEval(maxCostEval);
     ...
     * 		criterion threshold below which we do not need
     * 		to improve the criterion anymore
     */     public void setConvergence(final double convergence) {         this.convergence = convergence;
    }
     ...
     */     public void setSteadyStateThreshold(final double steadyStateThreshold) {         this.steadyStateThreshold = steadyStateThreshold;
    }
    ...
    @java.lang.Override
    public void estimate(org.apache.commons.math.estimation.EstimationProblem problem) throws 
    org.apache.commons.math.estimation.EstimationException {
        ...
        (((java.lang.Math.abs((previous - (cost)))) > ((cost) * (steadyStateThreshold))) && 
        ((java.lang.Math.abs(cost)) > (convergence))) );
