...
public abstract class ConvergingAlgorithmImpl implements org.apache.commons.math.ConvergingAlgorithm {
     ...
     */     protected ConvergingAlgorithmImpl(final int defaultMaximalIterationCount, final double defaultAbsoluteAccuracy) {         this.defaultAbsoluteAccuracy = defaultAbsoluteAccuracy;
    ...
    /**
     * {@inheritDoc}
     */     public void setAbsoluteAccuracy(double accuracy) {         absoluteAccuracy = accuracy;
    }
    ...
    /**
     * {@inheritDoc}
     */     public void resetAbsoluteAccuracy() {         absoluteAccuracy = defaultAbsoluteAccuracy;
    }

    /**
     * {@inheritDoc}
     */     public void setMaximalIterationCount(int count) {         maximalIterationCount = count;
    }
    ...
    /**
     * {@inheritDoc}
     */     public void setRelativeAccuracy(double accuracy) {         relativeAccuracy = accuracy;
    }
    ...
    /**
     * {@inheritDoc}
     */     public void resetRelativeAccuracy() {         relativeAccuracy = defaultRelativeAccuracy;
    }
