 ...
 */ public class ComplexUtilsTest extends junit.framework.TestCase {
    ...
    public void testPolar2Complex() {
        ...
        org.apache.commons.math.complex.ComplexUtils.polar2Complex(1, 0), 1.0E-11);
        org.apache.commons.math.TestUtils.assertEquals(org.apache.commons.math.complex.Complex.ZERO, 
        org.apache.commons.math.complex.ComplexUtils.polar2Complex(0, 1), 1.0E-11);
        org.apache.commons.math.TestUtils.assertEquals(org.apache.commons.math.complex.Complex.ZERO, 
        org.apache.commons.math.complex.ComplexUtils.polar2Complex(0, (-1)), 1.0E-11);
        org.apache.commons.math.TestUtils.assertEquals(org.apache.commons.math.complex.Complex.I, 
        org.apache.commons.math.complex.ComplexUtils.polar2Complex(1, ((pi) / 2)), 1.0E-11);
        org.apache.commons.math.TestUtils.assertEquals(org.apache.commons.math.complex.Complex.I.negate(), 
        org.apache.commons.math.complex.ComplexUtils.polar2Complex(1, ((-(pi)) / 2)), 1.0E-11);
        double r = 0;
        for (int i = 0; i < 5; i++) {
            r += i;
            ...
            for (int j = 0; j < 20; j++) {
                theta += (pi) / 6;
                org.apache.commons.math.TestUtils.assertEquals(altPolar(r, theta), 
                org.apache.commons.math.complex.ComplexUtils.polar2Complex(r, theta), 1.0E-11);
            }
            theta = (-2) * (pi);
            for (int j = 0; j < 20; j++) {
                theta -= (pi) / 6;
    ...
    public void testPolar2ComplexNaN() {
        ...
        org.apache.commons.math.complex.ComplexUtils.polar2Complex(nan, nan));
    }
    ...
    public void testPolar2ComplexInf() {
        ...
        org.apache.commons.math.TestUtils.assertSame(org.apache.commons.math.complex.Complex.NaN, 
        org.apache.commons.math.complex.ComplexUtils.polar2Complex(1, negInf));
        ...
        org.apache.commons.math.TestUtils.assertSame(org.apache.commons.math.complex.Complex.NaN, 
        org.apache.commons.math.complex.ComplexUtils.polar2Complex(inf, negInf));
