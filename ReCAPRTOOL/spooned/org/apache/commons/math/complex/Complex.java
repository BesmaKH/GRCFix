...
public class Complex implements java.io.Serializable , org.apache.commons.math.FieldElement<org.apache.commons.math.complex.Complex> {
     ...
     */     public static final org.apache.commons.math.complex.Complex NaN = new org.apache.commons.math.complex.Complex(java.lang.Double.NaN, java.lang.Double.NaN);     // CHECKSTYLE: resume ConstantName
     ...
     * @param imaginary
     * 		the imaginary part
     */     public Complex(double real, double imaginary) {         super();
        this.real = real;
     ...
     */     public org.apache.commons.math.complex.Complex add(org.apache.commons.math.complex.Complex rhs) {         return createComplex(((real) + (rhs.getReal())), 
     ...
     * @throws NullPointerException
     * 		if <code>rhs</code> is null
     */     public org.apache.commons.math.complex.Complex divide(org.apache.commons.math.complex.Complex rhs) {         if ((isNaN()) || (rhs.isNaN())) {
            return org.apache.commons.math.complex.Complex.NaN;
        }
     ...
     * @throws NullPointerException
     * 		if <code>rhs</code> is null
     */     public org.apache.commons.math.complex.Complex multiply(org.apache.commons.math.complex.Complex rhs) {         if ((isNaN()) || (rhs.isNaN())) {
            return org.apache.commons.math.complex.Complex.NaN;
        }
        if ((((java.lang.Double.isInfinite(real)) || (java.lang.Double.isInfinite(imaginary))) || 
        (java.lang.Double.isInfinite(rhs.real))) || (java.lang.Double.isInfinite(rhs.imaginary))) {
     ...
     */     public org.apache.commons.math.complex.Complex multiply(double rhs) {
        ...
        if (((java.lang.Double.isInfinite(real)) || (java.lang.Double.isInfinite(imaginary))) || 
        (java.lang.Double.isInfinite(rhs))) {
            // we don't use Complex.isInfinite() to avoid testing for NaN again
            return org.apache.commons.math.complex.Complex.INF;
        }
     ...
     * @throws NullPointerException
     * 		if <code>rhs</code> is null
     */     public org.apache.commons.math.complex.Complex subtract(org.apache.commons.math.complex.Complex rhs) {         if ((isNaN()) || (rhs.isNaN())) {
            return org.apache.commons.math.complex.Complex.NaN;
        }
    ...
    public org.apache.commons.math.complex.Complex acos() {
        ...
        return this.add(this.sqrt1z().multiply(org.apache.commons.math.complex.Complex.I)).log().multiply(
        org.apache.commons.math.complex.Complex.I.negate());
    }
    ...
    public org.apache.commons.math.complex.Complex asin() {
        ...
        return sqrt1z().add(this.multiply(org.apache.commons.math.complex.Complex.I)).log().multiply(
        org.apache.commons.math.complex.Complex.I.negate());
    }
    ...
    public org.apache.commons.math.complex.Complex atan() {
        ...
        return this.add(org.apache.commons.math.complex.Complex.I).divide(org.apache.commons.math.complex.Complex.I.subtract(this)).log().multiply(
    ...
    public org.apache.commons.math.complex.Complex cos() {
        ...
        return createComplex(((java.lang.Math.cos(real)) * (org.apache.commons.math.util.MathUtils.cosh(imaginary))), 
        ((-(java.lang.Math.sin(real))) * (org.apache.commons.math.util.MathUtils.sinh(imaginary))));
    }
    ...
    public org.apache.commons.math.complex.Complex cosh() {
        ...
        return createComplex(((org.apache.commons.math.util.MathUtils.cosh(real)) * (java.lang.Math.cos(imaginary))), 
        ((org.apache.commons.math.util.MathUtils.sinh(real)) * (java.lang.Math.sin(imaginary))));
    }
    ...
    public org.apache.commons.math.complex.Complex log() {
        ...
        return createComplex(java.lang.Math.log(abs()), 
        java.lang.Math.atan2(imaginary, real));
    }
     ...
     * 		if x is null
     * @since 1.2
     */     public org.apache.commons.math.complex.Complex pow(org.apache.commons.math.complex.Complex x) {         if (x == null) {
    ...
    public org.apache.commons.math.complex.Complex sin() {
        ...
        return createComplex(((java.lang.Math.sin(real)) * (org.apache.commons.math.util.MathUtils.cosh(imaginary))), 
        ((java.lang.Math.cos(real)) * (org.apache.commons.math.util.MathUtils.sinh(imaginary))));
    }
    ...
    public org.apache.commons.math.complex.Complex sinh() {
        ...
        return createComplex(((org.apache.commons.math.util.MathUtils.sinh(real)) * (java.lang.Math.cos(imaginary))), 
        ((org.apache.commons.math.util.MathUtils.cosh(real)) * (java.lang.Math.sin(imaginary))));
    }
    ...
    public org.apache.commons.math.complex.Complex sqrt() {
        ...
        if ((real) >= 0.0) {
            ...
            return createComplex(((java.lang.Math.abs(imaginary)) / (2.0 * t)), 
            ((org.apache.commons.math.util.MathUtils.indicator(imaginary)) * t));
        }
    }
     ...
     * 		if parameter n is less than or equal to 0
     * @since 2.0
     */     public java.util.List<org.apache.commons.math.complex.Complex> nthRoot(int n) throws java.lang.IllegalArgumentException {
        if (n <= 0) {
            ...
            org.apache.commons.math.util.LocalizedFormats.CANNOT_COMPUTE_NTH_ROOT_FOR_NEGATIVE_N, 
            n);
        }
     ...
     * @since 1.2
     */     protected org.apache.commons.math.complex.Complex createComplex(double realPart, double imaginaryPart) {         return new org.apache.commons.math.complex.Complex(realPart, imaginaryPart);
    }
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.complex.ComplexField getField() {         return org.apache.commons.math.complex.ComplexField.getInstance();
    }
