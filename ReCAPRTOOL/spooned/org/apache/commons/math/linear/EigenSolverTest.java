...
public class EigenSolverTest extends junit.framework.TestCase {
     ...
     */     public void testNonInvertible() {         java.util.Random r = new java.util.Random(9994100315209L);
        org.apache.commons.math.linear.RealMatrix m = 
        org.apache.commons.math.linear.EigenDecompositionImplTest.createTestMatrix(r, new double[]{ 1.0, 0.0, -1.0, -2.0, -3.0 });
     ...
     */     public void testInvertible() {         java.util.Random r = new java.util.Random(9994100315209L);
        org.apache.commons.math.linear.RealMatrix m = 
        org.apache.commons.math.linear.EigenDecompositionImplTest.createTestMatrix(r, new double[]{ 1.0, 0.5, -1.0, -2.0, -3.0 });
        org.apache.commons.math.linear.DecompositionSolver es = new org.apache.commons.math.linear.EigenDecompositionImpl(m, org.apache.commons.math.util.MathUtils.SAFE_MIN).getSolver();
        junit.framework.Assert.assertTrue(es.isNonSingular());
        org.apache.commons.math.linear.RealMatrix inverse = es.getInverse();
        org.apache.commons.math.linear.RealMatrix error = 
        m.multiply(inverse).subtract(org.apache.commons.math.linear.MatrixUtils.createRealIdentityMatrix(m.getRowDimension()));
        junit.framework.Assert.assertEquals(0, error.getNorm(), 4.0E-15);
    }

    /**
     * test solve dimension errors
     */     public void testSolveDimensionErrors() {         org.apache.commons.math.linear.DecompositionSolver es = new org.apache.commons.math.linear.EigenDecompositionImpl(matrix, org.apache.commons.math.util.MathUtils.SAFE_MIN).getSolver();
    ...
    /**
     * test solve
     */     public void testSolve() {         org.apache.commons.math.linear.RealMatrix m = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        new double[]{ 91, 5, 29, 32, 40, 14 }, 
        new double[]{ 5, 34, -1, 0, 2, -1 }, 
        new double[]{ 29, -1, 12, 9, 21, 8 }, 
        new double[]{ 32, 0, 9, 14, 9, 0 }, 
        new double[]{ 40, 2, 21, 9, 51, 19 }, 
        new double[]{ 14, -1, 8, 0, 19, 14 } });

        org.apache.commons.math.linear.DecompositionSolver es = new org.apache.commons.math.linear.EigenDecompositionImpl(m, org.apache.commons.math.util.MathUtils.SAFE_MIN).getSolver();
        org.apache.commons.math.linear.RealMatrix b = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        new double[]{ 1561, 269, 188 }, 
        new double[]{ 69, -21, 70 }, 
        new double[]{ 739, 108, 63 }, 
        new double[]{ 324, 86, 59 }, 
        new double[]{ 1624, 194, 107 }, 
        new double[]{ 796, 69, 36 } });
        ...
        for (int i = 0; i < (b.getColumnDimension()); ++i) {
            ...
            new org.apache.commons.math.linear.ArrayRealVector(es.solve(b.getColumn(i))).subtract(xRef.getColumnVector(i)).getNorm(), 
            2.0E-11);
        }
