...
public class SparseFieldVectorTest extends junit.framework.TestCase {
     ...
     */     protected void assertEquals(java.lang.String msg, org.apache.commons.math.fraction.Fraction[] m, org.apache.commons.math.fraction.Fraction[] n) {         if ((m.length) != (n.length)) {
    ...
    /**
     * verifies that two vectors are close (sup norm)
     */     protected void assertClose(java.lang.String msg, org.apache.commons.math.fraction.Fraction[] m, org.apache.commons.math.fraction.Fraction[] n, double tolerance) {         if ((m.length) != (n.length)) {
            junit.framework.Assert.fail("vectors have different lengths");
        }
        for (int i = 0; i < (m.length); i++) {
