...
public class ArrayRealVectorTest extends junit.framework.TestCase {
    ...
    public void testPredicates() {
        ...
        junit.framework.Assert.assertEquals(new org.apache.commons.math.linear.ArrayRealVector(new double[]{ java.lang.Double.NaN, 1, 2 }).hashCode(), 
        new org.apache.commons.math.linear.ArrayRealVector(new double[]{ 0, java.lang.Double.NaN, 2 }).hashCode());

        junit.framework.Assert.assertTrue(((new org.apache.commons.math.linear.ArrayRealVector(new double[]{ java.lang.Double.NaN, 1, 2 }).hashCode()) != 
        (new org.apache.commons.math.linear.ArrayRealVector(new double[]{ 0, 1, 2 }).hashCode())));
