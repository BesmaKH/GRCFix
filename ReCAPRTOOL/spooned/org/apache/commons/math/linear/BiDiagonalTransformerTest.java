...
public class BiDiagonalTransformerTest {
    ...
    public void testSingularMatrix() {
        org.apache.commons.math.linear.BiDiagonalTransformer transformer = 
        new org.apache.commons.math.linear.BiDiagonalTransformer(org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        ...
        new double[]{ (-1.0) / s14, 5.0 / (s3 * s14), 1.0 / s3 }, 
        new double[]{ (-2.0) / s14, (-4.0) / (s3 * s14), 1.0 / s3 }, 
        new double[]{ (-3.0) / s14, 1.0 / (s3 * s14), (-1.0) / s3 } });

        org.apache.commons.math.linear.RealMatrix bRef = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        new double[]{ -s14, s1553 / s14, 0.0 }, 
        new double[]{ 0.0, ((-87) * s3) / (s14 * s1553), ((-s3) * s14) / s1553 }, 
        ...
        new double[]{ 0.0, (-23) / s1553, 32 / s1553 }, 
        new double[]{ 0.0, (-32) / s1553, (-23) / s1553 } });
    ...
    public void testMatricesValues() {
        org.apache.commons.math.linear.BiDiagonalTransformer transformer = 
        new org.apache.commons.math.linear.BiDiagonalTransformer(org.apache.commons.math.linear.MatrixUtils.createRealMatrix(testSquare));
        final double s17 = java.lang.Math.sqrt(17.0);
        org.apache.commons.math.linear.RealMatrix uRef = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        new double[]{ (-8) / (5 * s17), 19 / (5 * s17) }, 
        new double[]{ (-19) / (5 * s17), (-8) / (5 * s17) } });

        org.apache.commons.math.linear.RealMatrix bRef = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        new double[]{ ((-3) * s17) / 5, (32 * s17) / 85 }, 
        new double[]{ 0.0, ((-5) * s17) / 17 } });
