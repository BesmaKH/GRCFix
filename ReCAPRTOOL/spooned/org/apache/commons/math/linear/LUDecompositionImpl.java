...
public class LUDecompositionImpl implements org.apache.commons.math.linear.LUDecomposition {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.RealMatrix getL() {         if (((cachedL) == null) && (!(singular))) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.RealMatrix getU() {         if (((cachedU) == null) && (!(singular))) {
            final int m = pivot.length;
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.RealMatrix getP() {         if (((cachedP) == null) && (!(singular))) {
            final int m = pivot.length;
    ...
    /**
     * {@inheritDoc}
     */     public int[] getPivot() {         return pivot.clone();
    }

    /**
     * {@inheritDoc}
     */     public double getDeterminant() {         if (singular) {
            return 0;
        }else {
            final int m = pivot.length;
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.DecompositionSolver getSolver() {         return new org.apache.commons.math.linear.LUDecompositionImpl.Solver(lu, pivot, singular);
    }
     ...
     */     private static class Solver implements org.apache.commons.math.linear.DecompositionSolver {
         ...
         * @param singular
         * 		singularity indicator
         */         private Solver(final double[][] lu, final int[] pivot, final boolean singular) {             this.lu = lu;             this.pivot = pivot;             this.singular = singular;
        }

        /**
         * {@inheritDoc}
         */         public boolean isNonSingular() {             return !(singular);
        }
         ...
         */         public double[] solve(double[] b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
            ...
            if ((b.length) != m) {
                ...
                org.apache.commons.math.util.LocalizedFormats.VECTOR_LENGTH_MISMATCH, b.length, m);
            }
            if (singular) {
         ...
         */         public org.apache.commons.math.linear.RealVector solve(org.apache.commons.math.linear.RealVector b) throws java.lang.IllegalArgumentException, org.apache.commons.math.linear.InvalidMatrixException {
            try {
                ...
                if ((b.getDimension()) != m) {
                    throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
                    org.apache.commons.math.util.LocalizedFormats.VECTOR_LENGTH_MISMATCH, b.getDimension(), m);
                }
                if (singular) {
                    throw new org.apache.commons.math.linear.SingularMatrixException();
                }
        ...
        /**
         * {@inheritDoc}
         */         public org.apache.commons.math.linear.RealMatrix getInverse() throws org.apache.commons.math.linear.InvalidMatrixException {             return solve(org.apache.commons.math.linear.MatrixUtils.createRealIdentityMatrix(pivot.length));
        }
