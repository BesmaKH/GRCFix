...
public final class BlockRealMatrixTest extends junit.framework.TestCase {
    ...
    protected double[][] testDataMinus = new double[][]{ new double[]{ -1.0, -2.0, -3.0 }, new double[]{ -2.0, -5.0, -3.0 }, 
    ...
    new double[][]{ new double[]{ -40.0, 16.0, 9.0 }, new double[]{ 13.0, -5.0, -3.0 }, new double[]{ 5.0, -2.0, -1.0 } };
    ...
    new double[][]{ new double[]{ -39.0, 18.0, 12.0 }, new double[]{ 15.0, 0.0, 0.0 }, new double[]{ 6.0, -2.0, 7.0 } };

    // lu decomposition tests
    protected double[][] luData = new double[][]{ new double[]{ 2.0, 3.0, 3.0 }, new double[]{ 0.0, 5.0, 7.0 }, new double[]{ 6.0, 9.0, 8.0 } };
    protected double[][] luDataLUDecomposition = new double[][]{ new double[]{ 6.0, 9.0, 8.0 }, new double[]{ 0.0, 5.0, 7.0 }, 
    new double[]{ 0.33333333333333, 0.0, 0.33333333333333 } };

    // singular matrices
    protected double[][] singular = new double[][]{ new double[]{ 2.0, 3.0 }, new double[]{ 2.0, 3.0 } };
    protected double[][] bigSingular = new double[][]{ new double[]{ 1.0, 2.0, 3.0, 4.0 }, new double[]{ 2.0, 5.0, 3.0, 4.0 }, 
    new double[]{ 7.0, 3.0, 256.0, 1930.0 }, new double[]{ 3.0, 7.0, 6.0, 8.0 } };// 4th row = 1st + 2nd
    ...
    protected double[][] subTestData = new double[][]{ new double[]{ 1, 2, 3, 4 }, new double[]{ 1.5, 2.5, 3.5, 4.5 }, 
    new double[]{ 2, 4, 6, 8 }, new double[]{ 4, 5, 6, 7 } };
    // array selections
    ...
    /**
     * test dimensions
     */     public void testDimensions() {         org.apache.commons.math.linear.BlockRealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
    ...
    /**
     * test add
     */     public void testAdd() {         org.apache.commons.math.linear.BlockRealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
    ...
    /**
     * test add failure
     */     public void testAddFail() {         org.apache.commons.math.linear.BlockRealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
        org.apache.commons.math.linear.BlockRealMatrix m2 = new org.apache.commons.math.linear.BlockRealMatrix(testData2);
        try {
            m.add(m2);
    ...
    /**
     * test norm
     */     public void testNorm() {         org.apache.commons.math.linear.BlockRealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
        org.apache.commons.math.linear.BlockRealMatrix m2 = new org.apache.commons.math.linear.BlockRealMatrix(testData2);
    ...
    /**
     * test Frobenius norm
     */     public void testFrobeniusNorm() {         org.apache.commons.math.linear.BlockRealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
        org.apache.commons.math.linear.BlockRealMatrix m2 = new org.apache.commons.math.linear.BlockRealMatrix(testData2);
    ...
    /**
     * test m-n = m + -n
     */     public void testPlusMinus() {         org.apache.commons.math.linear.BlockRealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
    ...
    /**
     * test multiply
     */     public void testMultiply() {         org.apache.commons.math.linear.BlockRealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
        org.apache.commons.math.linear.BlockRealMatrix mInv = new org.apache.commons.math.linear.BlockRealMatrix(testDataInv);
    ...
    /**
     * test trace
     */     public void testTrace() {         org.apache.commons.math.linear.RealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(id);
    ...
    /**
     * test scalarAdd
     */     public void testScalarAdd() {         org.apache.commons.math.linear.RealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
        assertClose(new org.apache.commons.math.linear.BlockRealMatrix(testDataPlus2), m.scalarAdd(2.0), entryTolerance);
    }

    /**
     * test operate
     */     public void testOperate() {         org.apache.commons.math.linear.RealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(id);
    ...
    /**
     * test issue MATH-209
     */     public void testMath209() {         org.apache.commons.math.linear.RealMatrix a = new org.apache.commons.math.linear.BlockRealMatrix(new double[][]{ 
    ...
    /**
     * test transpose
     */     public void testTranspose() {         org.apache.commons.math.linear.RealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
     ...
     */     public void testPremultiplyVector() {         org.apache.commons.math.linear.RealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
        assertClose(m.preMultiply(testVector), preMultTest, normTolerance);
        assertClose(m.preMultiply(new org.apache.commons.math.linear.ArrayRealVector(testVector).getData()), 
    ...
    private void checkGetSubMatrix(org.apache.commons.math.linear.RealMatrix m, double[][] reference, 
    ...
    private void checkCopy(org.apache.commons.math.linear.RealMatrix m, double[][] reference, 
    int startRow, int endRow, int startColumn, int endColumn) {
        try {
    ...
    public void testToString() {
        org.apache.commons.math.linear.BlockRealMatrix m = new org.apache.commons.math.linear.BlockRealMatrix(testData);
        junit.framework.Assert.assertEquals("BlockRealMatrix{{1.0,2.0,3.0},{2.0,5.0,3.0},{1.0,0.0,8.0}}", 
        m.toString());
    }
    ...
    public void testSetSubMatrix() throws java.lang.Exception {
        ...
        org.apache.commons.math.linear.RealMatrix expected = new org.apache.commons.math.linear.BlockRealMatrix(
        new double[][]{ new double[]{ 1.0, 2.0, 3.0 }, new double[]{ 2.0, 1.0, 3.0 }, new double[]{ 1.0, 2.0, 4.0 } });
        junit.framework.Assert.assertEquals(expected, m);

        m.setSubMatrix(detData2, 0, 0);
        expected = new org.apache.commons.math.linear.BlockRealMatrix(
        new double[][]{ new double[]{ 1.0, 3.0, 3.0 }, new double[]{ 2.0, 4.0, 3.0 }, new double[]{ 1.0, 2.0, 4.0 } });
        junit.framework.Assert.assertEquals(expected, m);

        m.setSubMatrix(testDataPlus2, 0, 0);
        expected = new org.apache.commons.math.linear.BlockRealMatrix(
        new double[][]{ new double[]{ 3.0, 4.0, 5.0 }, new double[]{ 4.0, 7.0, 5.0 }, new double[]{ 3.0, 2.0, 10.0 } });
        junit.framework.Assert.assertEquals(expected, m);

        // javadoc example
        org.apache.commons.math.linear.BlockRealMatrix matrix = new org.apache.commons.math.linear.BlockRealMatrix(
        new double[][]{ new double[]{ 1, 2, 3, 4 }, new double[]{ 5, 6, 7, 8 }, new double[]{ 9, 0, 1, 2 } });
        matrix.setSubMatrix(new double[][]{ new double[]{ 3, 4 }, new double[]{ 5, 6 } }, 1, 1);
        expected = new org.apache.commons.math.linear.BlockRealMatrix(
        new double[][]{ new double[]{ 1, 2, 3, 4 }, new double[]{ 5, 3, 4, 8 }, new double[]{ 9, 5, 6, 2 } });
     ...
     */     protected void assertClose(org.apache.commons.math.linear.RealMatrix m, org.apache.commons.math.linear.RealMatrix n, double tolerance) {         junit.framework.Assert.assertTrue(((m.subtract(n).getNorm()) < tolerance));
    }

    /**
     * verifies that two vectors are close (sup norm)
     */     protected void assertClose(double[] m, double[] n, double tolerance) {         if ((m.length) != (n.length)) {
