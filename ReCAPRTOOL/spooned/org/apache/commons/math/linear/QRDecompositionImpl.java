...
public class QRDecompositionImpl implements org.apache.commons.math.linear.QRDecomposition {
     ...
     */     public QRDecompositionImpl(org.apache.commons.math.linear.RealMatrix matrix) {
         ...
         */
        for (
        int minor = 0; minor < (java.lang.Math.min(m, n)); minor++) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.RealMatrix getQ() {         if ((cachedQ) == null) {
     ...
     */     public org.apache.commons.math.linear.RealMatrix getQT() {
        if ((cachedQT) == null) {
             ...
             */
            for (
            int minor = m - 1; minor >= (java.lang.Math.min(m, n)); minor--) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.DecompositionSolver getSolver() {         return new org.apache.commons.math.linear.QRDecompositionImpl.Solver(qrt, rDiag);
    }
     ...
     */     private static class Solver implements org.apache.commons.math.linear.DecompositionSolver {
         ...
         */         private Solver(final double[][] qrt, final double[] rDiag) {             this.qrt = qrt;             this.rDiag = rDiag;
        }
