 ...
 * @since 2.0
 */ public class DefaultFieldMatrixPreservingVisitor<T extends org.apache.commons.math.FieldElement<T>> implements 
org.apache.commons.math.linear.FieldMatrixPreservingVisitor<T> {
     ...
     */     public DefaultFieldMatrixPreservingVisitor(final T zero) {         this.zero = zero;}
