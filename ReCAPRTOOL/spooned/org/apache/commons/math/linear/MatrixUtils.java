...
public class MatrixUtils {
     ...
     */     public static org.apache.commons.math.linear.RealMatrix createRealMatrix(final int rows, final int columns) {         return (rows * columns) <= 4096 ? new org.apache.commons.math.linear.Array2DRowRealMatrix(rows, columns) : new org.apache.commons.math.linear.BlockRealMatrix(rows, columns);
    }
     ...
     */     public static org.apache.commons.math.linear.RealMatrix createRealMatrix(double[][] data) {         return ((data.length) * (data[0].length)) <= 4096 ? new org.apache.commons.math.linear.Array2DRowRealMatrix(data) : new org.apache.commons.math.linear.BlockRealMatrix(data);
    }
     ...
     * 		if dimension is not positive
     * @since 2.0
     */     public static <T extends org.apache.commons.math.FieldElement<T>> org.apache.commons.math.linear.FieldMatrix<T> createFieldIdentityMatrix(final org.apache.commons.math.Field<T> field, final int dimension) {         final T zero = field.getZero();         final T one = field.getOne();
        // zero is type T         @java.lang.SuppressWarnings("unchecked")
     ...
     */     public static void checkRowIndex(final org.apache.commons.math.linear.AnyMatrix m, final int row) {         if ((row < 0) || (row >= (m.getRowDimension()))) {             throw new org.apache.commons.math.linear.MatrixIndexException("row index {0} out of allowed range [{1}, {2}]", 
     ...
     * @exception MatrixIndexException if index is not valid
     */     public static void checkColumnIndex(final org.apache.commons.math.linear.AnyMatrix m, final int column) throws org.apache.commons.math.linear.MatrixIndexException {         if ((column < 0) || (column >= (m.getColumnDimension()))) {
     ...
     */     public static void checkSubMatrixIndex(final org.apache.commons.math.linear.AnyMatrix m, final int startRow, final int endRow, final int startColumn, final int endColumn) {         org.apache.commons.math.linear.MatrixUtils.checkRowIndex(m, startRow);         org.apache.commons.math.linear.MatrixUtils.checkRowIndex(m, endRow);
        if (startRow > endRow) {
     ...
     */     public static void checkAdditionCompatible(final org.apache.commons.math.linear.AnyMatrix left, final org.apache.commons.math.linear.AnyMatrix right) throws java.lang.IllegalArgumentException {         if (((left.getRowDimension()) != (right.getRowDimension())) || 
     ...
     */     public static void checkSubtractionCompatible(final org.apache.commons.math.linear.AnyMatrix left, final org.apache.commons.math.linear.AnyMatrix right) throws java.lang.IllegalArgumentException {         if (((left.getRowDimension()) != (right.getRowDimension())) || 
        ((left.getColumnDimension()) != (right.getColumnDimension()))) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
     ...
     */     public static void checkMultiplicationCompatible(final org.apache.commons.math.linear.AnyMatrix left, final org.apache.commons.math.linear.AnyMatrix right) throws java.lang.IllegalArgumentException {         if ((left.getColumnDimension()) != (right.getRowDimension())) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
     ...
     */     public static void deserializeRealVector(final java.lang.Object instance, final java.lang.String fieldName, final java.io.ObjectInputStream ois) throws java.io.IOException, java.lang.ClassNotFoundException {         try {
     ...
     */     public static void deserializeRealMatrix(final java.lang.Object instance, final java.lang.String fieldName, final java.io.ObjectInputStream ois) throws java.io.IOException, java.lang.ClassNotFoundException {         try {
