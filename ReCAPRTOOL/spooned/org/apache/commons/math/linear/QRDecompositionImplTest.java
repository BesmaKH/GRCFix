...
public class QRDecompositionImplTest extends junit.framework.TestCase {
    ...
    /**
     * test dimensions
     */     public void testDimensions() {         checkDimension(org.apache.commons.math.linear.MatrixUtils.createRealMatrix(testData3x3NonSingular));
    ...
    /**
     * test A = QR
     */     public void testAEqualQR() {         checkAEqualQR(org.apache.commons.math.linear.MatrixUtils.createRealMatrix(testData3x3NonSingular));
    ...
    private void checkAEqualQR(org.apache.commons.math.linear.RealMatrix m) {
        ...
        junit.framework.Assert.assertEquals(0, norm, org.apache.commons.math.linear.QRDecompositionImplTest.normTolerance);
    }

    /**
     * test the orthogonality of Q
     */     public void testQOrthogonal() {         checkQOrthogonal(org.apache.commons.math.linear.MatrixUtils.createRealMatrix(testData3x3NonSingular));
     ...
     */     public void testRUpperTriangular() {         org.apache.commons.math.linear.RealMatrix matrix = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(testData3x3NonSingular);
     ...
     */     public void testHTrapezoidal() {         org.apache.commons.math.linear.RealMatrix matrix = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(testData3x3NonSingular);
     ...
     */     public void testMatricesValues() {         org.apache.commons.math.linear.QRDecomposition qr = 
        ...
        org.apache.commons.math.linear.RealMatrix qRef = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        new double[]{ (-12.0) / 14.0, 69.0 / 175.0, (-58.0) / 175.0 }, 
        new double[]{ (-6.0) / 14.0, (-158.0) / 175.0, 6.0 / 175.0 }, 
        new double[]{ 4.0 / 14.0, (-30.0) / 175.0, (-165.0) / 175.0 } });

        org.apache.commons.math.linear.RealMatrix rRef = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        new double[]{ -14.0, -21.0, 14.0 }, 
        new double[]{ 0.0, -175.0, 70.0 }, 
        new double[]{ 0.0, 0.0, 35.0 } });

        org.apache.commons.math.linear.RealMatrix hRef = org.apache.commons.math.linear.MatrixUtils.createRealMatrix(new double[][]{ 
        new double[]{ 26.0 / 14.0, 0.0, 0.0 }, 
        new double[]{ 6.0 / 14.0, 648.0 / 325.0, 0.0 }, 
        new double[]{ (-4.0) / 14.0, 36.0 / 325.0, 2.0 } });
