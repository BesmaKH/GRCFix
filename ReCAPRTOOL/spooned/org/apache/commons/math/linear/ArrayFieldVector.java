 ...
 */ public class ArrayFieldVector<T extends org.apache.commons.math.FieldElement<T>> implements java.io.Serializable , org.apache.commons.math.linear.FieldVector<T> {
     ...
     * @param field
     * 		field to which the elements belong
     */     public ArrayFieldVector(final org.apache.commons.math.Field<T> field) {         this(field, 0);
    }
     ...
     * @param size
     * 		size of the vector
     */     public ArrayFieldVector(org.apache.commons.math.Field<T> field, int size) {         this.field = field;         data = buildArray(size);
     ...
     */     public ArrayFieldVector(int size, T preset) {         this(preset.getField(), size);         java.util.Arrays.fill(data, preset);
    }
     ...
     */     public ArrayFieldVector(T[] d) throws java.lang.IllegalArgumentException {         try {
            field = d[0].getField();
            data = d.clone();
        } catch (java.lang.ArrayIndexOutOfBoundsException e) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.VECTOR_MUST_HAVE_AT_LEAST_ONE_ELEMENT);
        }
    }
     ...
     */     public ArrayFieldVector(T[] d, boolean copyArray) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {         try {             field = d[0].getField();             data = (copyArray) ? d.clone() : d;
        } catch (java.lang.ArrayIndexOutOfBoundsException e) {
            throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(
            org.apache.commons.math.util.LocalizedFormats.VECTOR_MUST_HAVE_AT_LEAST_ONE_ELEMENT);
        }
     ...
     */     public ArrayFieldVector(T[] d, int pos, int size) {         if ((d.length) < (pos + size)) {             throw org.apache.commons.math.MathRuntimeException.createIllegalArgumentException(org.apache.commons.math.util.LocalizedFormats.POSITION_SIZE_MISMATCH_INPUT_ARRAY, 
            pos, size, d.length);
        }
        field = d[0].getField();
     ...
     * @param v
     * 		vector to copy
     */     public ArrayFieldVector(org.apache.commons.math.linear.FieldVector<T> v) {         field = v.getField();
     ...
     * @param v
     * 		vector to copy
     */     public ArrayFieldVector(org.apache.commons.math.linear.ArrayFieldVector<T> v) {         field = v.getField();
        data = v.data.clone();
    }
     ...
     */     public ArrayFieldVector(org.apache.commons.math.linear.ArrayFieldVector<T> v, boolean deep) {         field = v.getField();         data = (deep) ? v.data.clone() : v.data;
    }
     ...
     */     public ArrayFieldVector(org.apache.commons.math.linear.ArrayFieldVector<T> v1, org.apache.commons.math.linear.ArrayFieldVector<T> v2) {         field = v1.getField();         data = buildArray(((v1.data.length) + (v2.data.length)));
     ...
     * @param v2
     * 		second vector (will be put at back of the new vector)
     */     public ArrayFieldVector(org.apache.commons.math.linear.ArrayFieldVector<T> v1, T[] v2) {         field = v1.getField();         data = buildArray(((v1.data.length) + (v2.length)));
        java.lang.System.arraycopy(v1.data, 0, data, 0, v1.data.length);
     ...
     * @param v2
     * 		second vector (will be put at back of the new vector)
     */     public ArrayFieldVector(T[] v1, org.apache.commons.math.linear.ArrayFieldVector<T> v2) {         field = v2.getField();         data = buildArray(((v1.length) + (v2.data.length)));
     ...
     */     public ArrayFieldVector(T[] v1, T[] v2) {         try {             data = buildArray(((v1.length) + (v2.length)));
            java.lang.System.arraycopy(v1, 0, data, 0, v1.length);
     ...
     * @return a new array
     */     // field is of type T     @java.lang.SuppressWarnings("unchecked")     private T[] buildArray(final int length) {         return ((T[]) (java.lang.reflect.Array.newInstance(field.getZero().getClass(), length)));
    }
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> copy() {         return new org.apache.commons.math.linear.ArrayFieldVector<T>(this, true);
    }

    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> add(org.apache.commons.math.linear.FieldVector<T> v) throws java.lang.IllegalArgumentException {         try {
     ...
     */     public org.apache.commons.math.linear.ArrayFieldVector<T> add(org.apache.commons.math.linear.ArrayFieldVector<T> v) throws java.lang.IllegalArgumentException {         return ((org.apache.commons.math.linear.ArrayFieldVector<T>) (add(v.data)));
    }

    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> subtract(org.apache.commons.math.linear.FieldVector<T> v) throws java.lang.IllegalArgumentException {         try {
     ...
     * @throws IllegalArgumentException
     * 		if v is not the same size as this
     */     public org.apache.commons.math.linear.ArrayFieldVector<T> subtract(org.apache.commons.math.linear.ArrayFieldVector<T> v) throws java.lang.IllegalArgumentException {         return ((org.apache.commons.math.linear.ArrayFieldVector<T>) (subtract(v.data)));
    }

    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapAdd(T d) {         T[] out = buildArray(data.length);
        for (int i = 0; i < (data.length); i++) {
            out[i] = data[i].add(d);
        }
        return new org.apache.commons.math.linear.ArrayFieldVector<T>(out);
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapAddToSelf(T d) {         for (int i = 0; i < (data.length); i++) {
            data[i] = data[i].add(d);
        }
        return this;
    }
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapSubtract(T d) {         T[] out = buildArray(data.length);
        for (int i = 0; i < (data.length); i++) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapSubtractToSelf(T d) {         for (int i = 0; i < (data.length); i++) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapMultiply(T d) {         T[] out = buildArray(data.length);
        for (int i = 0; i < (data.length); i++) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapMultiplyToSelf(T d) {         for (int i = 0; i < (data.length); i++) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapDivide(T d) {         T[] out = buildArray(data.length);
        for (int i = 0; i < (data.length); i++) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapDivideToSelf(T d) {         for (int i = 0; i < (data.length); i++) {
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapInv() {         T[] out = buildArray(data.length);
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> mapInvToSelf() {         final T one = field.getOne();
        for (int i = 0; i < (data.length); i++) {
     ...
     * @throws IllegalArgumentException
     * 		if v is not the same size as this
     */     public org.apache.commons.math.linear.ArrayFieldVector<T> ebeDivide(org.apache.commons.math.linear.ArrayFieldVector<T> v) throws java.lang.IllegalArgumentException {         return ((org.apache.commons.math.linear.ArrayFieldVector<T>) (ebeDivide(v.data)));
    }

    /**
     * {@inheritDoc}
     */     public T[] getData() {         return data.clone();
    }
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> projection(org.apache.commons.math.linear.FieldVector<T> v) {         return v.mapMultiply(dotProduct(v).divide(v.dotProduct(v)));
    }

    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> projection(T[] v) {         return projection(new org.apache.commons.math.linear.ArrayFieldVector<T>(v, false));
    }
     ...
     * @throws IllegalArgumentException
     * 		if v is not the same size as this
     */     public org.apache.commons.math.linear.ArrayFieldVector<T> projection(org.apache.commons.math.linear.ArrayFieldVector<T> v) {         return ((org.apache.commons.math.linear.ArrayFieldVector<T>) (v.mapMultiply(dotProduct(v).divide(v.dotProduct(v)))));}
    /**
     * {@inheritDoc}
    ...
    /**
     * {@inheritDoc}
     */     public T getEntry(int index) throws org.apache.commons.math.linear.MatrixIndexException {         return data[index];
    }
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> append(org.apache.commons.math.linear.FieldVector<T> v) {         try {
     ...
     * @return a new vector
     */     public org.apache.commons.math.linear.ArrayFieldVector<T> append(org.apache.commons.math.linear.ArrayFieldVector<T> v) {         return new org.apache.commons.math.linear.ArrayFieldVector<T>(this, v);
    }

    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> append(T in) {         final T[] out = buildArray(((data.length) + 1));
    ...
    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> append(T[] in) {         return new org.apache.commons.math.linear.ArrayFieldVector<T>(this, in);
    }

    /**
     * {@inheritDoc}
     */     public org.apache.commons.math.linear.FieldVector<T> getSubVector(int index, int n) {         org.apache.commons.math.linear.ArrayFieldVector<T> out = new org.apache.commons.math.linear.ArrayFieldVector<T>(field, n);
        try {
    ...
    /**
     * {@inheritDoc}
     */     public void setEntry(int index, T value) {         try {
            data[index] = value;
        } catch (java.lang.IndexOutOfBoundsException e) {
            checkIndex(index);
        }
    ...
    /**
     * {@inheritDoc}
     */     public void setSubVector(int index, org.apache.commons.math.linear.FieldVector<T> v) {         try {
            try {
    ...
    /**
     * {@inheritDoc}
     */     public void setSubVector(int index, T[] v) {         try {
    ...
    /**
     * {@inheritDoc}
     */     public void set(T value) {         java.util.Arrays.fill(data, value);
    }

    /**
     * {@inheritDoc}
     */     public T[] toArray() {         return data.clone();
    }
    ...
    public boolean equals(java.lang.Object other) {
        ...
        try {
            // May fail, but we ignore ClassCastException             @java.lang.SuppressWarnings("unchecked")
