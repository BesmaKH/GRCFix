...
public class TriDiagonalTransformerTest extends junit.framework.TestCase {
    ...
    private double[][] testSquare5 = new double[][]{ 
    new double[]{ 1, 2, 3, 1, 1 }, 
    new double[]{ 2, 1, 1, 3, 1 }, 
    new double[]{ 3, 1, 1, 1, 2 }, 
    new double[]{ 1, 3, 1, 2, 1 }, 
    new double[]{ 1, 1, 2, 1, 3 } };


    private double[][] testSquare3 = new double[][]{ 
    new double[]{ 1, 3, 4 }, 
    new double[]{ 3, 2, 2 }, 
    new double[]{ 4, 2, 0 } };
    ...
    public void testMatricesValues5() {
        ...
        new double[]{ 0.0, -0.5163977794943222, 0.016748280772542083, 0.839800693771262, 0.16669620021405473 }, 
        new double[]{ 0.0, -0.7745966692414833, -0.4354553000860955, -0.44989322880603355, -0.08930153582895772 }, 
        new double[]{ 0.0, -0.2581988897471611, 0.6364346693566014, -0.30263204032131164, 0.6608313651342882 }, 
        new double[]{ 0.0, -0.2581988897471611, 0.6364346693566009, -0.027289660803112598, -0.7263191580755246 } }, 

        new double[]{ 1, 4.4, 1.433099579242636, -0.89537362758743, 2.062274048344794 }, 
        new double[]{ -(java.lang.Math.sqrt(15)), -3.0832882879592476, 0.6082710842351517, 1.1786086405912128 });
    }
    ...
    public void testMatricesValues3() {
        ...
        new double[]{ 0.0, -0.6, 0.8 }, 
        new double[]{ 0.0, -0.8, -0.6 } }, 
    ...
    double[] secondaryDiagonal) {
        org.apache.commons.math.linear.TriDiagonalTransformer transformer = 
        new org.apache.commons.math.linear.TriDiagonalTransformer(org.apache.commons.math.linear.MatrixUtils.createRealMatrix(matrix));
