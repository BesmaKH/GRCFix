...
public final class SparseRealMatrixTest extends junit.framework.TestCase {
    ...
    protected double[][] testData = new double[][]{ new double[]{ 1.0, 2.0, 3.0 }, new double[]{ 2.0, 5.0, 3.0 }, 
    new double[]{ 1.0, 0.0, 8.0 } };
    protected double[][] testDataLU = new double[][]{ new double[]{ 2.0, 5.0, 3.0 }, new double[]{ 0.5, -2.5, 6.5 }, 
    new double[]{ 0.5, 0.2, 0.2 } };
    protected double[][] testDataPlus2 = new double[][]{ new double[]{ 3.0, 4.0, 5.0 }, new double[]{ 4.0, 7.0, 5.0 }, 
    new double[]{ 3.0, 2.0, 10.0 } };
    protected double[][] testDataMinus = new double[][]{ new double[]{ -1.0, -2.0, -3.0 }, 
    new double[]{ -2.0, -5.0, -3.0 }, new double[]{ -1.0, 0.0, -8.0 } };
    protected double[] testDataRow1 = new double[]{ 1.0, 2.0, 3.0 };
    protected double[] testDataCol3 = new double[]{ 3.0, 3.0, 8.0 };
    protected double[][] testDataInv = new double[][]{ new double[]{ -40.0, 16.0, 9.0 }, new double[]{ 13.0, -5.0, -3.0 }, 
    ...
    protected double[][] testDataPlusInv = new double[][]{ new double[]{ -39.0, 18.0, 12.0 }, 
    new double[]{ 15.0, 0.0, 0.0 }, new double[]{ 6.0, -2.0, 7.0 } };

    // lu decomposition tests
    protected double[][] luData = new double[][]{ new double[]{ 2.0, 3.0, 3.0 }, new double[]{ 0.0, 5.0, 7.0 }, new double[]{ 6.0, 9.0, 8.0 } };
    protected double[][] luDataLUDecomposition = new double[][]{ new double[]{ 6.0, 9.0, 8.0 }, 
    new double[]{ 0.0, 5.0, 7.0 }, new double[]{ 0.33333333333333, 0.0, 0.33333333333333 } };

    // singular matrices
    protected double[][] singular = new double[][]{ new double[]{ 2.0, 3.0 }, new double[]{ 2.0, 3.0 } };
    protected double[][] bigSingular = new double[][]{ new double[]{ 1.0, 2.0, 3.0, 4.0 }, 
    new double[]{ 2.0, 5.0, 3.0, 4.0 }, new double[]{ 7.0, 3.0, 256.0, 1930.0 }, new double[]{ 3.0, 7.0, 6.0, 8.0 } };// 4th
    ...
    // +
    // 2nd
    protected double[][] detData = new double[][]{ new double[]{ 1.0, 2.0, 3.0 }, new double[]{ 4.0, 5.0, 6.0 }, 
    new double[]{ 7.0, 8.0, 10.0 } };
    ...
    protected double[][] subTestData = new double[][]{ new double[]{ 1, 2, 3, 4 }, 
    new double[]{ 1.5, 2.5, 3.5, 4.5 }, new double[]{ 2, 4, 6, 8 }, new double[]{ 4, 5, 6, 7 } };
    ...
    /**
     * test dimensions
     */     public void testDimensions() {         org.apache.commons.math.linear.OpenMapRealMatrix m = createSparseMatrix(testData);
    ...
    /**
     * test copy functions
     */     public void testCopyFunctions() {         org.apache.commons.math.linear.OpenMapRealMatrix m1 = createSparseMatrix(testData);
    ...
    /**
     * test add
     */     public void testAdd() {         org.apache.commons.math.linear.OpenMapRealMatrix m = createSparseMatrix(testData);
    ...
    /**
     * test add failure
     */     public void testAddFail() {         org.apache.commons.math.linear.OpenMapRealMatrix m = createSparseMatrix(testData);
        org.apache.commons.math.linear.OpenMapRealMatrix m2 = createSparseMatrix(testData2);
        try {
            m.add(m2);
    ...
    /**
     * test norm
     */     public void testNorm() {         org.apache.commons.math.linear.OpenMapRealMatrix m = createSparseMatrix(testData);
        org.apache.commons.math.linear.OpenMapRealMatrix m2 = createSparseMatrix(testData2);
    ...
    /**
     * test m-n = m + -n
     */     public void testPlusMinus() {         org.apache.commons.math.linear.OpenMapRealMatrix m = createSparseMatrix(testData);
        org.apache.commons.math.linear.OpenMapRealMatrix n = createSparseMatrix(testDataInv);
        assertClose("m-n = m + -n", m.subtract(n), 
        n.scalarMultiply((-1.0)).add(m), entryTolerance);
        try {
    ...
    /**
     * test multiply
     */     public void testMultiply() {         org.apache.commons.math.linear.OpenMapRealMatrix m = createSparseMatrix(testData);
        org.apache.commons.math.linear.OpenMapRealMatrix mInv = createSparseMatrix(testDataInv);
        org.apache.commons.math.linear.OpenMapRealMatrix identity = createSparseMatrix(id);
        org.apache.commons.math.linear.OpenMapRealMatrix m2 = createSparseMatrix(testData2);
        assertClose("inverse multiply", m.multiply(mInv), identity, 
        entryTolerance);
        assertClose("inverse multiply", m.multiply(new org.apache.commons.math.linear.BlockRealMatrix(testDataInv)), identity, 
        entryTolerance);
    ...
    /**
     * test trace
     */     public void testTrace() {         org.apache.commons.math.linear.RealMatrix m = createSparseMatrix(id);
    ...
    /**
     * test sclarAdd
     */     public void testScalarAdd() {         org.apache.commons.math.linear.RealMatrix m = createSparseMatrix(testData);
        assertClose("scalar add", createSparseMatrix(testDataPlus2), 
        m.scalarAdd(2.0), entryTolerance);
    }

    /**
     * test operate
     */     public void testOperate() {         org.apache.commons.math.linear.RealMatrix m = createSparseMatrix(id);
        assertClose("identity operate", testVector, m.operate(testVector), 
        entryTolerance);
        assertClose("identity operate", testVector, m.operate(
        new org.apache.commons.math.linear.ArrayRealVector(testVector)).getData(), entryTolerance);
    ...
    /**
     * test issue MATH-209
     */     public void testMath209() {         org.apache.commons.math.linear.RealMatrix a = createSparseMatrix(new double[][]{ 
     ...
     */     public void testPremultiplyVector() {         org.apache.commons.math.linear.RealMatrix m = createSparseMatrix(testData);
        assertClose("premultiply", m.preMultiply(testVector), preMultTest, 
        normTolerance);
        assertClose("premultiply", m.preMultiply(
        new org.apache.commons.math.linear.ArrayRealVector(testVector).getData()), preMultTest, normTolerance);
        m = createSparseMatrix(bigSingular);
        try {
     ...
     */     public void testExamples() {         // Create a real matrix with two rows and three columns
        ...
        // Solve example
        double[][] coefficientsData = new double[][]{ new double[]{ 2, 3, -2 }, new double[]{ -1, 7, 6 }, 
        new double[]{ 4, -3, -5 } };
        ...
        junit.framework.Assert.assertEquals((((2 * (solution[0])) + (3 * (solution[1]))) - (2 * (solution[2]))), 
        constants[0], 1.0E-12);
        junit.framework.Assert.assertEquals(((((-1) * (solution[0])) + (7 * (solution[1]))) + (6 * (solution[2]))), 
        constants[1], 1.0E-12);
        junit.framework.Assert.assertEquals((((4 * (solution[0])) - (3 * (solution[1]))) - (5 * (solution[2]))), 
        constants[2], 1.0E-12);
    ...
    public void testToString() {
        org.apache.commons.math.linear.OpenMapRealMatrix m = createSparseMatrix(testData);
        junit.framework.Assert.assertEquals("OpenMapRealMatrix{{1.0,2.0,3.0},{2.0,5.0,3.0},{1.0,0.0,8.0}}", 
        m.toString());
    ...
    public void testSetSubMatrix() throws java.lang.Exception {
        ...
        org.apache.commons.math.linear.RealMatrix expected = createSparseMatrix(new double[][]{ 
        new double[]{ 1.0, 2.0, 3.0 }, new double[]{ 2.0, 1.0, 3.0 }, new double[]{ 1.0, 2.0, 4.0 } });
        junit.framework.Assert.assertEquals(expected, m);

        m.setSubMatrix(detData2, 0, 0);
        expected = createSparseMatrix(new double[][]{ 
        new double[]{ 1.0, 3.0, 3.0 }, new double[]{ 2.0, 4.0, 3.0 }, new double[]{ 1.0, 2.0, 4.0 } });
        junit.framework.Assert.assertEquals(expected, m);

        m.setSubMatrix(testDataPlus2, 0, 0);
        expected = createSparseMatrix(new double[][]{ 
        new double[]{ 3.0, 4.0, 5.0 }, new double[]{ 4.0, 7.0, 5.0 }, new double[]{ 3.0, 2.0, 10.0 } });
        junit.framework.Assert.assertEquals(expected, m);

        // javadoc example
        org.apache.commons.math.linear.OpenMapRealMatrix matrix = 
        createSparseMatrix(new double[][]{ 
        new double[]{ 1, 2, 3, 4 }, new double[]{ 5, 6, 7, 8 }, new double[]{ 9, 0, 1, 2 } });
        matrix.setSubMatrix(new double[][]{ new double[]{ 3, 4 }, new double[]{ 5, 6 } }, 1, 1);
        expected = createSparseMatrix(new double[][]{ 
        new double[]{ 1, 2, 3, 4 }, new double[]{ 5, 3, 4, 8 }, new double[]{ 9, 5, 6, 2 } });
